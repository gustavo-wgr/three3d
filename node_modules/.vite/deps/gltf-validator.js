...
var require_gltf_validator_dart = __commonJS({
  "node_modules/gltf-validator/gltf_validator.dart.js"(exports) {
    var dartNodeIsActuallyNode = "undefined" != typeof process && (process.versions || {}).hasOwnProperty("node");
    var self = dartNodeIsActuallyNode ? Object.create(globalThis) : globalThis;
    if (self.scheduleImmediate = "undefined" != typeof setImmediate ? function(e) {
      setImmediate(e);
    } : function(e) {
      setTimeout(e, 0);
    }, "undefined" != typeof __require) self.require = __require;
    if ("undefined" != typeof exports) self.exports = exports;
    if ("undefined" != typeof process) self.process = process;
    if ("undefined" != typeof __dirname) self.__dirname = __dirname;
    if ("undefined" != typeof __filename) self.__filename = __filename;
    if ("undefined" != typeof Buffer) self.Buffer = Buffer;
    if (dartNodeIsActuallyNode) {
      url = ("undefined" != typeof __webpack_require__ ? __non_webpack_require__ : __require)("url");
      Object.defineProperty(self, "location", { value: { get href() {
        if (url.pathToFileURL) return url.pathToFileURL(process.cwd()).href + "/";
        else return "file://" + function() {
          var e = process.cwd();
        ...
        function e() {
          try {
            ...
            var e2 = n.stack, r2 = new RegExp("^ *at [^(]*\\((.*):[0-9]*:[0-9]*\\)$", "mg"), f = null;
            do {
              var t = r2.exec(e2);
              if (null != t) f = t;
            } while (null != t);
        ...
        var r = null;
        Object.defineProperty(self, "document", { value: { get currentScript() {
          if (null == r) r = { src: e() };
          return r;
        } } });
      }(), self.dartDeferredLibraryLoader = function(e, r, f) {
        try {
          load(e), r();
        } catch (e2) {
          f(e2);
    ...
    (function dartProgram() {
      ...
      function setOrUpdateInterceptorsByTag(a) {
        var s = v2.interceptorsByTag;
        if (!s) {
          v2.interceptorsByTag = a;
          return;
        }
        copyProperties(a, s);
      }
      ...
      var hunkHelpers = function() {
        ...
        return { inherit, inheritMany, mixin: mixinEasy, mixinHard, installStaticTearOff, installInstanceTearOff, _instance_0u: s(0, 0, null, ["$0"], 0), _instance_1u: s(0, 1, null, ["$1"], 0), _instance_2u: s(0, 2, null, ["$2"], 0), _instance_0i: s(1, 0, null, ["$0"], 0), _instance_1i: s(1, 1, null, ["$1"], 0), _instance_2i: s(1, 2, null, ["$2"], 0), _static_0: r(0, null, ["$0"], 0), _static_1: r(1, null, ["$1"], 0), _static_2: r(2, null, ["$2"], 0), makeConstList, lazy, lazyFinal, lazyOld, updateHolder, convertToFastObject, updateTypes, setOrUpdateInterceptorsByTag, setOrUpdateLeafTags };
      }();
      ...
      var A = {
        ...
        he(a, b, c) {
          if (b.h("q<0>").b(a)) return new A.dZ(a, b.h("@<0>").I(c).h("dZ<1,2>"));
          return new A.c5(a, b.h("@<0>").I(c).h("c5<1,2>"));
        },
        uG(a) {
          return new A.f1("Field '" + A.b(a) + "' has been assigned during initialization.");
        },
        bg(a) {
          return new A.fm(a);
        },
        ...
        pW(a, b) {
          var s = A.mW(B.a.B(a, b)), r = A.mW(B.a.B(a, b + 1));
          return s * 16 + r - (r & 256);
        },
        bU(a, b, c) {
          if (a == null) throw A.d(new A.dI(b, c.h("dI<0>")));
          return a;
        },
        dQ(a, b, c, d) {
          A.aW(b, "start");
          if (c != null) {
            A.aW(c, "end");
            if (b > c) A.Z(A.Y(b, 0, c, "start", null));
          }
          return new A.dP(a, b, c, d.h("dP<0>"));
        },
        jQ(a, b, c, d) {
          if (t.O.b(a)) return new A.c9(a, b, c.h("@<0>").I(d).h("c9<1,2>"));
        ...
        nq() {
          return new A.bJ("No element");
        },
        ui() {
          return new A.bJ("Too few elements");
        },
        bM: function bM() {
        },
        dm: function dm(a, b) {
        ...
        ub(a) {
          if (typeof a == "number") return B.c1.gE(a);
        ...
        oY(a, b) {
          ...
          if (b < 2 || b > 36) throw A.d(A.Y(b, 2, 36, "radix", m));
          if (b === 10 && r != null) return parseInt(a, 10);
          if (b < 10 || r == null) {
            q = b <= 10 ? 47 + b : 86 + b;
            p = s[1];
            for (o = p.length, n = 0; n < o; ++n) if ((B.a.J(p, n) | 32) > q) return m;
          }
          return parseInt(a, b);
        },
        ka(a) {
        ...
        v1(a) {
          var s, r, q, p = A.a([], t.Z);
          for (s = a.length, r = 0; r < a.length; a.length === s || (0, A.cN)(a), ++r) {
            q = a[r];
            if (!A.aI(q)) throw A.d(A.cL(q));
            if (q <= 65535) p.push(q);
            else if (q <= 1114111) {
              p.push(55296 + (B.c.ai(q - 65536, 10) & 1023));
              p.push(56320 + (q & 1023));
            } else throw A.d(A.cL(q));
          }
          return A.oQ(p);
        },
        v0(a) {
        ...
        be(a) {
          ...
          if (0 <= a) {
            ...
            if (a <= 1114111) {
              s = a - 65536;
              return String.fromCharCode((B.c.ai(s, 10) | 55296) >>> 0, s & 1023 | 56320);
            }
          }
          throw A.d(A.Y(a, 0, 1114111, null, null));
        },
        ax(a) {
        ...
        fk(a) {
          return a.b ? A.ax(a).getUTCFullYear() + 0 : A.ax(a).getFullYear() + 0;
        },
        oW(a) {
          return a.b ? A.ax(a).getUTCMonth() + 1 : A.ax(a).getMonth() + 1;
        },
        oS(a) {
          return a.b ? A.ax(a).getUTCDate() + 0 : A.ax(a).getDate() + 0;
        },
        oT(a) {
          return a.b ? A.ax(a).getUTCHours() + 0 : A.ax(a).getHours() + 0;
        },
        oV(a) {
          return a.b ? A.ax(a).getUTCMinutes() + 0 : A.ax(a).getMinutes() + 0;
        },
        oX(a) {
          return a.b ? A.ax(a).getUTCSeconds() + 0 : A.ax(a).getSeconds() + 0;
        },
        oU(a) {
          return a.b ? A.ax(a).getUTCMilliseconds() + 0 : A.ax(a).getMilliseconds() + 0;
        },
        bE(a, b, c) {
          var s, r, q = {};
          q.a = 0;
        ...
        uY(a, b, c) {
          ...
          if (b != null) s = Array.isArray(b) ? b : A.bc(b, true, t.z);
          else s = [];
          r = s.length;
          q = a.$R;
          ...
          if (o) {
            if (c != null && c.a !== 0) return A.bE(a, s, c);
          ...
          if (Array.isArray(n)) {
            ...
            if (s === b) s = A.bc(s, true, t.z);
            i = Object.keys(n);
            if (c == null) for (o = i.length, h = 0; h < i.length; i.length === o || (0, A.cN)(i), ++h) {
              g = n[i[h]];
              if (B.ad === g) return A.bE(a, s, c);
              B.d.C(s, g);
            }
            else {
              for (o = i.length, f = 0, h = 0; h < i.length; i.length === o || (0, A.cN)(i), ++h) {
                e = i[h];
                if (c.v(e)) {
                  ++f;
                  B.d.C(s, c.i(0, e));
        ...
        eA(a, b) {
          ...
          if (!A.aI(b)) return new A.at(true, b, r, q);
          s = J.a3(a);
          if (b < 0 || b >= s) return A.eW(b, s, a, q, r);
          return new A.dL(q, q, true, b, r, "Value not in range");
        },
        x0(a, b, c) {
          if (a < 0 || a > c) return A.Y(a, 0, c, "start", null);
          if (b != null) {
            if (b < a || b > c) return A.Y(b, a, c, "end", null);
          }
          return new A.at(true, b, "end", null);
        },
        cL(a) {
          return new A.at(true, a, null, null);
        },
        d(a) {
          var s, r;
        ...
        xQ() {
          return J.as(this.dartException);
        },
        Z(a) {
          throw A.d(a);
        },
        ...
        wH(a) {
          ...
          if ("number" in a && typeof a.number == "number") {
            r = a.number;
            q = r & 65535;
            if ((B.c.ai(r, 16) & 8191) === 10) switch (q) {
              case 438:
                return A.bW(a, A.nt(A.b(s) + " (Error " + q + ")", e));
              case 445:
              case 5007:
                p = A.b(s);
                return A.bW(a, new A.dJ(p + " (Error " + q + ")", e));
            }
          }
          if (a instanceof TypeError) {
            ...
            if (f != null) return A.bW(a, A.nt(s, f));
              ...
              if (f != null) {
                ...
                if (p) return A.bW(a, new A.dJ(s, f == null ? e : f.method));
              }
            }
            return A.bW(a, new A.fx(typeof s == "string" ? s : ""));
          }
          if (a instanceof RangeError) {
            if (typeof s == "string" && s.indexOf("call stack") !== -1) return new A.dO();
            s = function(b) {
              try {
                return String(b);
              } catch (d) {
            ...
            return A.bW(a, new A.at(false, e, e, typeof s == "string" ? s.replace(/^RangeError:\s*/, "") : s));
          }
          if (typeof InternalError == "function" && a instanceof InternalError) {
            if (typeof s == "string" && s === "too much recursion") return new A.dO();
          }
          return a;
        },
        aS(a) {
        ...
        fZ(a) {
          if (a == null || typeof a != "object") return J.bY(a);
          else return A.d0(a);
        },
        pN(a, b) {
        ...
        xg(a, b, c, d, e, f) {
          ...
          throw A.d(A.u9("Unsupported number of arguments for wrapped closure"));
        },
        mO(a, b) {
          var s;
        ...
        u1(a2) {
          ...
          else r = function tear_off(a3, a4) {
        ...
        u_(a, b, c, d) {
          ...
          switch (b ? -1 : a) {
            case 0:
              throw A.d(new A.fp("Intercepted function with no arguments."));
            case 1:
              return /* @__PURE__ */ function(e, f, g) {
                return function() {
        ...
        tR(a, b) {
          return A.mt(v2.typeUniverse, A.ak(a.a), b);
        },
        ow(a) {
          return a.a;
        },
        ...
        ot(a) {
          var s, r, q, p = new A.cP("receiver", "interceptor"), o = J.nr(Object.getOwnPropertyNames(p));
          for (s = o.length, r = 0; r < s; ++r) {
            q = o[r];
            if (p[q] === a) return q;
          }
          throw A.d(A.K("Field name " + a + " not found.", null));
        },
        xP(a) {
          throw A.d(new A.eQ(a));
        },
        xa(a) {
          return v2.getIsolateTag(a);
        },
        uH(a, b, c) {
          var s = new A.cx(a, b, c.h("cx<0>"));
          s.c = a.e;
          return s;
        },
        Bh(a, b, c) {
        ...
        xC(a) {
          var s, r, q, p, o, n = $.pR.$1(a), m = $.mP[n];
          if (m != null) {
            Object.defineProperty(a, v2.dispatchPropertyName, { value: m, enumerable: false, writable: true, configurable: true });
            return m.i;
          }
          s = $.n_[n];
          if (s != null) return s;
          r = v2.interceptorsByTag[n];
          if (r == null) {
            q = $.pJ.$2(a, n);
            if (q != null) {
              m = $.mP[q];
          ...
          if (p === "-") {
            o = A.nc(s);
            Object.defineProperty(Object.getPrototypeOf(a), v2.dispatchPropertyName, { value: o, enumerable: false, writable: true, configurable: true });
            return o.i;
          }
          if (p === "+") return A.pX(a, s);
          if (p === "*") throw A.d(A.p4(n));
          if (v2.leafTags[n] === true) {
            o = A.nc(s);
            Object.defineProperty(Object.getPrototypeOf(a), v2.dispatchPropertyName, { value: o, enumerable: false, writable: true, configurable: true });
            return o.i;
          } else return A.pX(a, s);
        },
        pX(a, b) {
          var s = Object.getPrototypeOf(a);
          Object.defineProperty(s, v2.dispatchPropertyName, { value: J.nS(b, s, null, null), enumerable: false, writable: true, configurable: true });
          return b;
        },
        nc(a) {
          return J.nS(a, false, null, !!a.$iav);
        },
        xE(a, b, c) {
          var s = b.prototype;
          if (v2.leafTags[a] === true) return A.nc(s);
        ...
        xf() {
          var s, r, q, p, o, n, m, l;
          $.mP = /* @__PURE__ */ Object.create(null);
          $.n_ = /* @__PURE__ */ Object.create(null);
          A.xd();
          s = v2.interceptorsByTag;
          ...
          if (typeof window != "undefined") {
            ...
            for (p = 0; p < r.length; ++p) {
              ...
              if (n != null) {
                m = A.xE(o, s[o], n);
                if (m != null) {
                  Object.defineProperty(n, v2.dispatchPropertyName, { value: m, enumerable: false, writable: true, configurable: true });
                  q.prototype = n;
                }
              }
            }
        ...
        uk(a, b, c, d, e, f) {
          var s = b ? "m" : "", r = c ? "" : "i", q = d ? "u" : "", p = e ? "s" : "", o = f ? "g" : "", n = function(g, h) {
            try {
        ...
        de(a, b, c) {
          if (!A.aI(b)) throw A.d(A.K("Invalid view offsetInBytes " + A.b(b), null));
        },
        w8(a) {
          return a;
        },
        ...
        bo(a, b, c) {
          if (a >>> 0 !== a || a >= c) throw A.d(A.eA(b, a));
        },
        bR(a, b, c) {
          var s;
        ...
        v5(a, b) {
          var s = b.c;
          return s == null ? b.c = A.nG(a, b.y, true) : s;
        },
        oZ(a, b) {
          var s = b.c;
        ...
        aR(a) {
          return A.fT(v2.typeUniverse, a, false);
        },
        bT(a, b, a0, a1) {
          ...
          switch (c) {
            ...
            case 6:
              ...
              r = A.bT(a, s, a0, a1);
              if (r === s) return b;
              return A.pl(a, r, true);
            case 7:
              s = b.y;
              r = A.bT(a, s, a0, a1);
              if (r === s) return b;
              return A.nG(a, r, true);
            case 8:
              s = b.y;
              r = A.bT(a, s, a0, a1);
              if (r === s) return b;
              return A.pk(a, r, true);
            case 9:
              q = b.z;
              p = A.ey(a, q, a0, a1);
              if (p === q) return b;
            ...
            case 14:
              ...
              return d;
            default:
              throw A.d(A.eG("Attempted to substitute unexpected RTI kind " + c));
          }
        },
        ey(a, b, c, d) {
          var s, r, q, p, o = b.length, n = A.mv(o);
        ...
        wF(a, b, c, d) {
          var s, r, q, p, o, n, m = b.length, l = A.mv(m);
        ...
        wE(a, b, c, d) {
          var s, r = b.a, q = A.ey(a, r, c, d), p = b.b, o = A.ey(a, p, c, d), n = b.c, m = A.wF(a, n, c, d);
        ...
        wj(a, b) {
          var s = a instanceof A.c7 ? a.__proto__.__proto__.constructor : b, r = A.vH(v2.typeUniverse, s.name);
          b.$ccache = r;
          return r;
        },
        xb(a) {
          var s, r = v2.types, q = r[a];
          if (typeof q == "string") {
            s = A.fT(v2.typeUniverse, q, false);
            r[a] = s;
            return s;
          }
          return q;
        ...
        pL(a) {
          ...
          q = A.fT(v2.typeUniverse, r, true);
          p = q.w;
          return a.w = p == null ? q.w = new A.eh(q) : p;
        },
        u(a) {
          return A.pL(A.fT(v2.typeUniverse, a, false));
        },
        wi(a) {
          var s, r, q, p = this, o = t.K;
          ...
          if (s.x === 9) {
            ...
            if (s.z.every(A.xh)) {
              ...
              return A.df(p, a, A.wq);
            }
          } else if (o === 7) return A.df(p, a, A.wb);
        ...
        w9(a) {
          ...
          return A.a7(v2.typeUniverse, A.pT(a, s), null, s, null);
        },
        wb(a) {
        ...
        pw(a, b) {
          throw A.d(A.vw(A.pd(a, A.pT(a, b), A.ar(b, null))));
        },
        pd(a, b, c) {
          var s = A.cS(a);
        ...
        vw(a) {
          return new A.ei("TypeError: " + a);
        },
        aq(a, b) {
          return new A.ei("TypeError: " + A.pd(a, null, b));
        },
        wn(a) {
          return a != null;
        },
        ...
        py(a4, a5, a6) {
          ...
          if (a6 != null) {
            ...
            for (o = t.cK, n = t._, m = t.K, l = "<", k = "", p = 0; p < s; ++p, k = a3) {
              l = B.a.ae(l + k, a5[a5.length - 1 - p]);
              j = a6[p];
              i = j.x;
              if (!(i === 2 || i === 3 || i === 4 || i === 5 || j === o)) if (!(j === n)) h = j === m;
              else h = true;
              else h = true;
              if (!h) l += B.a.ae(" extends ", A.ar(j, a5));
            }
            l += ">";
          } else {
            l = "";
        ...
        ar(a, b) {
          ...
          if (m === 7) {
            ...
            s = A.ar(r, b);
            q = r.x;
            return J.om(q === 12 || q === 13 ? B.a.ae("(", s) + ")" : s, "?");
          }
          if (m === 8) return "FutureOr<" + A.b(A.ar(a.y, b)) + ">";
          if (m === 9) {
            p = A.wG(a.y);
            o = a.z;
            return o.length > 0 ? p + ("<" + A.pF(o, b) + ">") : p;
          }
          if (m === 11) return A.wz(a, b);
        ...
        vH(a, b) {
          ...
          if (m == null) return A.fT(a, b, false);
        ...
        mt(a, b, c) {
          var s, r, q = b.Q;
          if (q == null) q = b.Q = /* @__PURE__ */ new Map();
          s = q.get(c);
          if (s != null) return s;
          r = A.pi(A.pg(a, b, c, true));
          q.set(c, r);
          return r;
        },
        vG(a, b, c) {
          var s, r, q, p = b.as;
          if (p == null) p = b.as = /* @__PURE__ */ new Map();
          s = c.at;
          r = p.get(s);
          if (r != null) return r;
        ...
        vD(a, b, c) {
          var s, r, q = "+" + (b + "(" + A.ej(c) + ")"), p = a.eC.get(q);
          if (p != null) return p;
          s = new A.aF(null, null);
          s.x = 11;
          s.y = b;
        ...
        pj(a, b, c) {
          var s, r, q, p, o, n = b.at, m = c.a, l = m.length, k = c.b, j = k.length, i = c.c, h = i.length, g = "(" + A.ej(m);
          if (j > 0) {
            s = l > 0 ? "," : "";
            g += s + "[" + A.ej(k) + "]";
          }
        ...
        nF(a, b, c, d) {
          var s, r = b.at + ("<" + A.ej(c) + ">"), q = a.eC.get(r);
          if (q != null) return q;
          s = A.vz(a, b, c, r, d);
          a.eC.set(r, s);
          return s;
        ...
        pi(a) {
          var s, r, q, p, o, n, m, l, k, j, i = a.r, h = a.s;
          for (s = i.length, r = 0; r < s; ) {
            q = i.charCodeAt(r);
            if (q >= 48 && q <= 57) r = A.vr(r + 1, q, i, h);
            else if ((((q | 32) >>> 0) - 97 & 65535) < 26 || q === 95 || q === 36 || q === 124) r = A.ph(a, r, i, h, false);
            else if (q === 46) r = A.ph(a, r, i, h, true);
            else {
              ++r;
              switch (q) {
                case 44:
                ...
                case 33:
                  ...
                  break;
                case 59:
                  h.push(A.bQ(a.u, a.e, h.pop()));
                  break;
                case 94:
                  h.push(A.vC(a.u, h.pop()));
                  break;
                case 35:
                  h.push(A.el(a.u, 5, "#"));
                  break;
        ...
        vq(a, b) {
          ...
          switch (l) {
            case -3:
              ...
              return;
            case -4:
              b.push(A.vD(m, b.pop(), q));
              return;
            default:
              throw A.d(A.eG("Unexpected state under `()`: " + A.b(l)));
          }
        },
        vs(a, b) {
          var s = b.pop();
          ...
          throw A.d(A.eG("Unexpected extended operation " + A.b(s)));
        },
        vp(a, b) {
          var s = b.splice(a.p);
          A.nD(a.u, a.e, s);
        ...
        bQ(a, b, c) {
          if (typeof c == "string") return A.ek(a, c, a.sEA);
        ...
        a7(a, b, c, d, e) {
          ...
          r = b.x;
          if (r === 4) return true;
          if (A.bq(b)) return false;
          if (b.x !== 1) s = b === t.P || b === t.T;
          else s = true;
          if (s) return true;
          q = r === 14;
          if (q) {
            if (A.a7(a, c[b.y], c, d, e)) return true;
          }
          p = d.x;
          if (r === 6) return A.a7(a, b.y, c, d, e);
          if (p === 6) {
            s = d.y;
            return A.a7(a, b, c, s, e);
          }
          if (r === 8) {
            if (!A.a7(a, b.y, c, d, e)) return false;
            return A.a7(a, A.oZ(a, b), c, d, e);
          }
          if (r === 7) {
            s = A.a7(a, b.y, c, d, e);
            return s;
          ...
          if (p === 8) {
            if (A.a7(a, b, c, d.y, e)) return true;
            return A.a7(a, b, c, A.oZ(a, d), e);
          }
          if (p === 7) {
            s = A.a7(a, b, c, d.y, e);
            return s;
          ...
          if (p === 13) {
            ...
            for (l = 0; l < m; ++l) {
              k = o[l];
              j = n[l];
              if (!A.a7(a, k, c, j, e) || !A.a7(a, j, e, k, c)) return false;
            }
            return A.pA(a, b.y, c, d.y, e);
          }
          if (p === 12) {
            if (b === t.g) return true;
            if (s) return false;
            return A.pA(a, b, c, d, e);
          }
          if (r === 9) {
            if (p !== 9) return false;
            return A.wk(a, b, c, d, e);
          }
          s = r === 11;
          if (s && d === t.gT) return true;
          if (s && p === 11) return A.wo(a, b, c, d, e);
          return false;
        },
        pA(a2, a3, a4, a5, a6) {
          var s, r, q, p, o, n, m, l, k, j, i, h, g, f, e, d, c, b, a, a0, a1;
          if (!A.a7(a2, a3.y, a4, a5.y, a6)) return false;
          s = a3.z;
          r = a5.z;
          q = s.a;
          p = r.a;
          ...
          for (h = 0; h < o; ++h) {
            g = q[h];
            if (!A.a7(a2, p[h], a6, g, a4)) return false;
          }
          for (h = 0; h < m; ++h) {
            g = l[h];
            if (!A.a7(a2, p[o + h], a6, g, a4)) return false;
          }
          for (h = 0; h < i; ++h) {
            g = l[m + h];
            if (!A.a7(a2, k[h], a6, g, a4)) return false;
          }
          f = s.c;
          e = r.c;
          d = f.length;
          ...
          for (b = 0, a = 0; a < c; a += 3) {
            ...
            for (; true; ) {
              ...
              if (a1 < a0) continue;
              g = f[b - 1];
              if (!A.a7(a2, e[a + 2], a6, g, a4)) return false;
              break;
            }
          }
          return true;
        ...
        wk(a, b, c, d, e) {
          ...
          for (; l !== k; ) {
            ...
            q = r.length;
            p = q > 0 ? new Array(q) : v2.typeUniverse.sEA;
            for (o = 0; o < q; ++o) p[o] = A.mt(a, b, r[o]);
            return A.pu(a, p, null, c, d.z, e);
          }
          n = b.z;
          m = d.z;
        ...
        pu(a, b, c, d, e, f) {
          ...
          for (s = 0; s < p; ++s) {
            r = b[s];
            q = e[s];
            if (!A.a7(a, r, d, q, f)) return false;
          }
          return true;
        },
        wo(a, b, c, d, e) {
          ...
          for (s = 0; s < p; ++s) if (!A.a7(a, r[s], c, q[s], e)) return false;
          return true;
        },
        n0(a) {
          var s, r = a.x;
        ...
        mv(a) {
          return a > 0 ? new Array(a) : v2.typeUniverse.sEA;
        },
        aF: function aF(a, b) {
          var _ = this;
          _.a = a;
        ...
        vg() {
          ...
          } else if (self.setImmediate != null) return A.wQ();
          return A.wR();
        },
        vh(a) {
          self.scheduleImmediate(A.mO(new A.lX(a), 0));
        },
        vi(a) {
          self.setImmediate(A.mO(new A.lY(a), 0));
        },
        vj(a) {
          A.vv(0, a);
        },
        ...
        ex(a) {
          return new A.fD(new A.C($.B, a.h("C<0>")), a.h("fD<0>"));
        },
        et(a, b) {
          a.$2(0, null);
          b.b = true;
        ...
        w2(a, b) {
          var s, r, q = new A.mx(b), p = new A.my(b);
        ...
        bS(a, b) {
          return new A.eg(a, b.h("eg<0>"));
        },
        h9(a, b) {
          var s = A.bU(a, "error", t.K);
          ...
          for (s = t.d; true; ) {
            ...
            if (k) {
              ...
              if ((e & 15) === 8) new A.md(r, f, o).$0();
                ...
                if ((e & 1) !== 0) new A.mc(r, l).$0();
              } else if ((e & 2) !== 0) new A.mb(f, r).$0();
              if (i != null) $.B = i;
              e = r.c;
              if (s.b(e)) {
                q = r.a.$ti;
                q = q.h("a5<2>").b(e) || !q.z[1].b(e);
              } else q = false;
              if (q) {
                h = r.a.b;
                if (e instanceof A.C) if ((e.a & 24) !== 0) {
                  g = h.c;
                  h.c = null;
                  b = h.bc(g);
                  h.a = e.a & 30 | h.a & 1;
        ...
        wA(a, b) {
          if (t.C.b(a)) return b.c1(a);
          if (t.v.b(a)) return a;
          throw A.d(A.h7(a, "onError", u.c));
        },
        wv() {
          var s, r;
          for (s = $.dg; s != null; s = $.dg) {
            $.ew = null;
            r = s.b;
            $.dg = r;
            if (r == null) $.ev = null;
        ...
        fs(a, b) {
          var s = null, r = b.h("aZ<0>"), q = new A.aZ(s, s, s, s, r);
          q.aJ(a);
          q.aK();
          return new A.aj(q, r.h("aj<1>"));
        },
        v9(a, b) {
          var s = null, r = b.h("db<0>"), q = new A.db(s, s, s, s, r);
        ...
        p1(a, b, c, d) {
          return new A.aZ(null, b, c, a, d.h("aZ<0>"));
        },
        nM(a) {
          var s, r, q;
          if (a == null) return;
        ...
        nu(a, b, c) {
          return A.pN(a, new A.aC(b.h("@<0>").I(c).h("aC<1,2>")));
        },
        a9(a, b) {
          return new A.aC(a.h("@<0>").I(b).h("aC<1,2>"));
        },
        vo(a, b, c, d, e) {
          var s = c != null ? c : new A.mi(d);
          return new A.e5(a, b, s, d.h("@<0>").I(e).h("e5<1,2>"));
        },
        oH(a) {
          return new A.b_(a.h("b_<0>"));
        },
        aD(a) {
          return new A.b_(a.h("b_<0>"));
        },
        aP(a, b) {
          return A.x4(a, new A.b_(b.h("b_<0>")));
        },
        nC() {
          var s = /* @__PURE__ */ Object.create(null);
        ...
        nL(a) {
          var s, r;
          for (s = $.cJ.length, r = 0; r < s; ++r) if (a === $.cJ[r]) return true;
          return false;
        },
        ws(a, b) {
          var s, r, q, p, o, n, m, l = a.gH(a), k = 0, j = 0;
          while (true) {
            if (!(k < 80 || j < 3)) break;
            if (!l.q()) return;
            s = A.b(l.gt());
        ...
        mA(a) {
          ...
          if (a == null) return null;
          if (typeof a != "object") return a;
          if (Object.getPrototypeOf(a) !== Array.prototype) return new A.fM(a, /* @__PURE__ */ Object.create(null));
        ...
        os(a, b, c, d, e, f) {
          if (B.c.br(f, 4) !== 0) throw A.d(A.R("Invalid base64 padding, padded length must be multiple of four, is " + f, a, c));
        ...
        vm(a, b, c, d, e, f) {
          var s, r, q, p, o, n, m = "Invalid encoding before padding", l = "Invalid character", k = B.c.ai(f, 2), j = f & 3, i = $.ok();
          for (s = b, r = 0; s < c; ++s) {
            q = B.a.B(a, s);
            r |= q;
            p = i[q & 127];
            if (p >= 0) {
              ...
              if (r > 127) break;
              if (j === 3) {
                if ((k & 3) !== 0) throw A.d(A.R(m, a, s));
                d[e] = k >>> 10;
                d[e + 1] = k >>> 2;
              } else {
                if ((k & 15) !== 0) throw A.d(A.R(m, a, s));
                d[e] = k >>> 4;
              }
              n = (3 - j) * 3;
              if (q === 37) n += 2;
              return A.pc(a, s + 1, c, -n - 1);
            }
            throw A.d(A.R(l, a, s));
          }
          if (r >= 0 && r <= 127) return (k << 2 | j) >>> 0;
          for (s = b; s < c; ++s) {
            q = B.a.B(a, s);
            if (q > 127) break;
          }
        ...
        vk(a, b, c, d) {
          var s = A.vl(a, b, c), r = (d & 3) + (s - b), q = B.c.ai(r, 2) * 3, p = r & 3;
          if (p !== 0 && s < c) q += p - 1;
        ...
        pc(a, b, c, d) {
          ...
          if (b !== c) throw A.d(A.R("Invalid padding character", a, b));
          return -s - 1;
        },
        ps(a) {
          switch (a) {
        ...
        u6(a) {
          if (a instanceof A.c7) return a.k(0);
        ...
        p2(a, b, c) {
          if (t.bm.b(a)) return A.v2(a, b, A.aQ(b, c, a.length));
          return A.va(a, b, c);
        },
        va(a, b, c) {
          var s, r, q, p, o = null;
          ...
          if (s) for (; r.q(); ) p.push(r.d);
            ...
            if (!r.q()) throw A.d(A.Y(c, b, q, o, o));
            p.push(r.d);
          }
          return A.v0(p);
        },
        nx(a) {
          return new A.iK(a, A.uk(a, false, true, false, false, false));
        },
        ny(a, b, c) {
          var s = J.aA(b);
          if (!s.q()) return a;
          if (c.length === 0) {
            ...
            a += A.b(s.gt());
            for (; s.q(); ) a = a + c + A.b(s.gt());
          }
          return a;
        },
        uT(a, b, c, d, e) {
          return new A.dH(a, b, c, d, e);
        },
        oy(a) {
        ...
        cS(a) {
          if (typeof a == "number" || A.eu(a) || a == null) return J.as(a);
        ...
        K(a, b) {
          return new A.at(false, null, b, a);
        },
        h7(a, b, c) {
          return new A.at(true, a, b, c);
        },
        h8(a, b) {
          return a;
        },
        Y(a, b, c, d, e) {
          return new A.dL(b, c, true, a, d, "Invalid value");
        },
        aQ(a, b, c) {
          if (0 > a || a > c) throw A.d(A.Y(a, 0, c, "start", null));
          if (b != null) {
            if (a > b || b > c) throw A.d(A.Y(b, a, c, "end", null));
            return b;
          }
          return c;
        },
        aW(a, b) {
          if (a < 0) throw A.d(A.Y(a, 0, null, b, null));
          return a;
        },
        eW(a, b, c, d, e) {
          return new A.eV(b, true, a, e, "Index out of range");
        },
        ad(a) {
          return new A.fz(a);
        },
        ...
        R(a, b, c) {
          return new A.aK(a, b, c);
        },
        oE(a, b, c) {
          if (a <= 0) return new A.b7(c.h("b7<0>"));
          return new A.e0(a, b, c.h("e0<0>"));
        },
        oK(a, b, c, d, e) {
          return new A.c6(a, b.h("@<0>").I(c).I(d).I(e).h("c6<1,2,3,4>"));
        },
        k6(a) {
          var s, r, q = $.to();
          for (s = a.length, r = 0; r < s; ++r) {
            q = q + J.bY(a[r]) & 536870911;
        ...
        p6(a6) {
          var s, r, q, p, o, n, m, l, k, j, i, h, g, f, e, d, c, b, a, a0, a1, a2, a3, a4 = null, a5 = a6.length;
          if (a5 >= 5) {
            s = A.pI(a6, 0);
            if (s === 0) {
              r = A.lw(a5 < a5 ? B.a.u(a6, 0, a5) : a6, 5, a4);
              return r.gbo(r);
            } else if (s === 32) {
              r = A.lw(B.a.u(a6, 5, a5), 0, a4);
              return r.gbo(r);
            }
          }
          q = A.U(8, 0, false, t.S);
          ...
          if (j) if (o > p + 3) {
            ...
            if (r && n + 1 === m) {
              ...
              if (!B.a.U(a6, "\\", m)) if (o > 0) h = B.a.U(a6, "\\", o - 1) || B.a.U(a6, "\\", o - 2);
              else h = false;
              else h = true;
              if (h) {
                i = a4;
                ...
                if (!(l < a5 && l === m + 2 && B.a.U(a6, "..", m))) h = l > m + 2 && B.a.U(a6, "/..", l - 3);
                else h = true;
                if (h) {
                  i = a4;
                  j = false;
                } else {
                  if (p === 4) if (B.a.U(a6, "file", 0)) {
                    if (o <= 0) {
                      if (!B.a.U(a6, "/", m)) {
                        g = "file:///";
                        f = 3;
                    ...
                    i = "file";
                  } else if (B.a.U(a6, "http", 0)) {
                    if (r && n + 3 === m && B.a.U(a6, "80", n + 1)) {
                      k -= 3;
                      d = m - 3;
                      l -= 3;
                      a6 = B.a.aH(a6, n, m, "");
                  ...
                  else if (p === 5 && B.a.U(a6, "https", 0)) {
                    if (r && n + 4 === m && B.a.U(a6, "443", n + 1)) {
                      k -= 4;
                      d = m - 4;
                      l -= 4;
                      a6 = B.a.aH(a6, n, m, "");
          ...
          if (j) {
            ...
            return new A.fP(a6, p, o, n, m, l, k, i);
          }
          if (i == null) if (p > 0) i = A.vS(a6, 0, p);
          else {
            if (p === 0) {
              A.dc(a6, 0, "Invalid empty scheme");
              A.bg(u.g);
            }
            i = "";
          }
          if (o > 0) {
            ...
            r = n + 1;
            if (r < m) {
              a0 = A.oY(B.a.u(a6, r, m), a4);
              a1 = A.vQ(a0 == null ? A.Z(A.R("Invalid port", a6, r)) : a0, i);
            } else a1 = a4;
          } else {
            a1 = a4;
            a = a1;
          ...
          a2 = A.vP(a6, m, l, a4, i, a != null);
          a3 = l < k ? A.vR(a6, l + 1, k, a4) : a4;
          return A.vJ(i, b, a, a1, a2, a3, k < a5 ? A.vN(a6, k + 1, a5) : a4);
        },
        vd(a, b, c) {
          var s, r, q, p, o, n, m = "IPv4 address should contain exactly 4 parts", l = "each part must be in the range 0..255", k = new A.lx(a), j = new Uint8Array(4);
        ...
        p7(a, b, a0) {
          var s, r, q, p, o, n, m, l, k, j, i, h, g, f, e = null, d = new A.ly(a), c = new A.lz(d, a);
          if (a.length < 2) d.$2("address is too short", e);
          s = A.a([], t.Z);
          for (r = b, q = r, p = false, o = false; r < a0; ++r) {
            n = B.a.B(a, r);
            if (n === 58) {
              if (r === b) {
                ++r;
        ...
        vO(a, b, c, d) {
          ...
          if (B.a.B(a, b) === 91) {
            s = c - 1;
            if (B.a.B(a, s) !== 93) {
              A.dc(a, b, "Missing end `]` to match `[` in host");
              A.bg(u.g);
            }
            r = b + 1;
            q = A.vL(a, r, s);
            if (q < s) {
              p = q + 1;
              o = A.pr(a, B.a.U(a, "25", p) ? q + 3 : p, s, "%25");
            } else o = "";
            A.p7(a, r, q);
            return B.a.u(a, b, q).toLowerCase() + o + "]";
          }
          for (n = b; n < c; ++n) if (B.a.B(a, n) === 58) {
            q = B.a.bg(a, "%", b);
            q = q >= b && q < c ? q : c;
            if (q < c) {
              p = q + 1;
              o = A.pr(a, B.a.U(a, "25", p) ? q + 3 : p, c, "%25");
            } else o = "";
            A.p7(a, b, q);
            return "[" + B.a.u(a, b, q) + o + "]";
          }
          return A.vV(a, b, c);
        },
        vL(a, b, c) {
        ...
        pr(a, b, c, d) {
          var s, r, q, p, o, n, m, l, k, j, i = d !== "" ? new A.ac(d) : null;
          for (s = b, r = s, q = true; s < c; ) {
            p = B.a.B(a, s);
            if (p === 37) {
              o = A.nI(a, s, true);
              n = o == null;
              ...
              if (n) o = B.a.u(a, s, s + 3);
                ...
                A.dc(a, s, "ZoneID should not contain % anymore");
                A.bg(u.g);
              }
              i.a = m + o;
              s += 3;
              r = s;
              q = true;
            } else if (p < 127 && (B.av[p >>> 4] & 1 << (p & 15)) !== 0) {
              if (q && 65 <= p && 90 >= p) {
                if (i == null) i = new A.ac("");
                if (r < s) {
                  i.a += B.a.u(a, r, s);
        ...
        vV(a, b, c) {
          ...
          for (s = b, r = s, q = null, p = true; s < c; ) {
            ...
            if (o === 37) {
              ...
              r = s;
              p = true;
            } else if (o < 127 && (B.db[o >>> 4] & 1 << (o & 15)) !== 0) {
              if (p && 65 <= o && 90 >= o) {
                if (q == null) q = new A.ac("");
                if (r < s) {
                  q.a += B.a.u(a, r, s);
              ...
              ++s;
            } else if (o <= 93 && (B.an[o >>> 4] & 1 << (o & 15)) !== 0) {
              A.dc(a, s, "Invalid character");
              A.bg(u.g);
            } else {
        ...
        vS(a, b, c) {
          ...
          if (b === c) return "";
          if (!A.po(B.a.J(a, b))) {
            A.dc(a, b, "Scheme not starting with alphabetic character");
            A.bg(p);
          }
          for (s = b, r = false; s < c; ++s) {
            q = B.a.J(a, s);
            if (!(q < 128 && (B.as[q >>> 4] & 1 << (q & 15)) !== 0)) {
              A.dc(a, s, "Illegal scheme character");
              A.bg(p);
            }
            if (65 <= q && q <= 90) r = true;
          }
        ...
        vT(a, b, c) {
          return A.eo(a, b, c, B.cQ, false, false);
        },
        vP(a, b, c, d, e, f) {
          var s = e === "file", r = s || f, q = A.eo(a, b, c, B.ax, true, true);
          if (q.length === 0) {
            if (s) return "/";
          } else if (r && !B.a.Y(q, "/")) q = "/" + q;
          return A.vU(q, e, f);
        },
        vU(a, b, c) {
          var s = b.length === 0;
        ...
        vR(a, b, c, d) {
          return A.eo(a, b, c, B.D, true, false);
        },
        vN(a, b, c) {
          return A.eo(a, b, c, B.D, true, false);
        },
        ...
        nH(a) {
          ...
          return A.p2(s, 0, null);
        },
        eo(a, b, c, d, e, f) {
          var s = A.pq(a, b, c, d, e, f);
          return s == null ? B.a.u(a, b, c) : s;
        },
        pq(a, b, c, d, e, f) {
          var s, r, q, p, o, n, m, l, k, j, i = null;
          for (s = !e, r = b, q = r, p = i; r < c; ) {
            ...
            if (o < 127 && (d[o >>> 4] & 1 << (o & 15)) !== 0) ++r;
              ...
              if (o === 37) {
                ...
                n = "/";
                m = 1;
              } else if (s && o <= 93 && (B.an[o >>> 4] & 1 << (o & 15)) !== 0) {
                A.dc(a, r, "Invalid character");
                A.bg(u.g);
                m = i;
                n = m;
              } else {
        ...
        vX(a) {
          ...
          if (!A.pp(a)) return a;
          s = A.a([], t.s);
          for (r = a.split("/"), q = r.length, p = false, o = 0; o < q; ++o) {
            n = r[o];
            if (J.af(n, "..")) {
              if (s.length !== 0) {
                s.pop();
        ...
        pn(a) {
          var s, r, q = a.length;
          if (q >= 2 && A.po(B.a.J(a, 0))) for (s = 1; s < q; ++s) {
            r = B.a.J(a, s);
            if (r === 58) return B.a.u(a, 0, s) + "%3A" + B.a.bu(a, s + 1);
            if (r > 127 || (B.as[r >>> 4] & 1 << (r & 15)) === 0) break;
          }
          return a;
        },
        vM(a, b) {
          ...
          for (s = 0, r = 0; r < 2; ++r) {
            ...
            if (48 <= q && q <= 57) s = s * 16 + q - 48;
              ...
              else throw A.d(A.K("Invalid URL encoding", null));
            }
          }
          return s;
        },
        vY(a, b, c, d, e) {
          ...
          if (s) {
            ...
            for (q = a.length, o = b; o < c; ++o) {
              ...
              if (r === 37) {
                if (o + 3 > q) throw A.d(A.K("Truncated URI", null));
                p.push(A.vM(a, o + 1));
                o += 2;
              } else p.push(r);
            }
        ...
        p5(a) {
          ...
          if (a.length >= 5) {
            ...
            if (s === 32) return A.lw(B.a.bu(a, 5), 0, null);
          }
          throw A.d(A.R("Does not start with 'data:'", a, 0));
        },
        lw(a, b, c) {
          var s, r, q, p, o, n, m, l, k = "Invalid MIME type", j = A.a([b - 1], t.Z);
          ...
          if (q < 0 && r > b) throw A.d(A.R(k, a, r));
          for (; p !== 44; ) {
            j.push(r);
            ++r;
            for (o = -1; r < s; ++r) {
          ...
          if ((j.length & 1) === 1) a = B.b7.ee(a, m, s);
            ...
            l = A.pq(a, m, s, B.D, true, false);
            if (l != null) a = B.a.aH(a, m, s, l);
          }
          return new A.lv(a, j, c);
        },
        w6() {
          var s, r, q, p, o, n = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-._~!$&'()*+,;=", m = ".", l = ":", k = "/", j = "\\", i = "?", h = "#", g = "/\\", f = A.a(new Array(22), t.gN);
        ...
        pI(a, b) {
          return ((B.a.J(a, b + 4) ^ 58) * 3 | B.a.J(a, b) ^ 100 | B.a.J(a, b + 1) ^ 97 | B.a.J(a, b + 2) ^ 116 | B.a.J(a, b + 3) ^ 97) >>> 0;
        },
        k2: function k2(a, b) {
          this.a = a;
          this.b = b;
        ...
        fP: function fP(a, b, c, d, e, f, g, h) {
          var _ = this;
          _.a = a;
          _.b = b;
          _.c = c;
        ...
        nR(a) {
          if (!t.I.b(a) && !t.j.b(a)) throw A.d(A.K("object must be a Map or Iterable", null));
          return A.w5(a);
        },
        w5(a) {
          var s = new A.mz(new A.e4(t.aH)).$1(a);
          s.toString;
          return s;
        },
        mz: function mz(a) {
        ...
        tN(a, b) {
          var s, r, q, p, o, n, m, l, k, j, i, h, g, f = "byteOffset", e = null, d = "normalized";
          A.w(a, B.cZ, b);
          s = A.W(a, "bufferView", b, false);
          if (s === -1) {
            r = a.v(f);
            if (r) b.l($.cO(), A.a(["bufferView"], t.M), f);
            q = 0;
          } else q = A.a0(a, f, b, 0, e, -1, 0, false);
          p = A.a0(a, "componentType", b, -1, B.cu, -1, 0, true);
          o = A.a0(a, "count", b, -1, e, -1, 1, true);
          n = A.J(a, "type", b, e, B.m.gN(), e, true);
          m = A.pO(a, d, b);
          if (n != null && p !== -1) {
            l = B.m.i(0, n);
            if (l != null) if (p === 5126) {
              r = t.V;
              k = A.ae(a, "min", b, e, A.a([l], r), 1 / 0, -1 / 0, true);
              j = A.ae(a, "max", b, e, A.a([l], r), 1 / 0, -1 / 0, true);
            } else {
              k = A.pP(a, "min", b, p, l);
              j = A.pP(a, "max", b, p, l);
            }
          ...
          switch (p) {
            ...
            case 5125:
              ...
              r.a(j);
              r.a(k);
              A.J(a, "name", b, e, e, e, false);
              r = A.t(a, B.S, b, e);
              h = A.x(a, b);
              g = new A.fC(s, q, p, o, n, m, j, k, i, A.b0(p), r, h, false);
              if (k != null) {
                r = b.S();
                h = t.e;
                b.a_(g, new A.f6(A.U(k.length, 0, false, h), A.U(k.length, 0, false, h), J.h4(k, false), r));
              }
              if (j != null) {
                r = b.S();
                h = t.e;
                b.a_(g, new A.f4(A.U(j.length, 0, false, h), A.U(j.length, 0, false, h), J.h4(j, false), r));
              }
              break;
            default:
              r = t.fy;
              ...
              r = A.t(a, B.S, b, e);
              h = A.x(a, b);
              g = new A.fB(s, q, p, o, n, m, j, k, i, A.b0(p), r, h, false);
              b.a_(g, new A.eY(b.S()));
              if (k != null) {
                r = b.S();
                b.a_(g, new A.f5(A.U(k.length, 0, false, t.e), A.U(k.length, 0, false, t.F), J.h4(k, false), r));
              }
              if (j != null) {
                r = b.S();
                b.a_(g, new A.f3(A.U(j.length, 0, false, t.e), A.U(j.length, 0, false, t.F), J.h4(j, false), r));
              }
              break;
          }
          return g;
        ...
        tM(a, b) {
          var s, r, q;
          A.w(a, B.cH, b);
          s = A.a0(a, "count", b, -1, null, -1, 1, true);
          r = A.T(a, "indices", b, A.wI(), true);
          q = A.T(a, "values", b, A.wJ(), true);
          if (s === -1 || r == null || q == null) return null;
          return new A.bZ(s, r, q, A.t(a, B.dP, b, null), A.x(a, b), false);
        },
        tK(a, b) {
          A.w(a, B.cA, b);
          return new A.c_(A.W(a, "bufferView", b, true), A.a0(a, "byteOffset", b, 0, null, -1, 0, false), A.a0(a, "componentType", b, -1, B.ce, -1, 0, true), A.t(a, B.dN, b, null), A.x(a, b), false);
        },
        tL(a, b) {
          A.w(a, B.cD, b);
          return new A.c0(A.W(a, "bufferView", b, true), A.a0(a, "byteOffset", b, 0, null, -1, 0, false), A.t(a, B.dO, b, null), A.x(a, b), false);
        },
        a4: function a4() {
        },
        fC: function fC(a, b, c, d, e, f, g, h, i, j, k, l, m) {
          var _ = this;
          _.w = a;
          _.x = b;
          _.y = c;
        ...
        fB: function fB(a, b, c, d, e, f, g, h, i, j, k, l, m) {
          var _ = this;
          _.w = a;
          _.x = b;
          _.y = c;
        ...
        tP(a0, a1) {
          var s, r, q, p, o, n, m, l, k, j, i, h, g, f, e, d = null, c = "channels", b = "extras", a = "samplers";
          A.w(a0, B.cF, a1);
          s = A.eB(a0, c, a1);
          if (s != null) {
            r = s.gj(s);
            q = A.U(r, d, false, t.aA);
            p = new A.F(q, r, c, t.eq);
            r = a1.c;
            r.push(c);
            for (o = t.h, n = 0; n < s.gj(s); ++n) {
              m = s.i(0, n);
              r.push(B.c.k(n));
              A.w(m, B.di, a1);
              l = A.W(m, "sampler", a1, true);
              k = A.T(m, "target", a1, A.wM(), true);
              j = A.t(m, B.dQ, a1, d);
              i = m.i(0, b);
              if (i != null && !o.b(i)) a1.n($.dk(), b);
              q[n] = new A.b2(l, k, j, i, false);
              r.pop();
            }
            r.pop();
          } else p = d;
          ...
          if (h != null) {
            r = h.gj(h);
            q = A.U(r, d, false, t.gW);
            g = new A.F(q, r, a, t.az);
            r = a1.c;
            r.push(a);
            for (o = t.h, n = 0; n < h.gj(h); ++n) {
              f = h.i(0, n);
              r.push(B.c.k(n));
              A.w(f, B.cW, a1);
              l = A.W(f, "input", a1, true);
              k = A.J(f, "interpolation", a1, "LINEAR", B.cq, d, false);
              j = A.W(f, "output", a1, true);
              e = A.t(f, B.dR, a1, d);
              i = f.i(0, b);
              if (i != null && !o.b(i)) a1.n($.dk(), b);
              q[n] = new A.b3(l, k, j, e, i, false);
              r.pop();
            }
            r.pop();
          } else g = d;
          A.J(a0, "name", a1, d, d, d, false);
          return new A.bv(p, g, A.t(a0, B.T, a1, d), A.x(a0, a1), false);
        },
        tO(a, b) {
          var s, r;
          A.w(a, B.d3, b);
          s = A.t(a, B.aC, b, B.T);
          r = new A.bw(A.W(a, "node", b, false), A.J(a, "path", b, null, b.fy, null, true), s, A.x(a, b), false);
          b.W(r, A.bc(s.gX(), true, t._));
          return r;
        },
        ...
        tQ(a, b) {
          var s, r, q, p, o = null, n = "minVersion";
          A.w(a, B.cC, b);
          A.J(a, "copyright", b, o, o, o, false);
          s = A.J(a, "generator", b, o, o, o, false);
          r = $.br();
          q = A.J(a, "version", b, o, o, r, true);
          r = A.J(a, n, b, o, o, r, false);
          p = new A.bx(s, q, r, A.t(a, B.dS, b, o), A.x(a, b), false);
          if (r != null && q != null) {
            if (p.gcS() <= p.gbj()) s = p.gcS() === p.gbj() && p.ged() > p.gbW();
            else s = true;
            if (s) b.l($.rV(), A.a([r, q], t.M), n);
          }
          return p;
        },
        ...
        tU(a, b) {
          var s, r, q, p, o, n, m, l, k = null, j = "uri";
          A.w(a, B.dk, b);
          p = A.a0(a, "byteLength", b, -1, k, -1, 1, true);
          s = null;
          o = a.v(j);
          if (o) {
            r = A.J(a, j, b, k, k, k, false);
            if (r != null) {
              if (b.dx) b.n($.o2(), j);
              q = null;
              try {
                ...
                if (A.M(n2) instanceof A.aK) s = A.pS(r, b);
                else throw n2;
              }
              if (q != null) {
                if (b.dx) b.n($.o1(), j);
                switch (q.gbV().toLowerCase()) {
                  case "application/gltf-buffer":
                  case "application/octet-stream":
                    m = q.cD();
                    break;
                  default:
                    b.l($.ry(), A.a([q.gbV()], t.M), j);
                    m = k;
                    break;
                }
              } else m = k;
          ...
          l = s;
          A.J(a, "name", b, k, k, k, false);
          return new A.aT(l, p, o, m, A.t(a, B.dT, b, k), A.x(a, b), false);
        },
        ...
        tT(a, b) {
          var s, r, q, p, o, n = null, m = "byteStride";
          A.w(a, B.cp, b);
          s = A.a0(a, "byteLength", b, -1, n, -1, 1, true);
          r = A.a0(a, m, b, -1, n, 252, 4, false);
          q = A.a0(a, "target", b, -1, B.cb, -1, 0, false);
          if (r !== -1) {
            if (s !== -1 && r > s) b.l($.rz(), A.a([r, s], t.M), m);
            if (r % 4 !== 0) b.l($.rr(), A.a([r, 4], t.M), m);
            if (q === 34963) b.n($.nj(), m);
          }
          p = A.W(a, "buffer", b, true);
          o = A.a0(a, "byteOffset", b, 0, n, -1, 0, false);
          A.J(a, "name", b, n, n, n, false);
          return new A.by(p, o, s, r, q, A.t(a, B.aD, b, n), A.x(a, b), false);
        },
        by: function by(a, b, c, d, e, f, g, h) {
          var _ = this;
          _.w = a;
          _.x = b;
          _.y = c;
        ...
        tX(a, b) {
          var s = null, r = "orthographic", q = "perspective";
          A.w(a, B.dj, b);
          if (a.v(r) && a.v(q)) b.F($.oe(), B.aw);
          switch (A.J(a, "type", b, s, B.aw, s, true)) {
            case "orthographic":
              A.T(a, r, b, A.wV(), true);
              break;
            case "perspective":
          ...
          A.J(a, "name", b, s, s, s, false);
          return new A.bz(A.t(a, B.dW, b, s), A.x(a, b), false);
        },
        tV(a, b) {
          var s, r, q, p, o = "xmag", n = "ymag";
          A.w(a, B.dq, b);
          s = A.E(a, o, b, 0 / 0, 1 / 0, -1 / 0, 1 / 0, -1 / 0, true, 0 / 0);
          r = A.E(a, n, b, 0 / 0, 1 / 0, -1 / 0, 1 / 0, -1 / 0, true, 0 / 0);
          q = A.E(a, "zfar", b, 0 / 0, 1 / 0, 0, 1 / 0, -1 / 0, true, 0 / 0);
          p = A.E(a, "znear", b, 0 / 0, 1 / 0, -1 / 0, 1 / 0, 0, true, 0 / 0);
          if (q <= p) b.L($.oh());
          if (s === 0) b.n($.og(), o);
          else if (s < 0) b.n($.of(), o);
          if (r === 0) b.n($.og(), n);
          else if (r < 0) b.n($.of(), n);
          return new A.c3(A.t(a, B.dU, b, null), A.x(a, b), false);
        },
        tW(a, b) {
          var s, r, q;
          A.w(a, B.cB, b);
          s = A.E(a, "yfov", b, 0 / 0, 1 / 0, 0, 1 / 0, -1 / 0, true, 0 / 0);
          if (s >= 3.141592653589793) b.L($.rA());
          r = A.E(a, "zfar", b, 0 / 0, 1 / 0, 0, 1 / 0, -1 / 0, false, 0 / 0);
          q = A.E(a, "znear", b, 0 / 0, 1 / 0, 0, 1 / 0, -1 / 0, true, 0 / 0);
          if (r <= q) b.L($.oh());
          A.E(a, "aspectRatio", b, 0 / 0, 1 / 0, 0, 1 / 0, -1 / 0, false, 0 / 0);
          return new A.c4(A.t(a, B.dV, b, null), A.x(a, b), false);
        },
        ...
        oC(c0, c1) {
          var s, r, q, p, o, n, m, l, k, j, i, h, g, f, e, d, c, b, a, a0, a1, a2, a3, a4, a5, a6, a7, a8, a9, b0, b1, b2, b3, b4, b5, b6 = "extensionsRequired", b7 = "extensionsUsed", b8 = null, b9 = new A.iw(c1);
          b9.$0();
          A.w(c0, B.dr, c1);
          ...
          c1.e9(s, r);
          q = new A.ix(c0, b9, c1);
          p = new A.iy(b9, c0, c1).$1$3$req("asset", A.wO(), true, t.gP);
          ...
          a2 = A.t(c0, B.U, c1, b8);
          b9.$0();
          a3 = new A.du(s, r, m, l, p, k, j, i, h, g, f, e, d, a, a0, a1, a2, A.x(c0, c1), false);
          a4 = new A.iu(c1, a3);
          a4.$2(j, B.aD);
          a4.$2(m, B.S);
          a4.$2(h, B.aE);
          ...
          for (a6 = 0; a6 < 11; ++a6) {
            ...
            n.push(a7.c);
            for (o = a7.b, a8 = a7.a, a9 = a8.length, b0 = 0; b0 < o; ++b0) {
              b1 = b0 >= a9;
              b1 = b1 ? b8 : a8[b0];
              if ((b1 == null ? b8 : b1.a$) === false) c1.Z($.h1(), b0);
            }
            n.pop();
          }
          o = c1.x;
          if (o.a !== 0) {
            for (a8 = A.uH(o, o.r, A.A(o).c); a8.q(); ) {
              a9 = a8.d;
              if (a9.gj(a9) === 0) continue;
              b2 = o.i(0, a9);
              B.d.P(n);
              B.d.D(n, b2);
              for (b1 = a9.b, a9 = a9.a, b3 = a9.length, b0 = 0; b0 < b1; ++b0) {
                b4 = b0 >= b3;
                b4 = b4 ? b8 : a9[b0];
                if ((b4 == null ? b8 : b4.a$) === false) c1.Z($.h1(), b0);
              }
            }
            B.d.P(n);
          }
          n.push("meshes");
          for (o = f.b, a8 = f.a, a9 = a8.length, b0 = 0; b0 < o; ++b0) {
            b1 = b0 >= a9;
            b5 = b1 ? b8 : a8[b0];
            if ((b5 == null ? b8 : b5.x) != null && b5.a$ && !b5.y) {
              n.push(B.c.k(b0));
              c1.n($.ro(), "weights");
              n.pop();
            }
        ...
        du: function du(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s) {
          var _ = this;
          _.d = a;
          _.e = b;
          _.f = c;
        ...
        ug(a, b) {
          var s, r, q, p, o, n, m, l, k, j = "bufferView", i = null, h = "uri";
          A.w(a, B.cE, b);
          p = A.W(a, j, b, false);
          o = A.J(a, "mimeType", b, i, b.dy, i, false);
          s = A.J(a, h, b, i, i, i, false);
          n = p === -1;
          m = !n;
          ...
          if (s != null) {
            ...
            try {
              ...
              if (A.M(l2) instanceof A.aK) r = A.pS(s, b);
              else throw l2;
            }
            if (q != null) {
              if (b.dx) b.n($.o1(), h);
              ...
              if (n) {
                b.l($.od(), A.a([s, "The declared mediatype does not match the embedded content."], t.M), h);
                k = i;
              }
            } else k = i;
          } else k = i;
          n = r;
          A.J(a, "name", b, i, i, i, false);
          return new A.aU(p, o, n, k, A.t(a, B.aE, b, i), A.x(a, b), false);
        },
        ...
        uL(a, b) {
          var s, r, q, p, o, n, m, l, k, j, i = null, h = "alphaCutoff";
          A.w(a, B.cs, b);
          s = A.T(a, "pbrMetallicRoughness", b, A.xH(), false);
          r = A.T(a, "normalTexture", b, A.pV(), false);
          q = A.T(a, "occlusionTexture", b, A.xG(), false);
          p = A.T(a, "emissiveTexture", b, A.ao(), false);
          o = A.ae(a, "emissiveFactor", b, B.ak, B.l, 1, 0, false);
          n = A.J(a, "alphaMode", b, "OPAQUE", B.cr, i, false);
          A.E(a, h, b, 0.5, 1 / 0, -1 / 0, 1 / 0, 0, false, 0 / 0);
          if (n !== "MASK" && a.v(h)) b.n($.rO(), h);
          m = A.pO(a, "doubleSided", b);
          l = A.t(a, B.f, b, i);
          A.J(a, "name", b, i, i, i, false);
          k = new A.ai(s, r, q, p, o, m, A.a9(t.X, t.e), l, A.x(a, b), false);
          j = A.a([s, r, q, p], t.M);
          B.d.D(j, l.gX());
          b.W(k, j);
          return k;
        ...
        uX(a, b) {
          var s, r, q, p, o;
          A.w(a, B.cG, b);
          A.ae(a, "baseColorFactor", b, B.al, B.P, 1, 0, false);
          s = A.T(a, "baseColorTexture", b, A.ao(), false);
          A.E(a, "metallicFactor", b, 1, 1 / 0, -1 / 0, 1, 0, false, 0 / 0);
          A.E(a, "roughnessFactor", b, 1, 1 / 0, -1 / 0, 1, 0, false, 0 / 0);
          r = A.T(a, "metallicRoughnessTexture", b, A.ao(), false);
          q = A.t(a, B.ej, b, null);
          p = new A.cB(s, r, q, A.x(a, b), false);
          o = A.a([s, r], t.M);
          B.d.D(o, q.gX());
          b.W(p, o);
          return p;
        ...
        uW(a, b) {
          ...
          A.w(a, B.cU, b);
          s = A.t(a, B.aI, b, B.f);
          r = A.W(a, "index", b, true);
          q = A.a0(a, "texCoord", b, 0, null, -1, 0, false);
          A.E(a, "strength", b, 1, 1 / 0, -1 / 0, 1, 0, false, 0 / 0);
          p = new A.cA(r, q, s, A.x(a, b), false);
          b.W(p, s.gX());
          return p;
        },
        uV(a, b) {
          ...
          r = A.W(a, "index", b, true);
          q = A.a0(a, "texCoord", b, 0, null, -1, 0, false);
          A.E(a, "scale", b, 1, 1 / 0, -1 / 0, 1 / 0, -1 / 0, false, 0 / 0);
          p = new A.cz(r, q, s, A.x(a, b), false);
          b.W(p, s.gX());
          return p;
        },
        vb(a, b) {
          ...
          A.w(a, B.cS, b);
          s = A.t(a, B.aL, b, B.f);
          r = new A.bj(A.W(a, "index", b, true), A.a0(a, "texCoord", b, 0, null, -1, 0, false), s, A.x(a, b), false);
          b.W(r, s.gX());
          return r;
        },
        ai: function ai(a, b, c, d, e, f, g, h, i, j) {
          var _ = this;
          _.w = a;
          _.x = b;
          _.y = c;
        ...
        uP(a, b) {
          var s, r, q, p, o, n, m, l, k, j, i = null, h = "primitives";
          A.w(a, B.da, b);
          s = A.ae(a, "weights", b, i, i, 1 / 0, -1 / 0, false);
          r = A.eB(a, h, b);
          if (r != null) {
            q = r.gj(r);
            p = A.U(q, i, false, t.ft);
            o = new A.F(p, q, h, t.b_);
            q = b.c;
            q.push(h);
            for (n = 0, m = 0; m < r.gj(r); ++m) {
              q.push(B.c.k(m));
              l = A.uO(r.i(0, m), b);
              k = l.w;
              j = k == null ? i : k.length;
            ...
            q.pop();
            if (s != null && n !== s.length) b.l($.rP(), A.a([s.length, n], t.M), "weights");
          } else o = i;
          A.J(a, "name", b, i, i, i, false);
          return new A.aV(o, s, A.t(a, B.aG, b, i), A.x(a, b), false);
        },
        uN(a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
          var s, r = J.oF(l, t.e);
          for (s = 0; s < l; ++s) r[s] = s;
          return new A.aE(a, b, c, d, e, g, h, j, k, l, A.a9(t.X, t.W), r, m, n, false);
        },
        uO(a, b) {
          var s, r, q, p, o, n, m, l, k = "attributes", j = {};
          A.w(a, B.cY, b);
          j.a = j.b = j.c = false;
          j.d = 0;
          j.e = -1;
          ...
          j.z = -1;
          s = new A.jV();
          r = A.a0(a, "mode", b, 4, null, 6, 0, false);
          ...
          m = A.x6(a, "targets", b, new A.jU(s, b));
          l = A.uN(q, A.W(a, "indices", b, false), A.W(a, "material", b, false), r, m, j.c, j.b, j.a, j.d, j.f, j.w, j.y, A.t(a, B.aF, b, null), A.x(a, b));
          b.W(l, l.a.gX());
          return l;
        },
        ...
        aE: function aE(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
          var _ = this;
          _.d = a;
          _.e = b;
          _.f = c;
        ...
        uU(b4, b5) {
          var s, r, q, p, o, n, m, l, k, j, i, h, g, f, e, d, c, b, a, a0, a1, a2, a3, a4, a5, a6, a7, a8, a9, b0 = null, b1 = "matrix", b2 = "translation", b3 = "rotation";
          A.w(b4, B.cj, b5);
          if (b4.v(b1)) {
            s = A.ae(b4, b1, b5, b0, B.c6, 1 / 0, -1 / 0, false);
            if (s != null) {
          ...
          if (b4.v(b2)) {
            a = A.ae(b4, b2, b5, b0, B.l, 1 / 0, -1 / 0, false);
            a0 = a != null ? A.pb(a) : b0;
          } else a0 = b0;
          if (b4.v(b3)) {
            a1 = A.ae(b4, b3, b5, b0, B.P, 1, -1, false);
            if (a1 != null) {
              r = a1[0];
              p = a1[1];
              o = a1[2];
              ...
              m[3] = n;
              r = Math.sqrt(a2.gaW());
              if (Math.abs(1 - r) > 769e-5) b5.n($.t5(), b3);
            } else a2 = b0;
          } else a2 = b0;
          if (b4.v("scale")) {
            a3 = A.ae(b4, "scale", b5, b0, B.l, 1 / 0, -1 / 0, false);
            a4 = a3 != null ? A.pb(a3) : b0;
          } else a4 = b0;
          a5 = A.W(b4, "camera", b5, false);
          a6 = A.mR(b4, "children", b5, false);
          a7 = A.W(b4, "mesh", b5, false);
          a8 = A.W(b4, "skin", b5, false);
          a9 = A.ae(b4, "weights", b5, b0, b0, 1 / 0, -1 / 0, false);
          if (a7 === -1) {
            if (a8 !== -1) b5.l($.cO(), A.a(["mesh"], t.M), "skin");
            if (a9 != null) b5.l($.cO(), A.a(["mesh"], t.M), "weights");
          }
          if (q != null) {
            if (a0 != null || a2 != null || a4 != null) b5.n($.rZ(), b1);
            if (q.cP()) b5.n($.rX(), b1);
            else if (!A.xi(q)) b5.n($.t_(), b1);
          }
          A.J(b4, "name", b5, b0, b0, b0, false);
          return new A.ap(a5, a6, a8, q, a7, a0, a2, a4, a9, A.aD(t.bn), A.t(b4, B.V, b5, b0), A.x(b4, b5), false);
        },
        ap: function ap(a, b, c, d, e, f, g, h, i, j, k, l, m) {
          var _ = this;
          _.w = a;
          _.x = b;
          _.y = c;
        ...
        v6(a, b) {
          var s = null;
          A.w(a, B.dc, b);
          A.a0(a, "magFilter", b, -1, B.cg, -1, 0, false);
          A.a0(a, "minFilter", b, -1, B.ck, -1, 0, false);
          A.a0(a, "wrapS", b, 10497, B.ao, -1, 0, false);
          A.a0(a, "wrapT", b, 10497, B.ao, -1, 0, false);
          A.J(a, "name", b, s, s, s, false);
          return new A.bF(A.t(a, B.ek, b, s), A.x(a, b), false);
        },
        ...
        v7(a, b) {
          var s, r = null;
          A.w(a, B.d4, b);
          s = A.mR(a, "nodes", b, false);
          A.J(a, "name", b, r, r, r, false);
          return new A.bG(s, A.t(a, B.aJ, b, r), A.x(a, b), false);
        },
        ...
        v8(a, b) {
          var s, r, q, p = null;
          A.w(a, B.cw, b);
          s = A.W(a, "inverseBindMatrices", b, false);
          r = A.W(a, "skeleton", b, false);
          q = A.mR(a, "joints", b, true);
          A.J(a, "name", b, p, p, p, false);
          return new A.bI(s, r, q, A.aD(t.L), A.t(a, B.aK, b, p), A.x(a, b), false);
        },
        bI: function bI(a, b, c, d, e, f, g) {
          var _ = this;
          _.w = a;
          _.x = b;
          _.y = c;
        ...
        vc(a, b) {
          var s, r, q = null;
          A.w(a, B.de, b);
          s = A.W(a, "sampler", b, false);
          r = A.W(a, "source", b, false);
          A.J(a, "name", b, q, q, q, false);
          return new A.bK(s, r, A.t(a, B.W, b, q), A.x(a, b), false);
        },
        bK: function bK(a, b, c, d, e) {
          var _ = this;
          _.w = a;
          _.x = b;
          _.z = _.y = null;
        ...
        u4() {
          return new A.ab(B.au, new A.hh(), t.gw);
        },
        u3(a) {
          var s, r, q, p, o = null, n = t.i, m = A.a([], n), l = t._, k = A.a([], t.d6), j = A.a9(t.al, t.f9), i = A.a([], n), h = A.a([], n), g = A.a([], t.fh), f = A.a([], t.a9);
        ...
        i: function i(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s) {
          var _ = this;
          _.b = a;
          _.c = b;
          _.d = c;
        ...
        oD(a) {
          ...
          r = s.getUint32(0, true);
          if ((r & 16777215) === 16767231) return B.ag;
          if (r === 1196314761 && s.getUint32(4, true) === 169478669) return B.ah;
          if (r === 1179011410 && s.getUint32(8, true) === 1346520407 && s.getUint16(12, true) === 20566) return B.ai;
          if (r === 1481919403 && s.getUint32(4, true) === 3140497952 && s.getUint32(8, true) === 169478669) return B.bV;
          return null;
        },
        cU: function cU(a, b) {
          this.a = a;
        ...
        cd: function cd(a, b, c, d, e, f, g, h, i) {
          var _ = this;
          _.a = a;
          _.b = b;
          _.c = c;
        ...
        xS(a0, a1) {
          ...
          B.d.P(q);
          q.push("meshes");
          for (p = a0.at, o = p.b, n = a0.ax, m = n.$ti.h("aa<p.E>"), l = a0.cx, p = p.a, k = p.length, j = 0; j < o; ++j) {
            i = {};
            h = j >= k;
            g = h ? null : p[j];
            ...
            i.a = i.b = -1;
            for (f = new A.aa(n, n.gj(n), m); f.q(); ) {
              e = f.d;
              if (e.cy == g) {
                d = e.dx;
                d = (d == null ? null : d.Q) != null;
              } else d = false;
              if (d) {
                e = e.dx;
                c = e.Q.length;
          ...
          for (; A.wD(s); ) for (q = r.length, b = 0; b < r.length; r.length === q || (0, A.cN)(r), ++b) {
            a = r[b];
            if (!a.w) a.dY(a1);
          }
        },
        wD(a) {
          ...
          B.d.dP(a, new A.mL(), true);
          return a.length !== 0;
        },
        wx(a) {
          var s, r, q, p, o, n, m, l, k, j, i, h;
          for (s = a.d.ge4(), s = s.gH(s), r = a.c; s.q(); ) {
            q = s.gt();
            p = A.mJ(q.a);
            if (p == null) continue;
            o = B.m.i(0, p.Q);
            ...
            n = q.b;
            B.d.P(r);
            for (q = p.af(), q = new A.aH(q.a(), A.A(q).h("aH<1>")), m = J.V(n), l = 0, k = 0, j = false; q.q(); j = true) {
              i = q.gt();
              for (h = 0; h < m.gj(n); ++h) m.i(n, h).a0(a, l, k, i);
              ++k;
              if (k === o) k = 0;
              ++l;
            }
            if (j) for (h = 0; h < m.gj(n); ++h) m.i(n, h).aF(a);
          }
        },
        ne: function ne(a) {
          this.a = a;
        ...
        G(a, b, c) {
          return new A.ho(c, a, b);
        },
        am(a, b, c) {
          return new A.kf(c, a, b);
        },
        r(a, b, c) {
          return new A.kw(c, a, b);
        },
        v(a, b, c) {
          return new A.iY(c, a, b);
        },
        al(a, b, c) {
          return new A.hZ(c, a, b);
        },
        wy(a) {
          return "'" + A.b(a) + "'";
        },
        wu(a) {
          return typeof a == "string" ? "'" + a + "'" : J.as(a);
        },
        bH: function bH(a, b) {
          this.a = a;
          this.b = b;
        ...
        we(a) {
          a.dy.push("image/webp");
        },
        ua(a, b) {
          b.toString;
          A.w(a, B.df, b);
          return new A.ca(A.W(a, "source", b, false), A.t(a, B.dY, b, null), A.x(a, b), false);
        },
        ...
        un(a, b) {
          b.toString;
          A.w(a, B.d9, b);
          A.J(a, "pointer", b, null, null, $.qK(), true);
          return new A.cf(A.t(a, B.dZ, b, null), A.x(a, b), false);
        },
        wf(a) {
          a.fy.push("pointer");
        },
        ...
        uo(a, b) {
          var s, r, q, p, o, n, m, l, k, j, i, h = null, g = "lights", f = "spot";
          b.toString;
          A.w(a, B.d0, b);
          s = A.eB(a, g, b);
          r = t.cp;
          if (s != null) {
            ...
            for (o = t.h, n = 0; n < s.gj(s); ++n) {
              ...
              q.push(B.c.k(n));
              A.w(m, B.co, b);
              A.ae(m, "color", b, B.C, B.l, 1, 0, false);
              A.E(m, "intensity", b, 1, 1 / 0, -1 / 0, 1 / 0, 0, false, 0 / 0);
              l = A.J(m, "type", b, h, B.cJ, h, true);
              if (l === "spot") A.T(m, f, b, A.xm(), true);
              else {
                k = m.v(f);
                if (k) b.n($.oi(), f);
              }
              j = A.E(m, "range", b, 0 / 0, 1 / 0, 0, 1 / 0, -1 / 0, false, 0 / 0);
              if (l === "directional" && !isNaN(j)) b.n($.oi(), "range");
              A.J(m, "name", b, h, h, h, false);
              k = A.t(m, B.e1, b, h);
              i = m.i(0, "extras");
              if (i != null && !o.b(i)) b.n($.dk(), "extras");
              r[n] = new A.ba(k, i, false);
              q.pop();
            }
            q.pop();
          } else {
          ...
          return new A.bC(p, A.t(a, B.e_, b, h), A.x(a, b), false);
        },
        up(a, b) {
          var s, r, q = "outerConeAngle";
          A.w(a, B.cV, b);
          s = A.E(a, "innerConeAngle", b, 0, 1.5707963267948966, -1 / 0, 1 / 0, 0, false, 0 / 0);
          r = A.E(a, q, b, 0.7853981633974483, 1 / 0, 0, 1.5707963267948966, -1 / 0, false, 0 / 0);
          if (r <= s) b.l($.rF(), A.a([s, r], t.M), q);
          return new A.cg(A.t(a, B.e0, b, null), A.x(a, b), false);
        },
        uq(a, b) {
          b.toString;
          A.w(a, B.d_, b);
          return new A.ch(A.W(a, "light", b, true), A.t(a, B.e2, b, null), A.x(a, b), false);
        },
        ...
        ur(a, b) {
          ...
          b.toString;
          A.w(a, B.cv, b);
          A.E(a, "anisotropyStrength", b, 0, 1 / 0, -1 / 0, 1, 0, false, 0 / 0);
          A.E(a, "anisotropyRotation", b, 0, 1 / 0, -1 / 0, 1 / 0, -1 / 0, false, 0 / 0);
          s = A.T(a, "anisotropyTexture", b, A.ao(), false);
          r = A.t(a, B.e3, b, null);
          q = new A.ci(s, r, A.x(a, b), false);
          p = A.a([s], t.M);
          B.d.D(p, r.gX());
          b.W(q, p);
          return q;
        ...
        us(a, b) {
          ...
          b.toString;
          A.w(a, B.ca, b);
          A.E(a, "clearcoatFactor", b, 0, 1 / 0, -1 / 0, 1, 0, false, 0 / 0);
          s = A.T(a, "clearcoatTexture", b, A.ao(), false);
          A.E(a, "clearcoatRoughnessFactor", b, 0, 1 / 0, -1 / 0, 1, 0, false, 0 / 0);
          r = A.T(a, "clearcoatRoughnessTexture", b, A.ao(), false);
          q = A.T(a, "clearcoatNormalTexture", b, A.pV(), false);
          p = A.t(a, B.e4, b, null);
          o = new A.cj(s, r, q, p, A.x(a, b), false);
          n = A.a([s, r, q], t.M);
          B.d.D(n, p.gX());
          b.W(o, n);
          return o;
        ...
        ut(a, b) {
          b.toString;
          A.w(a, B.cK, b);
          A.E(a, "dispersion", b, 0, 1 / 0, -1 / 0, 1 / 0, 0, false, 0 / 0);
          return new A.ck(A.t(a, B.e5, b, null), A.x(a, b), false);
        },
        ...
        uu(a, b) {
          b.toString;
          A.w(a, B.cL, b);
          return new A.cl(A.E(a, "emissiveStrength", b, 1, 1 / 0, -1 / 0, 1 / 0, 0, false, 0 / 0), A.t(a, B.e6, b, null), A.x(a, b), false);
        },
        ...
        uv(a, b) {
          b.toString;
          A.w(a, B.cX, b);
          A.E(a, "ior", b, 1.5, 1 / 0, -1 / 0, 1 / 0, 1, false, 0);
          return new A.cm(A.t(a, B.e7, b, null), A.x(a, b), false);
        },
        ...
        uw(a, b) {
          var s, r, q, p, o, n, m, l = "iridescenceThicknessMinimum", k = "iridescenceThicknessTexture";
          b.toString;
          A.w(a, B.dg, b);
          A.E(a, "iridescenceFactor", b, 0, 1 / 0, -1 / 0, 1, 0, false, 0 / 0);
          s = A.T(a, "iridescenceTexture", b, A.ao(), false);
          A.E(a, "iridescenceIor", b, 1.3, 1 / 0, -1 / 0, 1 / 0, 1, false, 0 / 0);
          r = A.E(a, l, b, 100, 1 / 0, -1 / 0, 1 / 0, 0, false, 0 / 0);
          q = A.E(a, "iridescenceThicknessMaximum", b, 400, 1 / 0, -1 / 0, 1 / 0, 0, false, 0 / 0);
          p = A.T(a, k, b, A.ao(), false);
          if (p != null) {
            if (r === q) b.n($.rL(), k);
          } else if (!isNaN(r) && a.v(l)) b.n($.rK(), l);
          o = A.t(a, B.e8, b, null);
          n = new A.cn(s, p, o, A.x(a, b), false);
          m = A.a([s, p], t.M);
          B.d.D(m, o.gX());
          b.W(n, m);
          return n;
        ...
        ux(a, b) {
          ...
          b.toString;
          A.w(a, B.cI, b);
          A.ae(a, "diffuseFactor", b, B.al, B.P, 1, 0, false);
          s = A.T(a, "diffuseTexture", b, A.ao(), false);
          A.ae(a, "specularFactor", b, B.C, B.l, 1, 0, false);
          A.E(a, "glossinessFactor", b, 1, 1 / 0, -1 / 0, 1, 0, false, 0 / 0);
          r = A.T(a, "specularGlossinessTexture", b, A.ao(), false);
          q = A.t(a, B.dX, b, null);
          p = new A.co(s, r, q, A.x(a, b), false);
          o = A.a([s, r], t.M);
          B.d.D(o, q.gX());
          b.W(p, o);
          return p;
        ...
        uy(a, b) {
          ...
          b.toString;
          A.w(a, B.c9, b);
          A.ae(a, "sheenColorFactor", b, B.ak, B.l, 1, 0, false);
          s = A.T(a, "sheenColorTexture", b, A.ao(), false);
          A.E(a, "sheenRoughnessFactor", b, 0, 1 / 0, -1 / 0, 1, 0, false, 0 / 0);
          r = A.T(a, "sheenRoughnessTexture", b, A.ao(), false);
          q = A.t(a, B.e9, b, null);
          p = new A.cp(s, r, q, A.x(a, b), false);
          o = A.a([s, r], t.M);
          B.d.D(o, q.gX());
          b.W(p, o);
          return p;
        ...
        uz(a, b) {
          ...
          b.toString;
          A.w(a, B.cc, b);
          A.E(a, "specularFactor", b, 1, 1 / 0, -1 / 0, 1, 0, false, 0 / 0);
          s = A.T(a, "specularTexture", b, A.ao(), false);
          A.ae(a, "specularColorFactor", b, B.C, B.l, 1 / 0, 0, false);
          r = A.T(a, "specularColorTexture", b, A.ao(), false);
          q = A.t(a, B.ea, b, null);
          p = new A.cq(s, r, q, A.x(a, b), false);
          o = A.a([s, r], t.M);
          B.d.D(o, q.gX());
          b.W(p, o);
          return p;
        ...
        uA(a, b) {
          ...
          b.toString;
          A.w(a, B.cf, b);
          A.E(a, "transmissionFactor", b, 0, 1 / 0, -1 / 0, 1, 0, false, 0 / 0);
          s = A.T(a, "transmissionTexture", b, A.ao(), false);
          r = A.t(a, B.eb, b, null);
          q = new A.cr(s, r, A.x(a, b), false);
          p = A.a([s], t.M);
          B.d.D(p, r.gX());
          b.W(q, p);
          return q;
        ...
        uB(a, b) {
          b.toString;
          A.w(a, B.cM, b);
          return new A.cs(A.t(a, B.ec, b, null), A.x(a, b), false);
        },
        ...
        uC(a, b) {
          var s, r, q, p, o, n, m, l, k, j = null, i = "variants";
          b.toString;
          A.w(a, B.dl, b);
          s = A.eB(a, i, b);
          r = t.J;
          if (s != null) {
            ...
            for (o = t.h, n = 0; n < s.gj(s); ++n) {
              ...
              q.push(B.c.k(n));
              A.w(m, B.d2, b);
              A.J(m, "name", b, j, j, j, true);
              l = A.t(m, B.ef, b, j);
              k = m.i(0, "extras");
              if (k != null && !o.b(k)) b.n($.dk(), "extras");
              r[n] = new A.aM(l, k, false);
              q.pop();
            }
            q.pop();
          } else {
          ...
          return new A.bD(p, A.t(a, B.ed, b, j), A.x(a, b), false);
        },
        uD(a, b) {
          var s, r, q, p, o, n, m, l, k, j, i, h, g = null, f = "mappings";
          b.toString;
          A.w(a, B.d1, b);
          s = A.eB(a, f, b);
          r = t.aa;
          if (s != null) {
            ...
            for (o = t.h, n = 0; n < s.gj(s); ++n) {
              ...
              q.push(B.c.k(n));
              A.w(m, B.dm, b);
              l = A.mR(m, "variants", b, true);
              k = A.W(m, "material", b, true);
              A.J(m, "name", b, g, g, g, false);
              j = A.t(m, B.ee, b, g);
              i = m.i(0, "extras");
              if (i != null && !o.b(i)) b.n($.dk(), "extras");
              r[n] = new A.bb(l, k, j, i, false);
              q.pop();
            }
            q.pop();
          } else {
          ...
          h = new A.ct(p, A.t(a, B.el, b, g), A.x(a, b), false);
          b.W(h, A.bc(p, true, t._));
          return h;
        },
        ...
        uE(a, b) {
          ...
          b.toString;
          A.w(a, B.dp, b);
          A.ae(a, "attenuationColor", b, B.C, B.l, 1, 0, false);
          A.E(a, "attenuationDistance", b, 0 / 0, 1 / 0, 0, 1 / 0, -1 / 0, false, 0 / 0);
          s = A.E(a, "thicknessFactor", b, 0, 1 / 0, -1 / 0, 1 / 0, 0, false, 0 / 0);
          r = A.T(a, "thicknessTexture", b, A.ao(), false);
          q = A.t(a, B.eg, b, null);
          p = new A.cu(s, r, q, A.x(a, b), false);
          o = A.a([r], t.M);
          B.d.D(o, q.gX());
          b.W(p, o);
          return p;
        ...
        uF(a, b) {
          b.toString;
          A.w(a, B.d8, b);
          A.ae(a, "offset", b, B.c5, B.am, 1 / 0, -1 / 0, false);
          A.E(a, "rotation", b, 0, 1 / 0, -1 / 0, 1 / 0, -1 / 0, false, 0 / 0);
          A.ae(a, "scale", b, B.c7, B.am, 1 / 0, -1 / 0, false);
          return new A.cv(A.a0(a, "texCoord", b, -1, null, -1, 0, false), A.t(a, B.eh, b, null), A.x(a, b), false);
        },
        ...
        oA(a, b) {
          var s = null, r = new Uint8Array(12), q = new A.dt(r, a, new A.ay(new A.C($.B, t.f), t.G));
          b.dx = true;
          q.f = b;
        ...
        oB(a, b) {
          var s = new A.cT(a, new A.ay(new A.C($.B, t.f), t.G));
          s.e = b;
          return s;
        },
        ud(a, b) {
          var s, r, q, p, o = null, n = null;
          try {
            n = B.ab.e1(a);
          } catch (q2) {
            p = A.M(q2);
            if (p instanceof A.aK) {
              s = p;
              b.aE($.h3(), A.a([s], t.M), true);
              return o;
            } else throw q2;
          }
          if (t.t.b(n)) try {
            r = A.oC(n, b);
            return new A.au("model/gltf+json", r, o);
          } catch (q2) {
            if (A.M(q2) instanceof A.bA) return o;
            else throw q2;
          }
          else {
            b.aE($.a2(), A.a([n, "object"], t.M), true);
            return o;
          }
        },
        ...
        mM(a) {
          return typeof a == "number" && Math.floor(a) === a ? J.no(a) : a;
        },
        W(a, b, c, d) {
          var s = A.mM(A.az(a, b, "integer", c));
          if (A.aI(s)) {
            if (s >= 0) return s;
            c.n($.h2(), b);
          } else if (s == null) {
            if (d) c.F($.bs(), A.a([b], t.M));
          } else c.l($.a2(), A.a([s, "integer"], t.M), b);
          return -1;
        },
        pO(a, b, c) {
          var s = A.az(a, b, "boolean", c);
          if (s == null) return false;
          if (A.eu(s)) return s;
        ...
        a0(a, b, c, d, e, f, g, h) {
          var s, r = A.mM(A.az(a, b, "integer", c));
          if (A.aI(r)) {
            if (e != null) {
              if (!A.nN(b, r, e, c, false)) return -1;
            } else {
              if (!(r < g)) s = f !== -1 && r > f;
              else s = true;
              if (s) {
            ...
            if (!h) return d;
            c.F($.bs(), A.a([b], t.M));
          } else c.l($.a2(), A.a([r, "integer"], t.M), b);
          return -1;
        },
        E(a, b, c, d, e, f, g, h, i, j) {
          var s, r = A.az(a, b, "number", c);
          if (typeof r == "number") {
            if (r !== j) s = r < h || r <= f || r > g || r >= e;
            else s = false;
            if (s) {
              c.l($.ni(), A.a([r], t.M), b);
              return 0 / 0;
            ...
            if (!i) return d;
            c.F($.bs(), A.a([b], t.M));
          } else c.l($.a2(), A.a([r, "number"], t.M), b);
          return 0 / 0;
        },
        J(a, b, c, d, e, f, g) {
          var s, r = A.az(a, b, "string", c);
          if (typeof r == "string") {
            if (e != null) A.nN(b, r, e, c, false);
            else {
              if (f == null) s = null;
              else {
                s = f.b;
            ...
            if (!g) return d;
            c.F($.bs(), A.a([b], t.M));
          } else c.l($.a2(), A.a([r, "string"], t.M), b);
          return null;
        },
        pS(a, b) {
          var s, r, q, p;
        ...
        nP(a, b, c, d) {
          ...
          if (t.t.b(s)) return s;
            ...
            c.l($.a2(), A.a([s, "object"], t.M), b);
            if (d) return null;
          }
          return A.a9(t.X, t._);
        },
        T(a, b, c, d, e) {
          var s, r, q = A.az(a, b, "object", c);
          if (t.t.b(q)) {
            s = c.c;
            s.push(b);
            r = d.$2(q, c);
            ...
            if (e) c.F($.bs(), A.a([b], t.M));
          } else c.l($.a2(), A.a([q, "object"], t.M), b);
          return null;
        },
        mR(a, b, c, d) {
          var s, r, q, p, o, n, m = A.az(a, b, "array", c);
          if (t.m.b(m)) {
            s = J.V(m);
            if (s.gA(m)) {
              c.n($.bX(), b);
            ...
            if (d) c.F($.bs(), A.a([b], t.M));
          } else c.l($.a2(), A.a([m, "array"], t.M), b);
          return null;
        },
        x5(a, b, c, d) {
          var s, r = A.az(a, b, "object", c);
          if (t.t.b(r)) {
            if (r.gA(r)) {
              c.n($.bX(), b);
              return null;
            ...
            s.pop();
            return r.ak(0, t.X, t.e);
          } else {
            s = t.M;
            if (r == null) c.F($.bs(), A.a([b], s));
            else c.l($.a2(), A.a([r, "object"], s), b);
          }
          return null;
        },
        x6(a, b, c, d) {
          var s, r, q, p, o, n, m, l = A.az(a, b, "array", c);
          if (t.m.b(l)) {
            s = J.V(l);
            if (s.gA(l)) {
              c.n($.bX(), b);
              ...
              r = c.c;
              r.push(b);
              for (q = t.M, p = t.t, o = false, n = 0; n < s.gj(l); ++n) {
                m = s.i(l, n);
                if (p.b(m)) if (m.gA(m)) {
                  c.Z($.bX(), n);
                  o = true;
            ...
            return A.bc(new A.ab(s, new A.mU(), r), false, r.h("ah.E"));
          } else if (l != null) c.l($.a2(), A.a([l, "array"], t.M), b);
          return null;
        },
        ae(a, b, c, d, e, f, g, h) {
          var s, r, q, p, o, n, m, l, k = null, j = A.az(a, b, "array", c);
          if (t.m.b(j)) {
            s = J.V(j);
            if (s.gA(j)) {
              c.n($.bX(), b);
            ...
            if (e != null && !A.nN(b, s.gj(j), e, c, true)) return k;
            r = A.U(s.gj(j), 0, false, t.F);
            for (q = t.M, p = c.c, o = false, n = 0; n < s.gj(j); ++n) {
              m = s.i(j, n);
              if (typeof m == "number") {
                l = m == 1 / 0 || m == -1 / 0 || m < g || m > f;
                if (l) {
                  p.push(b);
                  c.ao($.ni(), A.a([m], q), n);
                  p.pop();
            ...
            return s;
          } else c.l($.a2(), A.a([j, "array"], t.M), b);
          return k;
        },
        pP(a, b, c, d, e) {
          var s, r, q, p, o, n, m, l, k, j = A.az(a, b, "array", c);
          if (t.m.b(j)) {
            s = J.V(j);
            if (s.gj(j) !== e) {
              c.l($.oc(), A.a([s.gj(j), A.a([e], t.V)], t.M), b);
              return null;
            }
            r = A.xR(d);
            q = A.q1(d);
            p = A.x_(d, e);
            for (o = t.M, n = false, m = 0; m < s.gj(j); ++m) {
              l = s.i(j, m);
              if (typeof l == "number" && Math.floor(l) === l) l = J.no(l);
              if (A.aI(l)) {
                k = l < r || l > q;
                if (k) {
                  c.l($.rC(), A.a([l, B.ay.i(0, d)], o), b);
                  n = true;
                }
                p[m] = l;
              } else {
                c.l($.eC(), A.a([l, "integer"], o), b);
                n = true;
              }
            }
            if (n) return null;
            return p;
          } else if (j != null) c.l($.a2(), A.a([j, "array"], t.M), b);
          return null;
        },
        pQ(a, b, c) {
          var s, r, q, p, o, n, m, l, k = A.az(a, b, "array", c);
          if (t.m.b(k)) {
            s = J.V(k);
            if (s.gA(k)) {
              c.n($.bX(), b);
            ...
            q = t.X;
            p = A.aD(q);
            for (o = t.M, n = false, m = 0; m < s.gj(k); ++m) {
              l = s.i(k, m);
              if (typeof l == "string") {
                if (!p.C(0, l)) c.Z($.ob(), m);
              } else {
                c.ao($.eC(), A.a([l, "string"], o), m);
                n = true;
              }
            }
            r.pop();
            if (n) return null;
            return s.aj(k, q);
          } else if (k != null) c.l($.a2(), A.a([k, "array"], t.M), b);
          return null;
        },
        eB(a, b, c) {
          var s, r, q, p, o, n, m = A.az(a, b, "array", c);
          if (t.m.b(m)) {
            ...
            if (s.gA(m)) {
              ...
              for (r = s.gH(m), q = t.t, p = t.M, o = false; r.q(); ) {
                n = r.gt();
                if (!q.b(n)) {
                  c.l($.eC(), A.a([n, "object"], p), b);
                  o = true;
                }
              }
              if (o) return null;
            ...
            else c.l($.a2(), A.a([m, "array"], s), b);
          }
          return null;
        },
        t(a, b, c, d) {
          var s, r, q, p, o, n, m, l, k, j, i, h, g = "extensions", f = A.a9(t.X, t._), e = A.nP(a, g, c, false);
          if (e.gA(e)) return f;
          s = c.c;
          s.push(g);
          for (r = e.gN(), r = r.gH(r), q = t.ax, p = t.c, o = d == null, n = c.f, m = c.r; r.q(); ) {
            l = r.gt();
            k = A.nP(e, l, c, false);
            j = c.ay;
            if (!j.G(j, l)) {
            ...
            i = c.Q.a.i(0, new A.cb(b, l));
            if (i == null) {
              c.n($.rl(), l);
              continue;
            }
            if (e.gj(e) > 1 && i.b) c.n($.rW(), l);
            if (k != null) {
              s.push(l);
              h = i.a.$2(k, c);
              f.m(0, l, h);
        ...
        nT(a, b, c, d, e, f) {
          var s, r, q, p, o, n, m = e.c;
          m.push(d);
          for (s = t.M, r = c.a, q = r.length, p = 0; p < a.gj(a); ++p) {
            o = a.i(0, p);
            if (o === -1) continue;
            ...
            if (n != null) {
              ...
              b[p] = n;
              f.$3(n, o, p);
            } else e.ao($.Q(), A.a([o], s), p);
          }
          m.pop();
        },
        xi(b8) {
          var s, r, q, p, o, n, m, l, k, j, i, h, g, f, e, d, c, b, a, a0, a1, a2, a3, a4, a5, a6, a7, a8, a9, b0, b1, b2, b3, b4, b5, b6, b7 = b8.a;
          if (b7[3] !== 0 || b7[7] !== 0 || b7[11] !== 0 || b7[15] !== 1) return false;
          if (b8.cG() === 0) return false;
          s = $.tt();
          r = $.tq();
          q = $.tr();
          p = $.oN;
          ...
          b7[14] = b7[14];
          b7[15] = b7[15];
          return Math.abs(r.cL() - b8.cL()) < 5e-5;
        },
        x_(a, b) {
          switch (a) {
            case 5120:
        ...
        uM() {
          return new A.cZ(new Float32Array(16));
        },
        v3() {
          return new A.fl(new Float32Array(4));
        },
        pb(a) {
        ...
        pa() {
          return new A.cE(new Float32Array(3));
        },
        f2: function f2(a) {
          this.a = a;
        },
        ...
        xT(a, b) {
          var s = 0, r = A.ex(t.t), q, p = 2, o, n, m, l, k, j, i, h, g, f;
          var $async$h_ = A.ez(function(c, d) {
            if (c === 1) {
              o = d;
              s = p;
            }
            while (true) switch (s) {
              case 0:
                if (!t.a.b(a)) throw A.d(A.K("data: Argument must be a Uint8Array.", null));
                l = A.pv(b);
                n = A.pz(l);
                m = null;
                k = A.w0(l == null ? null : J.tw(l));
              case 3:
                switch (k == null ? null : k.toLowerCase()) {
                  case "glb":
                    s = 5;
                    break;
                  case "gltf":
        ...
        nV(a, b) {
          var s = 0, r = A.ex(t.t), q, p, o;
          var $async$nV = A.ez(function(c, d) {
            if (c === 1) return A.er(d, r);
            while (true) switch (s) {
              case 0:
                if (typeof a != "string") throw A.d(A.K("json: Argument must be a string.", null));
                p = A.pv(b);
                o = A.pz(p);
                q = A.fY(p, o, A.ud(a, o));
                s = 1;
        ...
        fY(a, b, c) {
          var s = 0, r = A.ex(t.t), q, p, o, n, m;
          var $async$fY = A.ez(function(d, e) {
            if (d === 1) return A.er(e, r);
            while (true) switch (s) {
              case 0:
                m = a == null;
                if (!m) {
                  ...
                  if (p.gc6(a) != null && !A.eu(p.gc6(a))) throw A.d(A.K("options.writeTimestamp: Value must be a boolean.", null));
                } else {
                  o = null;
                  n = null;
                }
                s = (c == null ? null : c.b) != null ? 3 : 4;
                break;
              case 3:
                s = 5;
              ...
              case 4:
                m = m ? null : J.tz(a);
                q = new A.lF(o, b, c, m == null ? true : m).bn();
                s = 1;
                break;
              case 1:
                return A.es(q, r);
        ...
        wd(a) {
          ...
          if (a != null) if (typeof a == "string") try {
            ...
            r = A.M(q2);
            if (r instanceof A.aK) {
              s = r;
              throw A.d(A.K("options.uri: " + A.b(s) + ".", null));
            } else throw q2;
          }
          else throw A.d(A.K("options.uri: Value must be a string.", null));
          return null;
        },
        pz(a) {
          var s, r, q, p, o, n, m, l, k, j, i = null, h = "]: Value must be a non-empty String.";
          if (a != null) {
            s = J.b1(a);
            ...
            if (s.gaY(a) != null) {
              if (!t.l.b(s.gaY(a))) throw A.d(A.K("options.onlyIssues: Value must be an array.", i));
              q = A.a([], t.i);
              for (p = 0; p < J.a3(s.gaY(a)); ++p) {
                o = J.nl(s.gaY(a), p);
                if (typeof o == "string" && o.length !== 0) q.push(o);
                else throw A.d(A.K("options.onlyIssues[" + p + h, i));
              }
            } else q = i;
            if (s.gaU(a) != null) {
              if (!t.l.b(s.gaU(a))) throw A.d(A.K("options.ignoredIssues: Value must be an array.", i));
              n = A.a([], t.i);
              for (p = 0; p < J.a3(s.gaU(a)); ++p) {
                o = J.nl(s.gaU(a), p);
                if (typeof o == "string" && o.length !== 0) n.push(o);
                else throw A.d(A.K("options.ignoredIssues[" + p + h, i));
              }
            } else n = i;
            if (s.gam(a) != null) {
              if (typeof s.gam(a) == "number" || A.eu(s.gam(a)) || typeof s.gam(a) == "string" || t.l.b(s.gam(a))) throw A.d(A.K("options.severityOverrides: Value must be an object.", i));
              r = t.X;
              m = A.a9(r, t.dz);
              for (r = J.nn(self.Object.keys(s.gam(a)), r), r = new A.aa(r, r.gj(r), A.A(r).h("aa<p.E>")); r.q(); ) {
                l = r.d;
                k = s.gam(a)[l];
                if (A.aI(k) && k >= 0 && k <= 3) m.m(0, l, B.cn[k]);
                else throw A.d(A.K('options.severityOverrides["' + A.b(l) + '"]: Value must be one of [0, 1, 2, 3].', i));
              }
            } else m = i;
            j = A.p9(n, s.gbk(a), q, m);
          } else j = i;
          return A.u3(j);
        },
        wc(a, b, c) {
          var s = new A.mG(c), r = new A.e_("options.externalResourceFunction is required to load this resource.");
        ...
        wg(a) {
          var s = "POSITION", r = "TEXCOORD", q = a.fr;
          q.i(0, s).D(0, B.dh);
        ...
        px(a) {
          var s = a + ((a & 67108863) << 3) & 536870911;
          s ^= s >>> 11;
        ...
        mV(a) {
          var s, r, q, p, o, n = a[v2.dispatchPropertyName];
          if (n == null) {
            if ($.nQ == null) {
              A.xe();
              n = a[v2.dispatchPropertyName];
            }
          }
          if (n != null) {
            s = n.p;
            ...
            if (s === r) return n.i;
            if (n.e === r) throw A.d(A.p4("Return interceptor for " + A.b(s(a, n))));
          }
          q = a.constructor;
          if (q == null) p = null;
          else {
            o = $.mg;
            if (o == null) o = $.mg = v2.getIsolateTag("_$dart_js");
            p = q[o];
          }
          if (p != null) return p;
          p = A.xC(a);
        ...
        b8(a, b) {
          if (a < 0 || a > 4294967295) throw A.d(A.Y(a, 0, 4294967295, "length", null));
          return J.cX(new Array(a), b);
        },
        oF(a, b) {
          if (a > 4294967295) throw A.d(A.Y(a, 0, 4294967295, "length", null));
          return J.cX(new Array(a), b);
        },
        cX(a, b) {
          return J.nr(A.a(a, b.h("D<0>")));
        },
        nr(a) {
          a.fixed$length = Array;
          return a;
        ...
        oG(a, b) {
          ...
          for (; b > 0; b = s) {
            s = b - 1;
            r = B.a.B(a, s);
            if (r !== 32 && r !== 13 && !J.uj(r)) break;
          }
          return b;
        },
        bV(a) {
          if (typeof a == "number") {
            if (Math.floor(a) == a) return J.dy.prototype;
            return J.eZ.prototype;
          }
        ...
        x7(a) {
          if (typeof a == "number") return J.ce.prototype;
          if (a == null) return a;
        ...
        nl(a, b) {
          if (typeof b === "number") {
            if (a.constructor == Array || typeof a == "string" || A.pU(a, a[v2.dispatchPropertyName])) {
        ...
        tv(a, b, c) {
          if (typeof b === "number") {
            if ((a.constructor == Array || A.pU(a, a[v2.dispatchPropertyName])) && !a.immutable$list && b >>> 0 === b && b < a.length) return a[b] = c;
          }
        ...
        tA(a, b, c) {
          return J.bp(a).b0(a, b, c);
        },
        bt(a, b, c) {
          return J.bp(a).al(a, b, c);
        },
        tB(a, b) {
        ...
        tD(a, b) {
          return J.b1(a).sdf(a, b);
        },
        tE(a, b) {
          return J.b1(a).seB(a, b);
        },
        tF(a, b) {
          return J.b1(a).seD(a, b);
        },
        tG(a, b) {
          return J.b1(a).seE(a, b);
        },
        op(a, b) {
          return J.bp(a).a6(a, b);
        },
        tH(a, b, c) {
          return J.b1(a).d1(a, b, c);
        },
        tI(a, b, c) {
          return J.b1(a).es(a, b, c);
        },
        no(a) {
          return J.x7(a).eu(a);
        },
        h4(a, b) {
          return J.bp(a).b_(a, b);
        },
        as(a) {
          return J.bV(a).k(a);
        },
      ...
      J.cV.prototype = {
        ...
        bm(a, b) {
          throw A.d(new A.dH(a, b.gcT(), b.gcX(), b.gcU(), null));
        }
      };
      J.dx.prototype = {
        k(a) {
      ...
      J.aN.prototype = {
        ...
        seB(a, b) {
          return a.validateBytes = b;
        },
        seD(a, b) {
          return a.validateString = b;
        },
        seE(a, b) {
          return a.version = b;
        },
        sdf(a, b) {
          return a.supportedExtensions = b;
        },
        gbo(a) {
          return a.uri;
        },
        ...
        gbL(a) {
          return a.externalResourceFunction;
        },
        gc6(a) {
          return a.writeTimestamp;
        },
        gbk(a) {
          return a.maxIssues;
        },
        gaU(a) {
          return a.ignoredIssues;
        },
        gaY(a) {
          return a.onlyIssues;
        },
        gam(a) {
          return a.severityOverrides;
        }
      };
      J.fj.prototype = {};
      J.bL.prototype = {};
      ...
      J.D.prototype = {
        aj(a, b) {
          return new A.b5(a, A.a_(a).h("@<1>").I(b).h("b5<1,2>"));
        },
        C(a, b) {
          if (!!a.fixed$length) A.Z(A.ad("add"));
          a.push(b);
        },
        dP(a, b, c) {
          var s, r, q, p = [], o = a.length;
          for (s = 0; s < o; ++s) {
            r = a[s];
            if (!b.$1(r)) p.push(r);
            if (a.length !== o) throw A.d(A.ag(a));
          }
          q = p.length;
          if (q === o) return;
          this.sj(a, q);
        ...
        P(a) {
          if (!!a.fixed$length) A.Z(A.ad("clear"));
          a.length = 0;
        },
        al(a, b, c) {
          return new A.ab(a, b, A.a_(a).h("@<1>").I(c).h("ab<1,2>"));
        },
        cQ(a, b) {
          var s, r = A.U(a.length, "", false, t.R);
          for (s = 0; s < a.length; ++s) r[s] = A.b(a[s]);
          return r.join(b);
        },
        a6(a, b) {
          return A.dQ(a, b, null, A.a_(a).c);
        },
        bf(a, b, c) {
          var s, r, q = a.length;
          for (s = 0; s < q; ++s) {
            r = a[s];
            if (b.$1(r)) return r;
            if (a.length !== q) throw A.d(A.ag(a));
          }
          return c.$0();
        },
        V(a, b) {
        ...
        a1(a, b, c) {
          if (b < 0 || b > a.length) throw A.d(A.Y(b, 0, a.length, "start", null));
        ...
        G(a, b) {
          var s;
          for (s = 0; s < a.length; ++s) if (J.af(a[s], b)) return true;
          return false;
        },
        gA(a) {
          return a.length === 0;
        ...
        b_(a, b) {
          var s = J.cX(a.slice(0), A.a_(a).c);
          return s;
        },
        c3(a) {
          return A.uJ(a, A.a_(a).c);
        },
        gH(a) {
          return new J.b4(a, a.length, A.a_(a).h("b4<1>"));
        },
        gE(a) {
          return A.d0(a);
        },
        ...
        sj(a, b) {
          if (!!a.fixed$length) A.Z(A.ad("set length"));
        ...
        m(a, b, c) {
          if (!!a.immutable$list) A.Z(A.ad("indexed set"));
          if (!(b >= 0 && b < a.length)) throw A.d(A.eA(a, b));
          a[b] = c;
        },
        $iq: 1,
      ...
      J.ce.prototype = {
        ...
        bJ(a, b) {
          return (a | 0) === a ? a / b | 0 : this.cv(a, b);
        },
        cv(a, b) {
          var s = a / b;
      ...
      J.bB.prototype = {
        B(a, b) {
          if (b < 0) throw A.d(A.eA(a, b));
          if (b >= a.length) A.Z(A.eA(a, b));
          return a.charCodeAt(b);
        },
        J(a, b) {
          if (b >= a.length) throw A.d(A.eA(a, b));
          return a.charCodeAt(b);
        },
        ae(a, b) {
          if (typeof b != "string") throw A.d(A.h7(b, null, null));
          return a + b;
        },
        aH(a, b, c, d) {
          var s = A.aQ(b, c, a.length);
        ...
        u(a, b, c) {
          return a.substring(b, A.aQ(b, c, a.length));
        },
        bu(a, b) {
          return this.u(a, b, null);
        },
        ey(a) {
          var s, r, q;
      ...
      A.bM.prototype = {
        ...
        gj(a) {
          return J.a3(this.gaa());
        },
        gA(a) {
          return J.oo(this.gaa());
        },
        ga8(a) {
          return J.tx(this.gaa());
        },
        a6(a, b) {
          var s = A.A(this);
        ...
        V(a, b) {
          return A.A(this).z[1].a(J.eD(this.gaa(), b));
        },
        G(a, b) {
          return J.on(this.gaa(), b);
        },
        k(a) {
          return J.as(this.gaa());
        }
      };
      A.dm.prototype = {
        q() {
      ...
      A.dU.prototype = {
        i(a, b) {
          return this.$ti.z[1].a(J.nl(this.a, b));
        },
        m(a, b, c) {
          J.tv(this.a, b, this.$ti.c.a(c));
        },
        sj(a, b) {
          J.tC(this.a, b);
        },
        C(a, b) {
          J.nm(this.a, this.$ti.c.a(b));
        },
        b0(a, b, c) {
          var s = this.$ti;
      ...
      A.b5.prototype = {
        aj(a, b) {
          return new A.b5(this.a, this.$ti.h("@<1>").I(b).h("b5<1,2>"));
        },
        gaa() {
          return this.a;
        }
      ...
      A.c6.prototype = {
        ...
        i(a, b) {
          return this.$ti.h("4?").a(this.a.i(0, b));
        },
        m(a, b, c) {
          var s = this.$ti;
      ...
      A.dI.prototype = {
        k(a) {
          return "Null is not a valid value for '" + this.a + "' of type '" + A.pL(this.$ti.c).k(0) + "'";
        },
        $iaG: 1
      };
      A.q.prototype = {};
      A.ah.prototype = {
        ...
        G(a, b) {
          var s, r = this, q = r.gj(r);
          for (s = 0; s < q; ++s) {
            if (J.af(r.V(0, s), b)) return true;
            if (q !== r.gj(r)) throw A.d(A.ag(r));
          }
          return false;
        },
        al(a, b, c) {
          return new A.ab(this, b, A.A(this).h("@<ah.E>").I(c).h("ab<1,2>"));
        },
        a6(a, b) {
          return A.dQ(this, b, null, A.A(this).h("ah.E"));
        }
      };
      A.dP.prototype = {
        gdu() {
          var s = J.a3(this.a), r = this.c;
          if (r == null || r > s) return s;
          return r;
        },
        gdU() {
          var s = J.a3(this.a), r = this.b;
          if (r > s) return s;
          return r;
        },
        gj(a) {
          var s, r = J.a3(this.a), q = this.b;
          if (q >= r) return 0;
          s = this.c;
        ...
        b_(a, b) {
          var s, r, q, p = this, o = p.b, n = p.a, m = J.V(n), l = m.gj(n), k = p.c;
          if (k != null && k < l) l = k;
          s = l - o;
          if (s <= 0) {
            n = J.b8(0, p.$ti.c);
          ...
          r = A.U(s, m.V(n, o), false, p.$ti.c);
          for (q = 1; q < s; ++q) {
            r[q] = m.V(n, o + q);
            if (m.gj(n) < l) throw A.d(A.ag(p));
          }
          return r;
        }
      };
      A.aa.prototype = {
        ...
        q() {
          var s, r = this, q = r.a, p = J.V(q), o = p.gj(q);
      ...
      A.lK.prototype = {
        gH(a) {
          return new A.cF(J.aA(this.a), this.b, this.$ti.h("cF<1>"));
        },
        al(a, b, c) {
          return new A.bd(this, b, this.$ti.h("@<1>").I(c).h("bd<1,2>"));
        }
      };
      A.cF.prototype = {
        q() {
          var s, r;
          for (s = this.a, r = this.b; s.q(); ) if (r.$1(s.gt())) return true;
          return false;
        },
        gt() {
          return this.a.gt();
      ...
      A.bh.prototype = {
        ...
        gH(a) {
          return new A.dN(J.aA(this.a), this.b, A.A(this).h("dN<1>"));
        }
      };
      A.cR.prototype = {
        gj(a) {
          var s = J.a3(this.a) - this.b;
          if (s >= 0) return s;
          return 0;
        },
        a6(a, b) {
      ...
      A.b7.prototype = {
        ...
        V(a, b) {
          throw A.d(A.Y(b, 0, 0, "index", null));
        },
        G(a, b) {
          return false;
        },
      ...
      A.ds.prototype = {
        sj(a, b) {
          throw A.d(A.ad("Cannot change the length of a fixed-length list"));
        },
        C(a, b) {
      ...
      A.fy.prototype = {
        ...
        sj(a, b) {
          throw A.d(A.ad("Cannot change the length of an unmodifiable list"));
        },
        C(a, b) {
      ...
      A.aJ.prototype = {
        ...
        v(a) {
          ...
          if ("__proto__" === a) return false;
          return this.b.hasOwnProperty(a);
        },
        i(a, b) {
          if (!this.v(b)) return null;
          return this.b[b];
        },
        M(a, b) {
        ...
        gN() {
          return new A.dW(this, this.$ti.h("dW<1>"));
        }
      };
      A.dW.prototype = {
        gH(a) {
      ...
      A.cP.prototype = {
        O(a, b) {
          ...
          if (!(b instanceof A.cP)) return false;
          return this.$_target === b.$_target && this.a === b.a;
        },
        gE(a) {
          return (A.fZ(this.a) ^ A.d0(this.$_target)) >>> 0;
        },
        k(a) {
          return "Closure '" + A.b(this.$_name) + "' of " + ("Instance of '" + A.b(A.ka(this.a)) + "'");
        }
      };
      A.fp.prototype = {
        k(a) {
      ...
      A.aC.prototype = {
        ...
        gN() {
          return new A.aO(this, A.A(this).h("aO<1>"));
        },
        gX() {
          var s = A.A(this);
        ...
        m(a, b, c) {
          ...
          if (typeof b == "string") {
            s = q.b;
            q.ca(s == null ? q.b = q.bH() : s, b, c);
          } else if (typeof b == "number" && (b & 1073741823) === b) {
            r = q.c;
            q.ca(r == null ? q.c = q.bH() : r, b, c);
          } else q.cO(b, c);
        },
        cO(a, b) {
      ...
      A.aO.prototype = {
        ...
        gH(a) {
          var s = this.a, r = new A.cx(s, s.r, this.$ti.h("cx<1>"));
          r.c = s.e;
          return r;
        },
        G(a, b) {
      ...
      A.dF.prototype = {
        dE(a, b, c, d) {
          var s = A.Y(b, 0, c, d, null);
          throw A.d(s);
        },
        ci(a, b, c, d) {
          if (b >>> 0 !== b || b > c) this.dE(a, b, c, d);
        }
      };
      A.d_.prototype = {
        gj(a) {
      ...
      A.f8.prototype = {
        a1(a, b, c) {
          return new Float32Array(a.subarray(b, A.bR(b, c, a.length)));
        }
      };
      A.f9.prototype = {
        a1(a, b, c) {
          return new Float64Array(a.subarray(b, A.bR(b, c, a.length)));
        }
      };
      A.fa.prototype = {
        i(a, b) {
        ...
        a1(a, b, c) {
          return new Int16Array(a.subarray(b, A.bR(b, c, a.length)));
        }
      };
      A.fb.prototype = {
        i(a, b) {
        ...
        a1(a, b, c) {
          return new Int32Array(a.subarray(b, A.bR(b, c, a.length)));
        }
      };
      A.fc.prototype = {
        i(a, b) {
        ...
        a1(a, b, c) {
          return new Int8Array(a.subarray(b, A.bR(b, c, a.length)));
        }
      };
      A.fd.prototype = {
        i(a, b) {
        ...
        a1(a, b, c) {
          return new Uint16Array(a.subarray(b, A.bR(b, c, a.length)));
        }
      };
      A.fe.prototype = {
        i(a, b) {
        ...
        a1(a, b, c) {
          return new Uint32Array(a.subarray(b, A.bR(b, c, a.length)));
        }
      };
      A.dG.prototype = {
        gj(a) {
        ...
        a1(a, b, c) {
          return new Uint8ClampedArray(a.subarray(b, A.bR(b, c, a.length)));
        }
      };
      A.cy.prototype = {
        gj(a) {
        ...
        a1(a, b, c) {
          return new Uint8Array(a.subarray(b, A.bR(b, c, a.length)));
        },
        $icy: 1,
        $ia6: 1
      };
      ...
      A.aF.prototype = {
        h(a) {
          return A.mt(v2.typeUniverse, this, a);
        },
        I(a) {
          return A.vG(v2.typeUniverse, this, a);
        }
      };
      A.fK.prototype = {};
      A.eh.prototype = {
        k(a) {
          return A.ar(this.a, null);
        },
        $ibk: 1
      };
      A.fJ.prototype = {
      ...
      A.mr.prototype = {
        dg(a, b) {
          if (self.setTimeout != null) self.setTimeout(A.mO(new A.ms(this, b), 0), a);
      ...
      A.d7.prototype = {
        k(a) {
          return "IterationMarker(" + this.b + ", " + A.b(this.a) + ")";
        }
      };
      A.aH.prototype = {
        gt() {
      ...
      A.eg.prototype = {
        gH(a) {
          return new A.aH(this.a(), this.$ti.h("aH<1>"));
        }
      };
      A.eH.prototype = {
        k(a) {
      ...
      A.bN.prototype = {
        ...
        e7(a) {
          var s, r = this.e, q = null, p = this.b.b;
          ...
          try {
            ...
            if (t.eK.b(A.M(s2))) {
              if ((this.c & 1) !== 0) throw A.d(A.K("The error handler of Future.then must return a value of the returned future's type", "onError"));
              throw A.d(A.K("The error handler of Future.catchError must return a value of the future's type", "onError"));
            } else throw s2;
          }
        }
      };
      A.C.prototype = {
        au(a, b, c, d) {
          var s, r, q = $.B;
          if (q === B.i) {
            if (c != null && !t.C.b(c) && !t.v.b(c)) throw A.d(A.h7(c, "onError", u.c));
          } else if (c != null) c = A.wA(c, q);
          s = new A.C(q, d.h("C<0>"));
          r = c == null ? 1 : 3;
        ...
        d1(a, b, c) {
          return this.au(a, b, null, c);
        },
        cz(a, b, c) {
          var s = new A.C($.B, c.h("C<0>"));
          this.b4(new A.bN(s, 3, a, b, this.$ti.h("@<1>").I(c).h("bN<1,2>")));
          return s;
        },
        bp(a) {
          var s = this.$ti, r = new A.C($.B, s);
        ...
        b4(a) {
          ...
          if (r <= 3) {
            ...
            A.cI(null, null, s.b, new A.m3(s, a));
          }
        },
        cs(a) {
        ...
        ce(a) {
          ...
          p.a ^= 2;
          try {
            a.au(0, new A.m6(p), new A.m7(p), t.P);
          } catch (q2) {
            s = A.M(q2);
            r = A.aS(q2);
            A.q_(new A.m8(p, s, r));
        ...
        cf(a) {
          ...
          if (s.$ti.b(a)) {
            if ((a.a & 16) !== 0) {
              s.a ^= 2;
              A.cI(null, null, s.b, new A.m9(s, a));
            } else A.nz(a, s);
            return;
          }
          s.ce(a);
      ...
      A.bi.prototype = {
        gj(a) {
          var s = {}, r = new A.C($.B, t.fJ);
          s.a = 0;
          this.bU(new A.lp(s, this), true, new A.lq(s, r), r.gdq());
          return r;
        }
      };
      A.ln.prototype = {
      ...
      A.lq.prototype = {
        $0() {
          var s = this.b, r = this.a.a, q = s.bb();
          s.a = 8;
          s.c = r;
          A.d6(s, q);
        },
      ...
      A.da.prototype = {
        ...
        bv() {
          if ((this.b & 4) !== 0) return new A.bJ("Cannot add event after closing");
      ...
      A.fF.prototype = {
        aC(a) {
          this.gaD().az(new A.cG(a));
        },
        aP(a, b) {
          this.gaD().az(new A.dY(a, b));
        },
        aO() {
          this.gaD().az(B.M);
        }
      ...
      A.aj.prototype = {
        gE(a) {
          return (A.d0(this.a) ^ 892482866) >>> 0;
        },
        O(a, b) {
          if (b == null) return false;
          if (this === b) return true;
      ...
      A.dT.prototype = {
        ...
        aP(a, b) {
          var s, r = this, q = r.e, p = new A.m0(r, a, b);
          if ((q & 1) !== 0) {
            r.e = (q | 16) >>> 0;
            r.bw();
            s = r.f;
        ...
        bx(a) {
          ...
          if ((p & 64) !== 0 && p < 128) q.r.b1(q);
        }
      };
      A.m0.prototype = {
        $0() {
          var s, r, q = this.a, p = q.e;
      ...
      A.ee.prototype = {
        bU(a, b, c, d) {
          return this.a.dV(a, d, c, b === true);
        },
        bT(a, b, c) {
          return this.bU(a, null, b, c);
        },
        ea(a, b) {
          return this.bU(a, null, b, null);
        }
      };
      A.fI.prototype = {
        gaG() {
      ...
      A.m1.prototype = {
        ...
        saG(a) {
          throw A.d(A.d2("No events after a done."));
        }
      };
      A.eb.prototype = {
        b1(a) {
      ...
      A.mn.prototype = {
        ...
        el(a, b, c) {
          return this.em(a, b, c, t.z, t.z, t.z);
        },
        eh(a) {
          return a;
        },
        c1(a) {
          return this.eh(a, t.z, t.z, t.z);
        }
      };
      A.mo.prototype = {
        $0() {
      ...
      A.e1.prototype = {
        ...
        gN() {
          return new A.e2(this, this.$ti.h("e2<1>"));
        },
        v(a) {
          var s, r;
          if (typeof a == "string" && a !== "__proto__") {
            s = this.b;
            return s == null ? false : s[a] != null;
          } else if (typeof a == "number" && (a & 1073741823) === a) {
            r = this.c;
            return r == null ? false : r[a] != null;
      ...
      A.e5.prototype = {
        ...
        v(a) {
          if (!this.y.$1(a)) return false;
          return this.d7(a);
        },
        bh(a) {
          return this.x.$1(a) & 1073741823;
        },
        bi(a, b) {
          var s, r, q;
          if (a == null) return -1;
      ...
      A.b_.prototype = {
        gH(a) {
          var s = this, r = new A.cH(s, s.r, A.A(s).h("cH<1>"));
          r.c = s.e;
          return r;
        },
        gj(a) {
        ...
        C(a, b) {
          ...
          if (typeof b == "string" && b !== "__proto__") {
            s = q.b;
            return q.cc(s == null ? q.b = A.nC() : s, b);
          } else if (typeof b == "number" && (b & 1073741823) === b) {
            r = q.c;
            return q.cc(r == null ? q.c = A.nC() : r, b);
          } else return q.dh(b);
        },
        dh(a) {
      ...
      A.aX.prototype = {
        aj(a, b) {
          return new A.aX(J.nn(this.a, b), b.h("aX<0>"));
        },
        gj(a) {
          return J.a3(this.a);
        },
        i(a, b) {
          return J.eD(this.a, b);
        }
      };
      A.dw.prototype = {};
      ...
      A.p.prototype = {
        gH(a) {
          return new A.aa(a, this.gj(a), A.ak(a).h("aa<p.E>"));
        },
        V(a, b) {
          return this.i(a, b);
        },
        ...
        gcH(a) {
          if (this.gj(a) === 0) throw A.d(A.nq());
          return this.i(a, 0);
        },
        G(a, b) {
          var s, r = this.gj(a);
          for (s = 0; s < r; ++s) {
            if (J.af(this.i(a, s), b)) return true;
            if (r !== this.gj(a)) throw A.d(A.ag(a));
          }
          return false;
        },
        be(a, b) {
          var s, r = this.gj(a);
          for (s = 0; s < r; ++s) {
            if (!b.$1(this.i(a, s))) return false;
            if (r !== this.gj(a)) throw A.d(A.ag(a));
          }
          return true;
        },
        aR(a, b) {
          var s, r = this.gj(a);
          for (s = 0; s < r; ++s) {
            if (b.$1(this.i(a, s))) return true;
            if (r !== this.gj(a)) throw A.d(A.ag(a));
          }
          return false;
        },
        al(a, b, c) {
          return new A.ab(a, b, A.ak(a).h("@<p.E>").I(c).h("ab<1,2>"));
        },
        a6(a, b) {
          return A.dQ(a, b, null, A.ak(a).h("p.E"));
        },
        b_(a, b) {
          var s, r, q, p, o = this;
          if (o.gA(a)) {
            s = J.b8(0, A.ak(a).h("p.E"));
            return s;
          }
          r = o.i(a, 0);
          q = A.U(o.gj(a), r, false, A.ak(a).h("p.E"));
          for (p = 1; p < o.gj(a); ++p) q[p] = o.i(a, p);
          return q;
        },
        c3(a) {
          var s, r = A.oH(A.ak(a).h("p.E"));
        ...
        aj(a, b) {
          return new A.b5(a, A.ak(a).h("@<p.E>").I(b).h("b5<1,2>"));
        },
        a1(a, b, c) {
          var s = this.gj(a);
          A.aQ(b, c, s);
        ...
        a5(a, b, c, d, e) {
          ...
          if (s === 0) return;
          A.aW(e, "skipCount");
          if (A.ak(a).h("o<p.E>").b(d)) {
            r = e;
            q = d;
          } else {
            q = J.op(d, e).b_(0, false);
            r = 0;
          }
          p = J.V(q);
      ...
      A.I.prototype = {
        ...
        M(a, b) {
          var s, r;
          for (s = this.gN(), s = s.gH(s); s.q(); ) {
            r = s.gt();
            b.$2(r, this.i(0, r));
          }
        },
        ge4() {
          return this.gN().al(0, new A.jP(this), A.A(this).h("cY<I.K,I.V>"));
        },
        v(a) {
          return this.gN().G(0, a);
        },
        gj(a) {
          var s = this.gN();
          return s.gj(s);
      ...
      A.jP.prototype = {
        $1(a) {
          var s = this.a, r = A.A(s);
          return new A.cY(a, s.i(0, a), r.h("@<I.K>").I(r.h("I.V")).h("cY<1,2>"));
        },
        $S() {
          return A.A(this.a).h("cY<I.K,I.V>(I.K)");
        }
      };
      A.fU.prototype = {
        m(a, b, c) {
      ...
      A.bm.prototype = {
        ak(a, b, c) {
          return new A.bm(this.a.ak(0, b, c), b.h("@<0>").I(c).h("bm<1,2>"));
        }
      };
      A.dM.prototype = {
        gA(a) {
        ...
        al(a, b, c) {
          return new A.c9(this, b, A.A(this).h("@<1>").I(c).h("c9<1,2>"));
        },
        k(a) {
          return A.iI(this, "{", "}");
        },
        be(a, b) {
          var s;
          for (s = A.nB(this, this.r, A.A(this).c); s.q(); ) if (!b.$1(s.d)) return false;
          return true;
        },
        a6(a, b) {
          return A.p0(this, b, A.A(this).c);
        },
        bf(a, b, c) {
          var s, r;
          for (s = A.nB(this, this.r, A.A(this).c); s.q(); ) {
            r = s.d;
            if (b.$1(r)) return r;
          }
          return c.$0();
        ...
        V(a, b) {
          var s, r, q, p = this, o = "index";
          A.bU(b, o, t.S);
          A.aW(b, o);
          for (s = A.nB(p, p.r, A.A(p).c), r = 0; s.q(); ) {
            q = s.d;
            if (b === r) return q;
            ++r;
          }
          throw A.d(A.eW(b, r, p, null, o));
        }
      };
      ...
      A.fM.prototype = {
        ...
        v(a) {
          if (this.b == null) return this.c.v(a);
          if (typeof a != "string") return false;
      ...
      A.fN.prototype = {
        ...
        gH(a) {
          ...
          if (s.b == null) {
            ...
            s = s.aL();
            s = new J.b4(s, s.length, A.a_(s).h("b4<1>"));
          }
          return s;
        },
        G(a, b) {
      ...
      A.ha.prototype = {
        ee(a, b, a0) {
          var s, r, q, p, o, n, m, l, k, j, i, h, g, f, e, d, c = "Invalid base64 encoding length ";
          a0 = A.aQ(b, a0, a.length);
          s = $.ok();
          for (r = b, q = r, p = null, o = -1, n = -1, m = 0; r < a0; r = l) {
            l = r + 1;
            k = B.a.J(a, r);
            if (k === 37) {
              j = l + 2;
            ...
            if (0 <= i && i <= 127) {
              h = s[i];
              if (h >= 0) {
                i = B.a.B("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", h);
                if (i === k) continue;
                k = i;
              } else {
                if (h === -1) {
                  if (o < 0) {
                    g = p == null ? null : p.a.length;
                    if (g == null) g = 0;
                    o = g + (r - q);
                    n = r;
                  }
            ...
            throw A.d(A.R("Invalid base64 data", a, r));
          }
          if (p != null) {
            g = p.a += B.a.u(a, q, a0);
            f = g.length;
            ...
            g = p.a;
            return B.a.aH(a, b, a0, g.charCodeAt(0) == 0 ? g : g);
          }
          d = a0 - b;
      ...
      A.hb.prototype = {
        e0(a, b) {
          var s, r, q, p = A.aQ(b, null, a.length);
      ...
      A.mu.prototype = {
        ...
        dX(a, b, c, d) {
          this.c.a += this.a.cE(a, b, c, false);
        }
      };
      A.lA.prototype = {};
      A.lB.prototype = {
        e_(a) {
          var s = this.a, r = A.ve(s, a, 0, null);
          if (r != null) return r;
          return new A.fV(s).cE(a, 0, null, true);
        }
      };
      A.fV.prototype = {
        cE(a, b, c, d) {
          var s, r, q, p, o, n = this, m = A.aQ(b, c, J.a3(a));
          if (b === m) return "";
          if (t.gc.b(a)) {
            s = a;
            r = 0;
        ...
        e3(a, b, c, d) {
          var s, r, q, p, o, n, m, l = this, k = 65533, j = l.b, i = l.c, h = new A.ac(""), g = b + 1, f = a[b];
          $label0$0: for (s = l.a; true; ) {
            for (; true; g = p) {
              r = B.a.J("", f) & 31;
              i = j <= 32 ? f & 61694 >>> r : (f & 63 | i << 6) >>> 0;
              j = B.a.J(" \x000:XECCCCCN:lDb \x000:XECCCCCNvlDb \x000:XECCCCCN:lDb AAAAA\0\0\0\0\0AAAAA00000AAAAA:::::AAAAAGG000AAAAA00KKKAAAAAG::::AAAAA:IIIIAAAAA0000AAAAA\0\0\0\0 AAAAA", j + r);
              if (j === 0) {
                h.a += A.be(i);
            ...
            if (f < 128) {
              ...
              if (o - g < 20) for (m = g; m < o; ++m) h.a += A.be(a[m]);
              else h.a += A.p2(a, g, o);
              if (o === c) break $label0$0;
              g = p;
            } else g = p;
          }
          if (d && j > 32) if (s) h.a += A.be(k);
          else {
            l.b = 77;
            l.c = c;
            return "";
      ...
      A.dp.prototype = {
        ...
        ew() {
          ...
          A.bU(true, "isUtc", t.y);
          return new A.dp(s, true);
        },
        k(a) {
          var s = this, r = A.oy(A.fk(s)), q = A.b6(A.oW(s)), p = A.b6(A.oS(s)), o = A.b6(A.oT(s)), n = A.b6(A.oV(s)), m = A.b6(A.oX(s)), l = A.oz(A.oU(s)), k = r + "-" + q;
          if (s.b) return k + "-" + p + " " + o + ":" + n + ":" + m + "." + l + "Z";
          else return k + "-" + p + " " + o + ":" + n + ":" + m + "." + l;
        },
        ev() {
          var s = this, r = A.fk(s) >= -9999 && A.fk(s) <= 9999 ? A.oy(A.fk(s)) : A.u5(A.fk(s)), q = A.b6(A.oW(s)), p = A.b6(A.oS(s)), o = A.b6(A.oT(s)), n = A.b6(A.oV(s)), m = A.b6(A.oX(s)), l = A.oz(A.oU(s)), k = r + "-" + q;
      ...
      A.H.prototype = {
        gb2() {
          return A.aS(this.$thrownJsError);
        }
      };
      A.eF.prototype = {
        k(a) {
      ...
      A.at.prototype = {
        ...
        k(a) {
          var s = this, r = s.c, q = r == null ? "" : " (" + r + ")", p = s.d, o = p == null ? "" : ": " + A.b(p), n = s.gbE() + q + o;
          if (!s.a) return n;
      ...
      A.dH.prototype = {
        k(a) {
          var s, r, q, p, o, n, m, l, k = this, j = {}, i = new A.ac("");
          j.a = "";
          s = k.c;
      ...
      A.aK.prototype = {
        k(a) {
          var s, r, q, p, o, n, m, l, k, j, i, h = this.a, g = h != null && "" !== h ? "FormatException: " + A.b(h) : "FormatException", f = this.c, e = this.b;
          if (typeof e == "string") {
            if (f != null) s = f < 0 || f > e.length;
            else s = false;
            if (s) f = null;
            if (f == null) {
              if (e.length > 78) e = B.a.u(e, 0, 75) + "...";
              return g + "\n" + e;
            }
            for (r = 1, q = 0, p = false, o = 0; o < f; ++o) {
              n = B.a.J(e, o);
              if (n === 10) {
                if (q !== o || !p) ++r;
                q = o + 1;
      ...
      A.j.prototype = {
        aj(a, b) {
          return A.he(this, A.A(this).h("j.E"), b);
        },
        al(a, b, c) {
          return A.jQ(this, b, A.A(this).h("j.E"), c);
        },
        G(a, b) {
          var s;
          for (s = this.gH(this); s.q(); ) if (J.af(s.gt(), b)) return true;
          return false;
        },
        aR(a, b) {
          var s;
          for (s = this.gH(this); s.q(); ) if (b.$1(s.gt())) return true;
          return false;
        },
        b_(a, b) {
          return A.bc(this, false, A.A(this).h("j.E"));
        },
        gj(a) {
          var s, r = this.gH(this);
          for (s = 0; r.q(); ) ++s;
          return s;
        },
        gA(a) {
        ...
        a6(a, b) {
          return A.p0(this, b, A.A(this).h("j.E"));
        },
        V(a, b) {
          var s, r, q;
          A.aW(b, "index");
          for (s = this.gH(this), r = 0; s.q(); ) {
            q = s.gt();
            if (b === r) return q;
            ++r;
          }
          throw A.d(A.eW(b, r, this, null, "index"));
        },
        k(a) {
          return A.uh(this, "(", ")");
        }
      ...
      A.cY.prototype = {
        k(a) {
          return "MapEntry(" + A.b(this.a) + ": " + A.b(this.b) + ")";
        }
      };
      A.l.prototype = {
        gE(a) {
          return A.c.prototype.gE.call(this, this);
        },
        k(a) {
          return "null";
        }
      ...
      A.c.prototype = {
        ...
        k(a) {
          return "Instance of '" + A.b(A.ka(this)) + "'";
        },
        bm(a, b) {
          throw A.d(A.uT(this, b.gcT(), b.gcX(), b.gcU(), null));
        },
        toString() {
          return this.k(this);
        }
      ...
      A.lx.prototype = {
        $2(a, b) {
          throw A.d(A.R("Illegal IPv4 address, " + a, this.a, b));
        },
        $S: 87
      };
      A.ly.prototype = {
        $2(a, b) {
          throw A.d(A.R("Illegal IPv6 address, " + a, this.a, b));
        },
        $S: 88
      };
      A.lz.prototype = {
      ...
      A.en.prototype = {
        ...
        O(a, b) {
          ...
          if (b == null) return false;
          if (q === b) return true;
          if (t.n.b(b)) if (q.a === b.gc8()) if (q.c != null === b.gbN()) if (q.b === b.gd2()) if (q.gbQ() === b.gbQ()) if (q.gbZ() === b.gbZ()) if (q.e === b.gcV()) {
            s = q.f;
            r = s == null;
            if (!r === b.gbP()) {
              if (r) s = "";
      ...
      A.lv.prototype = {
        gbo(a) {
          ...
          if (m == null) {
            ...
            q = m.length;
            if (r >= 0) {
              p = A.eo(m, r + 1, q, B.D, false, false);
              q = r;
            } else p = n;
            m = o.c = new A.fH("data", "", n, n, A.eo(m, s, q, B.ax, false, false), p, n);
          }
          return m;
        },
        gbV() {
          var s = this.b, r = s[0] + 1, q = s[1];
          if (r === q) return "text/plain";
          return A.vY(this.a, r, q, B.ac, false);
        },
        cD() {
          var s, r, q, p, o, n, m, l, k = this.a, j = this.b, i = B.d.gaV(j) + 1;
          if ((j.length & 1) === 1) return B.b8.e0(k, i);
          j = k.length;
          s = j - i;
          for (r = i; r < j; ++r) if (B.a.B(k, r) === 37) {
            r += 2;
            s -= 2;
          }
          q = new Uint8Array(s);
          if (s === j) {
            B.j.a5(q, 0, s, new A.c8(k), i);
            return q;
          }
          for (r = i, p = 0; r < j; ++r) {
            o = B.a.B(k, r);
            if (o !== 37) {
              ...
              throw A.d(A.R("Invalid percent escape", k, r));
            }
            p = n;
          }
          return q;
      ...
      A.fP.prototype = {
        ...
        gcV() {
          return B.a.u(this.a, this.e, this.f);
        },
        gcY() {
      ...
      A.a4.prototype = {
        ...
        gad() {
          ...
          if (r === 5121 || r === 5120) {
            ...
            return s.gac();
          } else if (r === 5123 || r === 5122) {
            if (s.Q === "MAT3") return 22;
            return 2 * s.gac();
          }
          return 4 * s.gac();
        },
        ...
        p(a, b) {
          var s, r, q, p = this, o = "bufferView", n = a.y, m = p.w, l = p.CW = n.i(0, m), k = l == null;
          if (!k && l.z !== -1) p.cx = l.z;
          ...
          if (m != null) {
            ...
            if (m !== -1) {
              ...
              if (n == null) b.l($.Q(), A.a([m], t.M), o);
                ...
                if (q.r.z !== -1) b.n($.nj(), o);
                n = q.f;
                if (n !== -1) A.bu(q.e, A.b0(n), A.b0(n) * l, q.r, m, b);
              }
            }
            k.pop();
            k.push("values");
      ...
      A.fC.prototype = {
        af() {
          var s = this;
          return A.bS(function() {
            var r = 0, q = 2, p, o, n, m, l, k, j, i, h, g, f, e, d, c, b, a, a0;
            return function $async$af(a1, a2) {
              if (a1 === 1) {
                p = a2;
                r = q;
              }
              while (true) switch (r) {
                case 0:
                  ...
                  if (m != null) {
                    ...
                    m = s.x;
                    l = s.ch;
                    if (!A.bu(m, l, s.gaS(), s.CW, null, null)) {
                      r = 1;
                      break;
                    }
                    k = s.CW;
                    ...
                    if (s.gco()) {
                      ...
                      k = l ? 8 : 12;
                      h = l ? 2 : 3;
                      g = new A.lR(i, j, h, h, m - k).$0();
                    } else g = new A.lS(j).$3(i, o, B.c.aw(s.gap(), l) - o);
                  } else g = A.oE(n * o, new A.lT(), t.e);
                  m = s.ay;
                  if (m != null) {
                    l = m.f;
                    k = l.e;
                    if (k !== -1) {
                      f = l.f;
                      if (f != null) if (f.y !== -1) if (f.x !== -1) {
                        f = f.as;
                        if ((f == null ? null : f.z) != null) {
                          f = m.e;
                          if (f.f !== -1) if (f.e !== -1) {
                            f = f.r;
                            if (f != null) if (f.y !== -1) if (f.x !== -1) {
                              f = f.as;
                              f = (f == null ? null : f.z) == null;
                            } else f = true;
                            else f = true;
                            else f = true;
                          } else f = true;
                    ...
                    m = n.e;
                    e = n.f;
                    if (A.bu(m, A.b0(e), A.b0(e) * f, n.r, null, null)) {
                      d = s.ch;
                      c = B.m.i(0, s.Q);
                      if (c == null) c = 0;
        ...
        $0() {
          ...
          return A.bS(function() {
            ...
            return function $async$$0(a, b) {
              ...
              while (true) switch (r) {
                case 0:
                  o = s.a, n = s.c, m = s.b, l = s.d, k = s.e, j = 0, i = 0, h = 0;
                case 2:
                  if (!(j < o)) {
                    r = 3;
                    break;
                ...
                case 0:
                  ...
                  if (m != null) {
                    ...
                    if (s.gco()) {
                      ...
                      k = l ? 8 : 12;
                      h = l ? 2 : 3;
                      g = new A.lL(i, j, h, h, m - k).$0();
                    } else g = new A.lM(j).$3(i, o, B.c.aw(s.gap(), l) - o);
                  } else g = A.oE(n * o, new A.lN(), t.F);
                  m = s.ay;
                  if (m != null) {
                    l = m.f;
                    k = l.e;
      ...
      A.bZ.prototype = {
        ge8() {
          var s = this.e, r = s.r, q = r == null ? null : r.as;
      ...
      A.c_.prototype = {
        p(a, b) {
          this.r = a.y.i(0, this.d);
        }
      };
      A.c0.prototype = {
        p(a, b) {
          this.f = a.y.i(0, this.d);
        }
      };
      A.eY.prototype = {
        a0(a, b, c, d) {
          d.toString;
          if (d == 1 / 0 || d == -1 / 0 || isNaN(d)) {
            a.l($.qa(), A.a([b, d], t.M), this.a);
            return false;
          }
          return true;
        }
      ...
      A.f5.prototype = {
        ...
        aF(a) {
          ...
          for (s = j.b, r = s.length, q = j.c, p = j.a, o = j.d + "/min/", n = t.M, m = 0; m < r; ++m) if (!J.af(q[m], s[m])) {
            l = o + m;
            a.l($.o_(), A.a([q[m], s[m]], n), l);
            k = p[m];
            if (k > 0) a.l($.nY(), A.a([k, q[m]], n), l);
          }
          return true;
        }
      };
      A.f3.prototype = {
        ...
        aF(a) {
          var s, r, q, p, o, n, m, l, k, j = this;
          for (s = j.b, r = s.length, q = j.c, p = j.a, o = j.d + "/max/", n = t.M, m = 0; m < r; ++m) if (!J.af(q[m], s[m])) {
            l = o + m;
            a.l($.nZ(), A.a([q[m], s[m]], n), l);
            k = p[m];
            if (k > 0) a.l($.nX(), A.a([k, q[m]], n), l);
          }
          return true;
        }
      };
      ...
      A.bv.prototype = {
        p(a, b) {
          var s, r, q, p, o, n = this, m = "samplers", l = n.x;
          ...
          s.pop();
          s.push(m);
          for (r = l.b, l = l.a, q = l.length, p = 0; p < r; ++p) {
            o = p >= q;
            if (!(o ? null : l[p]).a$) b.Z($.h1(), p);
          }
          s.pop();
        }
      };
      A.h5.prototype = {
        $2(a, b) {
          var s, r, q, p, o, n, m = "input", l = "output", k = this.a, j = k.c;
          j.push(B.c.k(a));
          s = this.b.f;
          r = b.d;
          b.r = s.i(0, r);
      ...
      A.h6.prototype = {
        $2(a, a0) {
          var s, r, q, p, o, n, m, l, k, j, i, h, g, f, e = null, d = "sampler", c = this.b, b = c.c;
          b.push(B.c.k(a));
          s = this.a;
          r = a0.d;
          a0.f = s.x.i(0, r);
          ...
          if (r !== -1) {
            ...
            if (o == null) c.l($.Q(), A.a([r], t.M), d);
              ...
              if (p && o.w != null) {
                ...
                l = A.dl(o.w);
                k = B.dt.i(0, r);
                if ((k == null ? e : B.d.G(k, l)) === false) c.l($.qV(), A.a([l, k, r], t.M), d);
                o = a0.f;
                n = o.r;
                if (n != null && n.z !== -1 && o.w.z !== -1 && o.e != null) {
                  j = n.z;
                  ...
                  if (r === "weights") {
                    ...
                    i = r == null ? e : r.length;
                    j *= i == null ? 0 : i;
                  } else if (!B.d.G(B.R, r)) j = 0;
                  if (j !== 0 && j !== a0.f.w.z) c.l($.qU(), A.a([j, a0.f.w.z], t.M), d);
                }
              }
            }
            for (h = a + 1, s = s.w, r = s.b, o = t.M, s = s.a, n = s.length; h < r; ++h) {
              if (p) {
                g = h >= n;
                f = (g ? e : s[h]).e;
                if (f != null) {
      ...
      A.eE.prototype = {
        a0(a, b, c, d) {
          ...
          if (d < 0) a.l($.q4(), A.a([b, d], t.M), s.b);
            ...
            if (b !== 0 && d <= s.a) a.l($.q5(), A.a([b, d, s.a], t.M), s.b);
            s.a = d;
          }
          return true;
        }
      ...
      A.dK.prototype = {
        a0(a, b, c, d) {
          ...
          if (!q.a || 4 === (q.d & 4)) {
            ...
            q.e = s;
            if (3 === c) {
              if (Math.abs(Math.sqrt(s) - 1) > 769e-5) a.l($.q6(), A.a([b - 3, b, Math.sqrt(q.e)], t.M), q.c);
              q.e = 0;
            }
          }
          if (++q.d === 12) q.d = 0;
      ...
      A.by.prototype = {
        T(a, b, c) {
          ...
          if (s == null) {
            this.at = a;
            if (a === B.L || a === B.A) c.n($.qX(), b);
          } else if (s !== a) c.l($.qY(), A.a([s, a], t.M), b);
        },
        p(a, b) {
          var s, r = this, q = r.w, p = r.as = a.x.i(0, q);
          r.ax = r.z;
          s = r.Q;
          if (s === 34962) r.at = B.A;
      ...
      A.du.prototype = {
        eC(a) {
          ...
          s = a.r;
          for (r = s.length, q = a.c, p = 0; p < s.length; s.length === r || (0, A.cN)(s), ++p) {
            o = s[p];
            B.d.P(q);
            B.d.D(q, o.b);
            o.a.c4(this, a);
      ...
      A.iw.prototype = {
        $0() {
          return B.d.P(this.a.c);
        },
        $S: 1
      };
      A.ix.prototype = {
        $1$2(a, b, c) {
          var s, r, q, p, o, n, m, l, k, j = this, i = j.a;
          if (!i.v(a)) {
            i = J.b8(0, c.h("0*"));
          ...
          if (t.m.b(s)) {
            ...
            if (i.ga8(s)) {
              p = i.gj(s);
              q = A.U(p, null, false, q);
              o = r.c;
              o.push(a);
              for (n = t.M, m = t.t, l = 0; l < i.gj(s); ++l) {
                k = i.i(s, l);
                if (m.b(k)) {
                  o.push(B.c.k(l));
                  q[l] = b.$2(k, r);
                  o.pop();
                } else r.ao($.a2(), A.a([k, "object"], n), l);
              }
              return new A.F(q, p, a, c.h("F<0*>"));
            } else {
              r.n($.bX(), a);
              i = J.b8(0, q);
              return new A.F(i, 0, a, c.h("F<0*>"));
      ...
      A.iy.prototype = {
        $1$3$req(a, b, c, d) {
          ...
          this.a.$0();
          s = this.c;
          r = A.nP(this.b, a, s, true);
          if (r == null) return null;
          s.c.push(a);
          return b.$2(r, s);
        },
        $2(a, b) {
          return this.$1$3$req(a, b, false, t.z);
        },
        $1$2(a, b, c) {
          return this.$1$3$req(a, b, false, c);
        },
        $S: 39
      };
      A.iu.prototype = {
        $2(a, b) {
          var s, r, q, p, o, n = this.a, m = n.c;
          m.push(a.c);
          s = this.b;
          a.a4(new A.iv(n, s));
          r = n.f.i(0, b);
          if (r != null) {
            q = J.cX(m.slice(0), A.a_(m).c);
            for (p = J.aA(r); p.q(); ) {
              o = p.gt();
              B.d.P(m);
              B.d.D(m, o.b);
      ...
      A.aU.prototype = {
        ...
        ez() {
          var s, r = this.Q, q = r == null ? null : r.as;
          if ((q == null ? null : q.z) != null) try {
            this.z = A.nw(r.as.z.buffer, r.x, r.y);
          } catch (s2) {
            if (!(A.M(s2) instanceof A.at)) throw s2;
          }
        }
      };
      A.ai.prototype = {
        p(a, b) {
          var s = this, r = new A.jR(b, a);
      ...
      A.cz.prototype = {
        p(a, b) {
          var s, r;
          this.dd(a, b);
          for (s = b.e, r = this; r != null; ) {
            r = s.i(0, r);
            if (r instanceof A.ai) {
              r.ay = true;
              break;
            }
          }
      ...
      A.bj.prototype = {
        p(a, b) {
          var s, r = this, q = r.d, p = r.f = a.cy.i(0, q);
          if (q !== -1) if (p == null) b.l($.Q(), A.a([q], t.M), "index");
          else p.a$ = true;
          for (q = b.e, s = r; s != null; ) {
            s = q.i(0, s);
            if (s instanceof A.ai) {
              s.ch.m(0, b.S(), r.e);
              break;
            }
          }
      ...
      A.y.prototype = {
        k(a) {
          var s = B.ay.i(0, this.b), r = this.c ? " normalized" : "";
        ...
        gE(a) {
          return A.px(A.fW(A.fW(A.fW(0, J.bY(this.a)), B.c.gE(this.b)), B.c0.gE(this.c)));
        }
      };
      A.aV.prototype = {
        p(a, b) {
      ...
      A.aE.prototype = {
        ...
        p(a, a0) {
          var s, r, q, p, o, n, m, l, k, j, i, h, g, f = this, e = "attributes", d = "indices", c = "material", b = f.d;
          if (b != null) {
            s = a0.c;
            s.push(e);
            ...
            if (s == null) a0.l($.Q(), A.a([b], t.M), d);
              ...
              if (!B.d.G(B.aq, r)) a0.F($.r6(), A.a([r, B.aq], t.M));
                ...
                if (p !== 0 && q >= -1) {
                  ...
                  m = f.cy.y;
                  l = new Uint32Array(3);
                  a0.a_(s, new A.eU(q, n, A.q1(m), 16 === (p & 16), l, o));
                }
              }
              b.pop();
            }
          ...
          for (b = f.dx, s = B.d.gH(b), b = new A.cF(s, new A.jZ(), A.a_(b).h("cF<1>")), o = a0.c; b.q(); ) {
            n = s.gt();
            o.push(e);
      ...
      A.jV.prototype = {
        $1(a) {
          ...
          if (a.gj(a) !== 0) {
            s = a.a;
            s = s.length > 1 && B.a.J(s, 0) === 48;
          } else s = true;
          if (s) return -1;
          for (s = a.a, r = s.length, q = 0, p = 0; p < r; ++p) {
            o = B.a.J(s, p) - 48;
            if (o > 9 || o < 0) return -1;
            q = 10 * q + o;
          }
      ...
      A.jU.prototype = {
        $1(a) {
          ...
          s = a.split("_");
          if (B.d.G(B.cm, s[0])) if (s.length === 2) {
            r = s[1];
            r.toString;
            r = J.af(this.a.$1(new A.c8(r)), -1);
          } else r = true;
          else r = true;
          if (r) this.b.n($.nk(), a);
        },
      ...
      A.jX.prototype = {
        $2(a, b) {
          ...
          if (n != null) {
            if (!n.G(0, o)) q.l($.o7(), A.a([o, n], t.M), a);
            else if (a === "NORMAL") {
              p = q.c;
              p.push("NORMAL");
              m = q.S();
              ...
              p.pop();
            } else if (a === "COLOR_0" && 5126 === s.y) {
              p = q.c;
              p.push(a);
              q.a_(s, new A.eK(q.S()));
              p.pop();
            }
          } else if (s.y === 5125) q.n($.r3(), a);
          p = s.x;
          if (!(p !== -1 && p % 4 !== 0)) if (s.gad() % 4 !== 0) {
            p = s.CW;
            p = p != null && p.z === -1;
          } else p = false;
          else p = true;
      ...
      A.ap.prototype = {
            ...
            if (o == null) b.l($.Q(), A.a([r], t.M), "mesh");
              ...
              if (o != null) {
                ...
                if (o) {
                  ...
                  s = s.length;
                  q = p.cy.w.i(0, 0).cx;
                  b.l(o, A.a([s, q == null ? null : q.length], t.M), "weights");
                }
                if (r && p.cy.x != null) p.cy.y = true;
                if (p.dx != null) {
                  o = p.cy.w;
                  if (o.be(o, new A.k3())) b.L($.re());
                } else {
                  o = p.cy.w;
                  if (o.aR(o, new A.k4())) b.L($.rf());
                }
              }
            }
          }
        ...
        cd(a, b) {
          ...
          for (s = o.cx, r = s.length, q = 0; q < r; ++q) {
            p = s[q];
            if (p != null) p.cd(a, b);
          }
        }
      ...
      A.k5.prototype = {
        $3(a, b, c) {
          if (a.db != null) this.b.ao($.rd(), A.a([b], t.M), c);
          a.db = this.a;
        },
        $S: 10
      };
      ...
      A.ke.prototype = {
        $3(a, b, c) {
          if (a.db != null) this.b.ao($.rh(), A.a([b], t.M), c);
      ...
      A.bI.prototype = {
        p(a, b) {
          var s, r, q, p, o, n = this, m = "inverseBindMatrices", l = "skeleton", k = n.w;
          n.z = a.f.i(0, k);
          s = a.ax;
          r = n.x;
          n.as = s.i(0, r);
          q = n.y;
          if (q != null) {
            p = A.U(q.gj(q), null, false, t.L);
            n.Q = p;
            A.nT(q, p, s, "joints", b, new A.lm(n));
            if (n.at.a === 0) b.n($.t6(), "joints");
          }
          if (k !== -1) {
            s = n.z;
      ...
      A.lm.prototype = {
        $3(a, b, c) {
          ...
          r = a;
          while (true) {
            if (!(r != null && s.C(0, r))) break;
            r = r.db;
          }
          q = this.a.at;
          if (q.a === 0) q.D(0, s);
          else q.dv(s.gcC(s), false);
        },
        $S: 10
      };
      A.eT.prototype = {
      ...
      A.bK.prototype = {
        ...
        c4(a, b) {
          var s = this.z, r = s == null, q = r ? null : s.x;
          if (q == null) {
            s = r ? null : s.as;
            q = s == null ? null : s.a;
          }
          if (q != null && !B.d.G(B.ap, q)) b.l($.oa(), A.a([q, B.ap], t.M), "source");
        },
        $icC: 1
      };
      A.lE.prototype = {};
      A.i.prototype = {
        a_(a, b) {
          J.nm(this.d.c_(a, new A.hg()), b);
        },
        W(a, b) {
          var s, r, q;
          for (s = J.aA(b), r = this.e; s.q(); ) {
            q = s.gt();
            if (q != null) r.m(0, q, a);
          }
        },
        ...
        e9(a, b) {
          var s, r, q, p, o, n, m, l, k, j, i = this, h = "/extensionsUsed/";
          B.d.D(i.as, a);
          for (s = J.V(a), r = i.ax, q = i.cx, p = J.V(b), o = t.M, n = 0; n < s.gj(a); ++n) {
            m = s.i(a, n);
            l = $.q3().aT(m);
        ...
        ab(a, b, c, d, e, f) {
          var s, r, q, p = this, o = p.b, n = a.b;
          if (o.b.G(0, n)) return;
          s = o.c;
          if (s.a !== 0 && !s.G(0, n)) return;
          s = o.a;
          if (s > 0 && p.cy.length === s) {
            p.y = true;
            throw A.d(B.ba);
          }
          o = o.d;
        ...
        n(a, b) {
          return this.ab(a, null, null, b, false, null);
        },
        F(a, b) {
          return this.ab(a, b, null, null, false, null);
        },
        l(a, b, c) {
          return this.ab(a, b, null, c, false, null);
        },
        ao(a, b, c) {
          return this.ab(a, b, c, null, false, null);
        },
        Z(a, b) {
          return this.ab(a, null, b, null, false, null);
        },
        L(a) {
          return this.ab(a, null, null, null, false, null);
        },
        aE(a, b, c) {
          return this.ab(a, b, null, null, c, null);
        },
        aQ(a, b) {
          return this.ab(a, null, null, null, false, b);
        },
        a2(a, b, c) {
          return this.ab(a, b, null, null, false, c);
        }
      };
      A.hh.prototype = {
        $1(a) {
      ...
      A.hm.prototype = {
        $0() {
          return B.d.bf(B.au, new A.hj(this.a), new A.hk());
        },
        $S: 61
      };
      A.hj.prototype = {
      ...
      A.hn.prototype = {
        $2(a, b) {
          this.a.z.m(0, new A.cb(a, this.b.a), b);
        },
        $S: 62
      };
          ...
          if (!p.c) {
            ...
            switch (s) {
              ...
              case B.ah:
                ...
                break;
              case B.ai:
                p.b = new A.lJ(new Uint8Array(30), q, r);
                break;
              default:
                r.K();
                q.R(B.bj);
      ...
      A.iM.prototype = {
        ...
        dD(a) {
          var s, r, q, p, o, n, m, l, k, j, i = this, h = new A.iO(), g = new A.iN();
          for (s = J.V(a), r = 0; r !== s.gj(a); ) {
            q = s.i(a, r);
            switch (i.c) {
              case 0:
                if (255 === q) i.c = 255;
              ...
              case 2:
                ...
                if (h.$1(i.d)) {
                  p = i.e;
                  i.r = new Uint8Array(p - 2);
                }
                i.c = 3;
                break;
              case 3:
                o = Math.min(s.gj(a) - r, i.e - i.f - 2);
                p = h.$1(i.d);
                n = i.f;
                m = n + o;
                if (p) {
                  ...
                  if (i.f === i.e - 2) {
                    ...
                    k.ah(new A.cd("image/jpeg", l, j, (n << 8 | m) >>> 0, (s << 8 | p) >>> 0, B.r, B.u, false, false));
                    return;
                  }
                } else {
                  i.f = m;
      ...
      A.iO.prototype = {
        $1(a) {
          return (a & 240) === 192 && a !== 196 && a !== 200 && a !== 204 || a === 222;
        },
        $S: 9
      };
      A.iN.prototype = {
        $1(a) {
          return !(a === 1 || (a & 248) === 208 || a === 216 || a === 217 || a === 255);
        },
        $S: 9
      };
      A.k7.prototype = {
        C(a, b) {
          var s, r, q, p, o, n, m, l, k, j, i, h, g, f, e = this, d = new A.k8(e);
          for (s = J.V(b), r = e.ay, q = e.ax, p = 0; p !== s.gj(b); ) {
            o = s.i(b, p);
            switch (e.x) {
              case 0:
                p += 8;
                ...
                if (++e.f === 4) {
                  switch (n) {
                    ...
                    case 1229209940:
                      ...
                      s = q.buffer;
                      b = new DataView(s, 0);
                      m = b.getUint32(0, false);
                      l = b.getUint32(4, false);
                      k = b.getUint8(8);
                      switch (b.getUint8(9)) {
                        case 0:
                          j = e.z ? B.af : B.ae;
                      ...
                      n.ah(new A.cd("image/png", k, j, m, l, s, r, q, false));
                      return;
                  }
                  if (e.c === 0) e.x = 4;
                  else e.x = 3;
                ...
                if (e.w === e.c) {
                  switch (e.e) {
                    ...
                    case 1883789683:
                      n = r.buffer;
                      f = new DataView(n, 0);
                      if (f.getUint32(0, false) !== f.getUint32(4, false)) e.at = true;
                      break;
                  }
                  e.x = 4;
                }
        ...
        dm() {
          var s = this;
          if (s.Q === B.v) return;
          switch (A.f7(s.ay.buffer, 0, null).getUint32(0, false)) {
            case 45455:
              s.Q = B.v;
              break;
            case 1e5:
        ...
        dl() {
          ...
          if (s.getUint32(0, false) === 31270 && s.getUint32(4, false) === 32900 && s.getUint32(8, false) === 64e3 && s.getUint32(12, false) === 33e3 && s.getUint32(16, false) === 3e4 && s.getUint32(20, false) === 6e4 && s.getUint32(24, false) === 15e3 && s.getUint32(28, false) === 6e3) r.as = B.t;
          else r.as = B.E;
        }
      };
      A.k8.prototype = {
      ...
      A.lJ.prototype = {
        C(a, b) {
          var s, r, q, p, o, n, m, l = this, k = J.a3(b), j = l.d, i = l.c;
          k = j + Math.min(k, 30 - j);
          l.d = k;
          B.j.d5(i, j, k, b);
          k = l.d;
          ...
          if (s.getUint32(0, false) !== 1380533830 || s.getUint32(8, false) !== 1464156752) {
            l.cb(B.aj);
            return;
          }
          switch (s.getUint32(12, false)) {
            case 1448097824:
              r = s.getUint16(26, true) & 16383;
              q = s.getUint16(28, true) & 16383;
              p = B.p;
              o = false;
              n = false;
              break;
          ...
          k = o ? B.F : B.v;
          j = o ? B.E : B.t;
          l.a.a3(new A.cd("image/webp", 8, p, r, q, j, k, false, n));
        }
      };
      ...
      A.fn.prototype = {
        bn() {
          var s, r = this, q = t.X, p = t._, o = A.a9(q, p);
          o.m(0, "pointer", r.a);
          s = r.b;
      ...
      A.kb.prototype = {
        ...
        eb() {
          var s = 0, r = A.ex(t.H), q, p = 2, o, n = this, m, l, k;
          var $async$aX = A.ez(function(a, b) {
            if (a === 1) {
              o = b;
              s = p;
            }
        ...
        b7() {
          var s = 0, r = A.ex(t.H), q = 1, p, o = this, n, m, l, k, j, i, h, g, f, e, d, c, b, a, a0, a1, a2, a3;
          var $async$b7 = A.ez(function(a4, a5) {
            if (a4 === 1) {
              p = a5;
              s = q;
            }
                ...
                if (l != null) {
                  ...
                  if (J.a3(l) < n.x) a1.F($.ql(), A.a([J.a3(l), n.x], g));
                    ...
                    if (a1.dx && d === 0 && !n.y) {
                      c = n.x;
                      a0 = c + (-c & 3);
                      if (J.a3(l) > a0) a1.F($.qm(), A.a([J.a3(l) - a0], g));
                    }
                    c = n;
                    if (c.z == null) c.z = l;
                  }
        ...
        b8() {
          var s = 0, r = A.ex(t.H), q = 1, p, o = this, n, m, l, k, j, i, h, g, f, e, d, c, b, a, a0, a1, a2, a3, a4, a5, a6, a7;
          var $async$b8 = A.ez(function(a9, b0) {
            if (a9 === 1) {
              p = b0;
              s = q;
            }
              ...
              case 10:
                if (j != null) {
                  ...
                  if (n.x != null && n.x !== j.a) {
                    a1 = $.qp();
                    a4 = A.a([j.a, n.x], d);
                    a5.l(a1, a4, a2.c === B.aN ? "bufferView" : "uri");
                  }
                  a1 = j.d;
                  if (a1 !== 0 && (a1 & a1 - 1) >>> 0 === 0) {
                    a1 = j.e;
      ...
      A.ne.prototype = {
        $2(a, b) {
          var s, r, q, p, o, n, m, l, k = A.mJ(b);
          if ((k == null ? null : k.ay) != null) {
            k = this.a;
            s = k.c;
            B.d.P(s);
            s.push("accessors");
            s.push(B.c.k(a));
            r = b.ay.ge8();
            if (r != null) for (s = r.length, q = b.z, p = t.M, o = 0, n = -1, m = 0; m < s; ++m, n = l) {
              l = r[m];
              if (n !== -1 && l <= n) k.l($.qi(), A.a([o, l, n], p), "sparse");
              if (l >= q) k.l($.qh(), A.a([o, l, q], p), "sparse");
              ++o;
            }
          }
        },
      ...
      A.ng.prototype = {
        $2(a, b) {
          var s, r, q, p, o = this, n = null, m = b.CW, l = b.as, k = A.U(l, n, false, t.bF), j = A.U(l, n, false, t.ga), i = t.hc, h = b.ay, g = 0;
          while (true) {
            if (!(g < l)) {
              s = false;
              break;
      ...
      A.eX.prototype = {
        dY(a) {
          ...
          for (s = d.a, r = s.length, q = d.b, p = d.c, o = d.e, n = o + "/JOINTS_", m = t.M, l = d.z, o += "/WEIGHTS_", k = d.d, j = 0; j < r; ++j) {
            i = s[j].gt();
            if (i == null) {
              d.w = true;
              return;
            ...
            if (i > p) {
              a.l($.qe(), A.a([d.f, d.r, i, p, k], m), n + j);
              continue;
            }
            h = q[j].gt();
            if (h == null) {
            ...
            } else if (i !== 0) a.l($.qf(), A.a([d.f, d.r, i], m), n + j);
          }
          if (4 === ++d.r) {
            if (Math.abs(d.x - 1) > d.y) for (j = 0; j < r; ++j) {
              s = $.qk();
              q = d.f;
              a.l(s, A.a([q - 3, q, d.x], m), o + j);
            }
            l.P(0);
            d.x = d.y = d.r = 0;
          }
      ...
      A.hL.prototype = {
        $1(a) {
          return "Actual data byte length (" + A.b(a[0]) + ") is less than the declared buffer byte length (" + A.b(a[1]) + ").";
        },
        $S: 0
      };
      A.hM.prototype = {
        $1(a) {
          return "GLB-stored BIN chunk contains " + A.b(a[0]) + " extra padding byte(s).";
        },
        $S: 0
      };
      A.hE.prototype = {
        $1(a) {
          return "Declared minimum value for this component (" + A.b(a[0]) + ") does not match actual minimum (" + A.b(a[1]) + ").";
        },
        $S: 0
      };
      A.hD.prototype = {
        $1(a) {
          return "Declared maximum value for this component (" + A.b(a[0]) + ") does not match actual maximum (" + A.b(a[1]) + ").";
        },
        $S: 0
      };
      A.ht.prototype = {
        $1(a) {
          return "Accessor contains " + A.b(a[0]) + " element(s) less than declared minimum value " + A.b(a[1]) + ".";
        },
        $S: 0
      };
      A.hs.prototype = {
        $1(a) {
          return "Accessor contains " + A.b(a[0]) + " element(s) greater than declared maximum value " + A.b(a[1]) + ".";
        },
        $S: 0
      };
      A.hI.prototype = {
        $1(a) {
          return "Vector3 at accessor indices " + A.b(a[0]) + ".." + A.b(a[1]) + " is not of unit length: " + A.b(a[2]) + ".";
        },
        $S: 0
      };
      A.hz.prototype = {
        $1(a) {
          return "Vector3 with sign at accessor indices " + A.b(a[0]) + ".." + A.b(a[1]) + " has invalid w component: " + A.b(a[2]) + ". Must be 1.0 or -1.0.";
        },
        $S: 0
      };
      A.hr.prototype = {
        $1(a) {
          return "Animation sampler output accessor element at indices " + A.b(a[0]) + ".." + A.b(a[1]) + " is not of unit length: " + A.b(a[2]) + ".";
        },
        $S: 0
      };
      A.hF.prototype = {
        $1(a) {
          return "Accessor element at index " + A.b(a[0]) + " is not clamped to 0..1 range: " + A.b(a[1]) + ".";
        },
        $S: 0
      };
      A.hx.prototype = {
        $1(a) {
          return "Accessor element at index " + A.b(a[0]) + " is " + A.b(a[1]) + ".";
        },
        $S: 0
      };
      A.hu.prototype = {
        $1(a) {
          return "Indices accessor element at index " + A.b(a[0]) + " has value " + A.b(a[1]) + " that is greater than the maximum vertex index available (" + A.b(a[2]) + ").";
        },
        $S: 0
      };
      A.hw.prototype = {
        $1(a) {
          return "Indices accessor contains " + A.b(a[0]) + " degenerate triangles (out of " + A.b(a[1]) + ").";
        },
        $S: 0
      };
      A.hv.prototype = {
        $1(a) {
          return "Indices accessor contains primitive restart value (" + A.b(a[0]) + ") at index " + A.b(a[1]) + ".";
        },
        $S: 0
      };
      A.hp.prototype = {
        $1(a) {
          return u.m + A.b(a[0]) + " is negative: " + A.b(a[1]) + ".";
        },
        $S: 0
      };
      A.hq.prototype = {
        $1(a) {
          return u.m + A.b(a[0]) + " is less than or equal to previous: " + A.b(a[1]) + " <= " + A.b(a[2]) + ".";
        },
        $S: 0
      };
      A.hH.prototype = {
        $1(a) {
          return u.d + A.b(a[0]) + " is less than or equal to previous: " + A.b(a[1]) + " <= " + A.b(a[2]) + ".";
        },
        $S: 0
      };
      A.hG.prototype = {
        $1(a) {
          return u.d + A.b(a[0]) + " is greater than or equal to the number of accessor elements: " + A.b(a[1]) + " >= " + A.b(a[2]) + ".";
        },
        $S: 0
      };
      A.hy.prototype = {
        $1(a) {
          return "Matrix element at index " + A.b(a[0]) + " (component index " + A.b(a[1]) + ") contains invalid value: " + A.b(a[2]) + ".";
        },
        $S: 0
      };
      A.hO.prototype = {
        $1(a) {
          return "Image data is invalid. " + A.b(a[0]);
        },
        $S: 0
      };
      A.hQ.prototype = {
        $1(a) {
          return "Recognized image format " + ("'" + A.b(a[0]) + "'") + " does not match declared image format " + ("'" + A.b(a[1]) + "'") + ".";
        },
        $S: 0
      };
      A.hT.prototype = {
      ...
      A.hR.prototype = {
        $1(a) {
          return "'" + A.b(a[0]) + "' MIME type requires an extension.";
        },
        $S: 0
      };
      A.hS.prototype = {
        $1(a) {
          return "Image has non-power-of-two dimensions: " + A.b(a[0]) + "x" + A.b(a[1]) + ".";
        },
        $S: 0
      };
      A.hP.prototype = {
      ...
      A.hB.prototype = {
        $1(a) {
          return "Joints accessor element at index " + A.b(a[0]) + " (component index " + A.b(a[1]) + ") has value " + A.b(a[2]) + " that is greater than the maximum joint index (" + A.b(a[3]) + ") set by skin " + A.b(a[4]) + ".";
        },
        $S: 0
      };
      A.hA.prototype = {
        $1(a) {
          return "Joints accessor element at index " + A.b(a[0]) + " (component index " + A.b(a[1]) + ") has value " + A.b(a[2]) + " that is already in use for the vertex.";
        },
        $S: 0
      };
      A.hJ.prototype = {
        $1(a) {
          return "Weights accessor element at index " + A.b(a[0]) + " (component index " + A.b(a[1]) + ") has negative value " + A.b(a[2]) + ".";
        },
        $S: 0
      };
      A.hK.prototype = {
        $1(a) {
          return "Weights accessor elements (at indices " + A.b(a[0]) + ".." + A.b(a[1]) + ") have non-normalized sum: " + A.b(a[2]) + ".";
        },
        $S: 0
      };
      A.hC.prototype = {
        $1(a) {
          return "Joints accessor element at index " + A.b(a[0]) + " (component index " + A.b(a[1]) + ") is used with zero weight but has non-zero value (" + A.b(a[2]) + ").";
        },
        $S: 0
      };
      A.iF.prototype = {};
      ...
      A.kh.prototype = {
        $1(a) {
          return "Invalid array length " + A.b(a[0]) + ". Valid lengths are: " + J.bt(t.Y.a(a[1]), A.pM(), t.X).k(0) + ".";
        },
        $S: 0
      };
      A.ki.prototype = {
      ...
      A.kl.prototype = {
        $1(a) {
          return "Invalid JSON data. Parser output: " + A.b(a[0]);
        },
        $S: 0
      };
      A.km.prototype = {
        $1(a) {
          return "Invalid URI " + ("'" + A.b(a[0]) + "'") + ". Parser output:\n" + A.b(a[1]);
        },
        $S: 0
      };
      A.kj.prototype = {
      ...
      A.ko.prototype = {
        $1(a) {
          return "Value " + ("'" + A.b(a[0]) + "'") + " does not match regexp pattern " + ("'" + A.b(a[1]) + "'") + ".";
        },
        $S: 0
      };
      A.kp.prototype = {
      ...
      A.kv.prototype = {
        $1(a) {
          return "Value " + A.b(a[0]) + " is out of range.";
        },
        $S: 0
      };
      A.kt.prototype = {
        $1(a) {
          return "Value " + A.b(a[0]) + " is not a multiple of " + A.b(a[1]) + ".";
        },
        $S: 0
      };
      A.kq.prototype = {
        $1(a) {
          return "Property " + ("'" + A.b(a[0]) + "'") + " must be defined.";
        },
        $S: 0
      };
      A.kr.prototype = {
      ...
      A.ks.prototype = {
        $1(a) {
          return "Dependency failed. " + ("'" + A.b(a[0]) + "'") + " must be defined.";
        },
        $S: 0
      };
      A.kw.prototype = {};
      A.lj.prototype = {
        $1(a) {
          return "Unknown glTF major asset version: " + A.b(a[0]) + ".";
        },
        $S: 0
      };
      A.lk.prototype = {
        $1(a) {
          return "Unknown glTF minor asset version: " + A.b(a[0]) + ".";
        },
        $S: 0
      };
      A.l4.prototype = {
        $1(a) {
          return "Asset minVersion " + ("'" + A.b(a[0]) + "'") + " is greater than version " + ("'" + A.b(a[1]) + "'") + ".";
        },
        $S: 0
      };
      A.kL.prototype = {
        $1(a) {
          return "Invalid value " + A.b(a[0]) + " for GL type " + ("'" + A.b(a[1]) + "'") + ".";
        },
        $S: 0
      };
      A.ky.prototype = {
      ...
      A.kz.prototype = {
        $1(a) {
          return "Offset " + A.b(a[0]) + " is not a multiple of componentType length " + A.b(a[1]) + ".";
        },
        $S: 0
      };
      A.kx.prototype = {
      ...
      A.kA.prototype = {
        $1(a) {
          return "Sparse accessor overrides more elements (" + A.b(a[0]) + ") than the base accessor contains (" + A.b(a[1]) + ").";
        },
        $S: 0
      };
      A.kB.prototype = {
      ...
      A.kC.prototype = {
        $1(a) {
          return "Data URI media type must be 'application/octet-stream' or 'application/gltf-buffer'. Found " + ("'" + A.b(a[0]) + "'") + " instead.";
        },
        $S: 0
      };
      A.kE.prototype = {
        $1(a) {
          return "Buffer view's byteStride (" + A.b(a[0]) + ") is greater than byteLength (" + A.b(a[1]) + ").";
        },
        $S: 0
      };
      A.kD.prototype = {
      ...
      A.kZ.prototype = {
        $1(a) {
          return "Indices for indexed attribute semantic " + ("'" + A.b(a[0]) + "'") + " must start with 0 and be continuous. Total expected indices: " + A.b(a[1]) + ", total provided indices: " + A.b(a[2]) + ".";
        },
        $S: 0
      };
      A.l2.prototype = {
      ...
      A.l0.prototype = {
        $1(a) {
          return "Number of JOINTS attribute semantics (" + A.b(a[0]) + ") does not match the number of WEIGHTS (" + A.b(a[1]) + ").";
        },
        $S: 0
      };
      A.kY.prototype = {
        $1(a) {
          return "The length of weights array (" + A.b(a[0]) + u.p + A.b(a[1]) + ").";
        },
        $S: 0
      };
      A.l8.prototype = {
      ...
      A.ll.prototype = {
        $1(a) {
          return "Unused extension " + ("'" + A.b(a[0]) + "'") + " cannot be required.";
        },
        $S: 0
      };
      A.lf.prototype = {
        $1(a) {
          return "Extension " + ("'" + A.b(a[0]) + "'") + " cannot be optional.";
        },
        $S: 0
      };
      A.kK.prototype = {
      ...
      A.le.prototype = {
        $1(a) {
          return "Non-relative URI found: " + ("'" + A.b(a[0]) + "'") + ".";
        },
        $S: 0
      };
      A.l5.prototype = {
      ...
      A.kN.prototype = {
        $1(a) {
          return "This extension requires the animation channel target path to be 'pointer'. Found " + ("'" + A.b(a[0]) + "'") + " instead.";
        },
        $S: 0
      };
      A.kO.prototype = {
        $1(a) {
          return "outerConeAngle (" + A.b(a[1]) + ") is less than or equal to innerConeAngle (" + A.b(a[0]) + ").";
        },
        $S: 0
      };
      A.kP.prototype = {
      ...
      A.j0.prototype = {
        $1(a) {
          return "Accessor's total byteOffset " + A.b(a[0]) + " isn't a multiple of componentType length " + A.b(a[1]) + ".";
        },
        $S: 0
      };
      A.iZ.prototype = {
        $1(a) {
          return "Referenced bufferView's byteStride value " + A.b(a[0]) + " is less than accessor element's length " + A.b(a[1]) + ".";
        },
        $S: 0
      };
      A.j_.prototype = {
        $1(a) {
          return "Accessor (offset: " + A.b(a[0]) + ", length: " + A.b(a[1]) + ") does not fit referenced bufferView [" + A.b(a[2]) + "] length " + A.b(a[3]) + ".";
        },
        $S: 0
      };
      A.j1.prototype = {
        $1(a) {
          return "Override of previously set accessor usage. Initial: " + ("'" + A.b(a[0]) + "'") + ", new: " + ("'" + A.b(a[1]) + "'") + ".";
        },
        $S: 0
      };
      A.j4.prototype = {
        $1(a) {
          return "Animation channel has the same target as channel " + A.b(a[0]) + ".";
        },
        $S: 0
      };
      A.j2.prototype = {
      ...
      A.j6.prototype = {
        $1(a) {
          return "Invalid Animation sampler input accessor format " + ("'" + A.b(a[0]) + "'") + ". Must be one of " + J.bt(t.Y.a(a[1]), A.dj(), t.X).k(0) + ".";
        },
        $S: 0
      };
      A.ja.prototype = {
        $1(a) {
          return "Invalid animation sampler output accessor format " + ("'" + A.b(a[0]) + "'") + " for path " + ("'" + A.b(a[2]) + "'") + ". Must be one of " + J.bt(t.Y.a(a[1]), A.dj(), t.X).k(0) + ".";
        },
        $S: 0
      };
      A.j7.prototype = {
        $1(a) {
          return "Animation sampler output accessor with " + ("'" + A.b(a[0]) + "'") + " interpolation must have at least " + A.b(a[1]) + " elements. Got " + A.b(a[2]) + ".";
        },
        $S: 0
      };
      A.j9.prototype = {
        $1(a) {
          return "Animation sampler output accessor of count " + A.b(a[0]) + " expected. Found " + A.b(a[1]) + ".";
        },
        $S: 0
      };
      A.j5.prototype = {
      ...
      A.je.prototype = {
        $1(a) {
          return "BufferView does not fit buffer (" + A.b(a[0]) + ") byteLength (" + A.b(a[1]) + ").";
        },
        $S: 0
      };
      A.jd.prototype = {
        $1(a) {
          return "Override of previously set bufferView target or usage. Initial: " + ("'" + A.b(a[0]) + "'") + ", new: " + ("'" + A.b(a[1]) + "'") + ".";
        },
        $S: 0
      };
      A.jc.prototype = {
      ...
      A.jh.prototype = {
        $1(a) {
          return "IBM accessor must have at least " + A.b(a[0]) + " elements. Found " + A.b(a[1]) + ".";
        },
        $S: 0
      };
      A.jl.prototype = {
        $1(a) {
          return "Invalid accessor format " + ("'" + A.b(a[0]) + "'") + " for this attribute semantic. Must be one of " + J.bt(t.Y.a(a[1]), A.dj(), t.X).k(0) + ".";
        },
        $S: 0
      };
      A.jm.prototype = {
      ...
      A.jp.prototype = {
        $1(a) {
          return "Invalid indices accessor format " + ("'" + A.b(a[0]) + "'") + ". Must be one of " + J.bt(t.Y.a(a[1]), A.dj(), t.X).k(0) + ". ";
        },
        $S: 0
      };
      A.jo.prototype = {
        $1(a) {
          return "Number of vertices or indices (" + A.b(a[0]) + ") is not compatible with used drawing mode (" + ("'" + A.b(a[1]) + "'") + ").";
        },
        $S: 0
      };
      A.jv.prototype = {
        $1(a) {
          return "Material is incompatible with mesh primitive: Texture binding " + ("'" + A.b(a[0]) + "'") + " needs 'TEXCOORD_" + A.b(a[1]) + "' attribute.";
        },
        $S: 0
      };
      A.jt.prototype = {
      ...
      A.jy.prototype = {
        $1(a) {
          return "Value overrides parent of node " + A.b(a[0]) + ".";
        },
        $S: 0
      };
      A.jB.prototype = {
      ...
      A.jC.prototype = {
        $1(a) {
          return "Node " + A.b(a[0]) + " is not a root node.";
        },
        $S: 0
      };
      A.jE.prototype = {
        $1(a) {
          return "Invalid IBM accessor format " + ("'" + A.b(a[0]) + "'") + ". Must be one of " + J.bt(t.Y.a(a[1]), A.dj(), t.X).k(0) + ". ";
        },
        $S: 0
      };
      A.jD.prototype = {
      ...
      A.jF.prototype = {
        $1(a) {
          return "Invalid MIME type " + ("'" + A.b(a[0]) + "'") + " for the texture source. Valid MIME types are " + J.bt(t.Y.a(a[1]), A.dj(), t.X).k(0) + ".";
        },
        $S: 0
      };
      A.jG.prototype = {
      ...
      A.jI.prototype = {
        $1(a) {
          return "Unresolved reference: " + A.b(a[0]) + ".";
        },
        $S: 0
      };
      A.jJ.prototype = {
        $1(a) {
          return "Cannot validate an extension as it is not supported by the validator: " + ("'" + A.b(a[0]) + "'") + ".";
        },
        $S: 0
      };
      A.jM.prototype = {
      ...
      A.i5.prototype = {
        $1(a) {
          return "Invalid GLB magic value (" + A.b(a[0]) + ").";
        },
        $S: 0
      };
      A.i6.prototype = {
        $1(a) {
          return "Invalid GLB version value " + A.b(a[0]) + ".";
        },
        $S: 0
      };
      A.i8.prototype = {
        $1(a) {
          return "Declared GLB length (" + A.b(a[0]) + ") is too small.";
        },
        $S: 0
      };
      A.i_.prototype = {
        $1(a) {
          return "Length of " + A.b(a[0]) + " chunk is not aligned to 4-byte boundaries.";
        },
        $S: 0
      };
      A.i7.prototype = {
        $1(a) {
          return "Declared length (" + A.b(a[0]) + ") does not match GLB length (" + A.b(a[1]) + ").";
        },
        $S: 0
      };
      A.i0.prototype = {
        $1(a) {
          return "Chunk (" + A.b(a[0]) + ") length (" + A.b(a[1]) + ") does not fit total GLB length.";
        },
        $S: 0
      };
      A.i3.prototype = {
        $1(a) {
          return "Chunk (" + A.b(a[0]) + ") cannot have zero length.";
        },
        $S: 0
      };
      A.i2.prototype = {
      ...
      A.i1.prototype = {
        $1(a) {
          return "Chunk of type " + A.b(a[0]) + " has already been used.";
        },
        $S: 0
      };
      A.ib.prototype = {
      ...
      A.id.prototype = {
        $1(a) {
          return "First chunk must be of JSON type. Found " + A.b(a[0]) + " instead.";
        },
        $S: 0
      };
      A.i9.prototype = {
      ...
      A.ie.prototype = {
        $1(a) {
          return "Unknown GLB chunk type: " + A.b(a[0]) + ".";
        },
        $S: 0
      };
      A.i4.prototype = {
      ...
      A.ca.prototype = {
        p(a, b) {
          var s = this.d, r = this.e = a.Q.i(0, s);
          if (s !== -1) if (r == null) b.l($.Q(), A.a([s], t.M), "source");
          else r.a$ = true;
        },
        c4(a, b) {
          var s = this.e, r = s == null, q = r ? null : s.x;
          if (q == null) {
            s = r ? null : s.as;
            q = s == null ? null : s.a;
          }
          if (q != null && q !== "image/webp") b.l($.oa(), A.a([q, B.d7], t.M), "source");
        },
        $icC: 1
      };
      A.cf.prototype = {
      ...
      A.ch.prototype = {
        p(a, b) {
          var s, r, q = a.a.i(0, "KHR_lights_punctual");
          if (q instanceof A.bC) {
            s = this.d;
            r = this.e = q.d.i(0, s);
            if (s !== -1) if (r == null) b.l($.Q(), A.a([s], t.M), "light");
            else r.a$ = true;
          } else b.F($.cO(), A.a(["/extensions/KHR_lights_punctual"], t.M));
        }
      };
      A.ci.prototype = {
        p(a, b) {
          ...
          if (o != null) {
            ...
            o.p(a, b);
            for (r = b.e, q = this; q != null; ) {
              q = r.i(0, q);
              if (q instanceof A.ai) {
                q.ay = true;
                p = q.x;
      ...
      A.ck.prototype = {
        p(a, b) {
          ...
          for (s = b.e, r = this; r != null; ) {
            r = s.i(0, r);
            if (r instanceof A.ai) {
              if (!r.a.v("KHR_materials_volume")) b.L($.rI());
              break;
            }
          }
        }
      ...
      A.bb.prototype = {
        cR(a, b, c) {
          var s, r, q, p = this, o = a.a.i(0, "KHR_materials_variants");
          if (o instanceof A.bD) {
            s = p.d;
            if (s != null) {
              r = b.c;
              r.push("variants");
              A.oJ(s.gj(s), new A.iU(p, o, b, c), false, t.J);
              r.pop();
            }
            s = p.e;
            r = p.r = a.as.i(0, s);
            if (s !== -1) if (r == null) b.l($.Q(), A.a([s], t.M), "material");
              ...
              r.a$ = true;
              for (s = b.e, q = p; q != null; ) {
                q = s.i(0, q);
                if (q instanceof A.aE) {
                  p.r.ch.M(0, new A.iV(q, b));
                  break;
                }
              }
            }
          } else b.F($.cO(), A.a(["/extensions/KHR_materials_variants"], t.M));
        },
        p(a, b) {
          return this.cR(a, b, null);
        }
      };
      A.iU.prototype = {
        $1(a) {
          var s = this, r = s.a.d.i(0, a), q = s.b.d.i(0, r);
          if (r !== -1) {
            if (!s.d.C(0, r)) s.c.Z($.r1(), a);
      ...
      A.cb.prototype = {
        gE(a) {
          var s = J.bY(this.a), r = J.bY(this.b);
      ...
      A.dt.prototype = {
        c0() {
          var s = this, r = s.d = s.c.bT(new A.ii(s), s.gdB(), s.gcn()), q = s.ch;
          q.e = r.geg();
          q.f = r.gej();
          q.r = new A.ij(s);
          return s.e.a;
        ...
        dA(a0) {
          var s, r, q, p, o, n, m, l, k, j, i, h, g, f, e, d, c = this, b = "model/gltf-binary", a = "0";
          c.d.aZ();
          for (s = J.V(a0), r = t.f, q = t.G, p = t.M, o = c.a, n = 0; n !== s.gj(a0); ) switch (c.r) {
            case 0:
              m = s.gj(a0);
              l = c.w;
              k = Math.min(m - n, 12 - l);
              ...
              if (j !== 1179937895) {
                ...
                if ((s.a & 30) === 0) {
                  r = c.cx;
                  s.ah(new A.au(b, null, r));
                }
                return;
              }
              i = c.b.getUint32(4, true);
              if (i !== 2) {
                c.f.a2($.qB(), A.a([i], p), 4);
                c.d.K();
                s = c.e.a;
            ...
            case 1:
              ...
              c.x += k;
              if (c.w !== 8) break;
              c.Q = c.b.getUint32(0, true);
              m = c.b.getUint32(4, true);
              c.as = m;
              if ((c.Q & 3) !== 0) {
                l = c.f;
                h = $.qu();
                g = c.x;
                l.a2(h, A.a(["0x" + B.a.aq(B.c.av(m, 16), 8, a)], p), g - 8);
              }
              if (c.x + c.Q > c.y) c.f.a2($.qv(), A.a(["0x" + B.a.aq(B.c.av(c.as, 16), 8, a), c.Q], p), c.x - 8);
              ...
              switch (m) {
                case 1313821514:
                  ...
                  break;
                case 5130562:
                  if (c.Q === 0) c.f.aQ($.qx(), c.x - 8);
                  f.$1$seen(c.CW);
                  c.CW = true;
                  break;
                default:
                  c.f.a2($.qJ(), A.a(["0x" + B.a.aq(B.c.av(m, 16), 8, a)], p), c.x - 8);
                  c.r = 4294967295;
              }
              ++c.z;
              c.w = 0;
          ...
          switch (q.r) {
            ...
            case 1:
              if (q.w !== 0) {
                ...
                else q.e.a3(new A.au("model/gltf-binary", null, q.cx));
              }
              break;
            default:
              if (q.Q > 0) q.f.aQ($.qF(), q.x);
              q.aN();
          }
        },
        dC(a) {
      ...
      A.ii.prototype = {
        $1(a) {
          ...
          try {
            ...
            if (A.M(s2) instanceof A.bA) this.a.aN();
            else throw s2;
          }
        },
        $S: 11
      ...
      A.ig.prototype = {
        $1$seen(a) {
          var s = this.a;
          if (a) {
            s.f.a2($.qw(), A.a(["0x" + B.a.aq(B.c.av(s.as, 16), 8, "0")], t.M), s.x - 8);
            s.r = 4294967295;
          } else s.r = s.as;
        },
        $0() {
      ...
      A.ih.prototype = {
        $1(a) {
          var s = this.a, r = a == null ? null : a.b;
        ...
        $1(a) {
          ...
          if (!n.a) {
            ...
            if (103 === r) {
              ...
              s = 123 === r || 9 === r || 32 === r || 10 === r || 13 === r || 239 === r;
              q = o.c;
              p = o.b;
              if (s) {
                q.a3(A.oB(new A.aj(p, A.A(p).h("aj<1>")), o.d));
                n.a = true;
              } else {
                n.b.K();
                p.a7();
      ...
      A.cT.prototype = {
        c0() {
          var s = this, r = A.a([], t.M), q = new A.ac("");
          s.d = new A.mu(new A.fV(false), new A.mh(B.ab.gcF().a, new A.fO(new A.ik(s), r, t.cy), q), q);
        ...
        dG(a) {
          ...
          if (p.f) {
            r = J.V(a);
            if (r.ga8(a) && 239 === r.i(a, 0)) p.e.aE($.h3(), A.a(["BOM found at the beginning of UTF-8 stream."], t.M), true);
            p.f = false;
          }
          try {
            p.d.dX(a, 0, J.a3(a), false);
            p.b.ar();
          } catch (q2) {
            r = A.M(q2);
            if (r instanceof A.aK) {
              s = r;
              p.e.aE($.h3(), A.a([s], t.M), true);
              p.b.K();
              p.c.bd();
            } else throw q2;
          }
      ...
      A.ik.prototype = {
        $1(a) {
          ...
          if (t.t.b(p)) try {
            r = this.a;
            s = A.oC(p, r.e);
            r.c.a3(new A.au("model/gltf+json", s, null));
          } catch (q2) {
            if (A.M(q2) instanceof A.bA) {
              r = this.a;
              r.b.K();
              r.c.bd();
            } else throw q2;
            ...
            r = this.a;
            r.e.aE($.a2(), A.a([p, "object"], t.M), true);
            r.b.K();
            r.c.bd();
          }
        },
      ...
      A.F.prototype = {
        i(a, b) {
          return b == null || b < 0 || b >= this.a.length ? null : this.a[b];
        },
        m(a, b, c) {
          this.a[b] = c;
        },
        ...
        sj(a, b) {
          throw A.d(A.ad("Changing length is not supported"));
        },
        k(a) {
          return A.iI(this.a, "[", "]");
        },
        a4(a) {
          var s, r, q, p;
          for (s = this.b, r = this.a, q = 0; q < s; ++q) {
            p = r[q];
            if (p == null) continue;
            a.$2(q, p);
          }
      ...
      A.fv.prototype = {
        a0(a, b, c, d) {
          var s = this, r = s.c, q = r != null ? r.$1(d) : d;
          r = s.a + q * q;
          s.a = r;
          if (2 === c) {
            if (Math.abs(Math.sqrt(r) - 1) > 674e-5) a.l($.o0(), A.a([b - 2, b, Math.sqrt(s.a)], t.M), s.b);
            s.a = 0;
          }
          return true;
        }
      ...
      A.fw.prototype = {
        a0(a, b, c, d) {
          var s = this, r = s.c, q = r != null ? r.$1(d) : d;
          if (3 === c) {
            if (1 !== q && -1 !== q) a.l($.qc(), A.a([b - 3, b, q], t.M), s.b);
          } else {
            r = s.a + q * q;
            s.a = r;
            if (2 === c) {
      ...
      A.eK.prototype = {
        a0(a, b, c, d) {
          if (1 < d || 0 > d) a.l($.qg(), A.a([b, d], t.M), this.a);
          return true;
        }
      };
      A.lF.prototype = {
        bn() {
          var s, r, q, p, o, n = this, m = t.X, l = t._, k = A.a9(m, l), j = n.a;
          if (j != null) k.m(0, "uri", j.k(0));
          j = n.c;
          s = j == null;
          if ((s ? null : j.a) != null) k.m(0, "mimeType", s ? null : j.a);
          k.m(0, "validatorVersion", "2.0.0-dev.3.10");
          if (n.d) k.m(0, "validatedAt", new A.dp(Date.now(), false).ew().ev());
          j = n.b;
          r = j.cy;
          q = A.a9(m, l);
          p = A.a([0, 0, 0, 0], t.V);
          o = A.oJ(r.length, new A.lI(r, p), false, t.t);
          q.m(0, "numErrors", p[0]);
        ...
        dz() {
          var s, r, q, p, o, n, m, l, k, j, i = null, h = this.c, g = h == null ? i : h.b;
          h = g == null ? i : g.w;
          ...
          if (r.ga8(h)) {
            h = r.c3(h);
            s.m(0, "extensionsUsed", A.bc(h, false, A.A(h).c));
          }
          h = g.e;
          r = J.V(h);
          if (r.ga8(h)) {
            h = r.c3(h);
            s.m(0, "extensionsRequired", A.bc(h, false, A.A(h).c));
          }
          h = this.b;
          r = h.CW;
          ...
          for (h = new A.aa(h, h.gj(h), h.$ti.h("aa<p.E>")), q = 0, p = 0, o = 0, n = 0, m = 0, l = 0; h.q(); ) {
            r = h.d.w;
            if (r != null) {
              q += r.b;
              for (r = new A.aa(r, r.gj(r), r.$ti.h("aa<p.E>")); r.q(); ) {
                k = r.d;
                j = k.CW;
                if (j !== -1) m += j;
                l += k.gex();
      ...
      A.lI.prototype = {
        $1(a) {
          var s, r = this.a[a], q = r.gc9().a, p = this.b;
          p[q] = p[q] + 1;
      ...
      A.f2.prototype = {
        ...
        ag(a) {
          var s = new Float32Array(3), r = this.a;
          s[0] = r[a];
          s[1] = r[3 + a];
          s[2] = r[6 + a];
          return new A.cE(s);
      ...
      A.cZ.prototype = {
        ...
        ag(a) {
          var s = new Float32Array(4), r = this.a;
          s[0] = r[a];
          s[1] = r[4 + a];
          s[2] = r[8 + a];
          s[3] = r[12 + a];
        ...
        cG() {
          var s = this.a, r = s[0], q = s[5], p = s[1], o = s[4], n = r * q - p * o, m = s[6], l = s[2], k = r * m - l * o, j = s[7], i = s[3], h = r * j - i * o, g = p * m - l * q, f = p * j - i * q, e = l * j - i * m;
          m = s[8];
          i = s[9];
          j = s[10];
          l = s[11];
        ...
        cL() {
          var s = this.a, r = 0 + Math.abs(s[0]) + Math.abs(s[1]) + Math.abs(s[2]) + Math.abs(s[3]), q = r > 0 ? r : 0;
      ...
      A.fl.prototype = {
        gaW() {
          var s = this.a, r = s[0], q = s[1], p = s[2], o = s[3];
      ...
      A.cE.prototype = {
        ...
        O(a, b) {
          var s, r, q;
          if (b == null) return false;
          if (b instanceof A.cE) {
            s = this.a;
            r = s[0];
            q = b.a;
            s = r === q[0] && s[1] === q[1] && s[2] === q[2];
          } else s = false;
          return s;
        },
        gE(a) {
      ...
      A.fA.prototype = {
        ...
        O(a, b) {
          var s, r, q;
          if (b == null) return false;
          if (b instanceof A.fA) {
            s = this.a;
            r = s[0];
            q = b.a;
            s = r === q[0] && s[1] === q[1] && s[2] === q[2] && s[3] === q[3];
          } else s = false;
          return s;
        },
        gE(a) {
        ...
        gj(a) {
          var s = this.a, r = s[0], q = s[1], p = s[2];
          s = s[3];
      ...
      A.n7.prototype = {
        $2(a, b) {
          return new self.Promise(A.cK(new A.n6(a, b, this.a)), t._);
        },
        $S: 86
      };
      A.n6.prototype = {
        $2(a, b) {
          A.h_(this.a, this.b).au(0, new A.n3(a), new A.n4(this.c, b), t.P);
        },
        $S: 24
      };
      A.n3.prototype = {
      ...
      A.n4.prototype = {
        $2(a, b) {
          return this.a.$3(a, b, this.b);
        },
        $S: 26
      };
      A.n8.prototype = {
        $2(a, b) {
          return new self.Promise(A.cK(new A.n5(a, b, this.a)), t._);
        },
        $S: 90
      };
      A.n5.prototype = {
        $2(a, b) {
          A.nV(this.a, this.b).au(0, new A.n1(a), new A.n2(this.c, b), t.P);
        },
        $S: 24
      };
      A.n1.prototype = {
      ...
      A.mG.prototype = {
        $1(a) {
          var s = new A.C($.B, t.q), r = new A.ay(s, t.as), q = this.a.$1(J.as(a));
          if ((q == null ? null : J.ty(q)) == null) r.R(new A.at(false, null, null, "options.externalResourceFunction: Function must return a Promise."));
      ...
      A.mH.prototype = {
        $1(a) {
          var s = this.a;
          if (t.a.b(a)) s.a3(a);
          else s.R(new A.at(false, null, null, "options.externalResourceFunction: Promise must be fulfilled with Uint8Array or rejected."));
        },
        $S: 23
      };
      A.mI.prototype = {
        $1(a) {
          return this.a.R(new A.ff(J.as(a)));
        },
        $S: 12
      };
      A.mE.prototype = {
      ...
      A.ff.prototype = {
        k(a) {
          return "Node Exception: " + A.b(this.a);
        },
        $ia8: 1
      };
      (function aliases() {
        var s = J.cV.prototype;
        s.d6 = s.bm;
        s = J.aN.prototype;
        s.da = s.k;
        s = A.aC.prototype;
      ...
      (function installTearOffs() {
        var s = hunkHelpers._static_1, r = hunkHelpers._static_0, q = hunkHelpers._static_2, p = hunkHelpers._instance_2u, o = hunkHelpers._instance_0u, n = hunkHelpers.installInstanceTearOff, m = hunkHelpers._instance_1i, l = hunkHelpers._instance_1u;
        s(A, "wt", "ub", 143);
        s(A, "wP", "vh", 13);
        s(A, "wQ", "vi", 13);
        s(A, "wR", "vj", 13);
      ...
      (function constants() {
        ...
        B.aA = J.fj.prototype;
        B.X = J.bL.prototype;
        B.Y = new A.y("MAT4", 5126, false);
        B.G = new A.y("SCALAR", 5126, false);
        B.a_ = new A.y("VEC2", 5120, true);
        B.a0 = new A.y("VEC2", 5121, true);
        B.a2 = new A.y("VEC2", 5122, true);
        B.a3 = new A.y("VEC2", 5123, true);
        B.a4 = new A.y("VEC2", 5126, false);
        B.w = new A.y("VEC3", 5120, true);
        B.H = new A.y("VEC3", 5121, true);
        B.x = new A.y("VEC3", 5122, true);
        B.I = new A.y("VEC3", 5123, true);
        B.k = new A.y("VEC3", 5126, false);
        B.J = new A.y("VEC4", 5120, true);
        B.b_ = new A.y("VEC4", 5121, false);
        B.y = new A.y("VEC4", 5121, true);
        B.K = new A.y("VEC4", 5122, true);
        B.b0 = new A.y("VEC4", 5123, false);
        B.z = new A.y("VEC4", 5123, true);
        B.n = new A.y("VEC4", 5126, false);
        ...
        B.a9 = function getTagFallback(o) {
          var s2 = Object.prototype.toString.call(o);
          return s2.substring(8, s2.length - 1);
        };
        B.bb = function() {
          var toStringFunction = Object.prototype.toString;
          function getTag(o) {
            var s2 = toStringFunction.call(o);
            return s2.substring(8, s2.length - 1);
          }
        ...
        B.bg = function(getTagFallback) {
          return function(hooks) {
            ...
            if (ua.indexOf("Chrome") >= 0) {
              let confirm2 = function(p) {
                return typeof window == "object" && window[p] && window[p].name == p;
              };
              var confirm = confirm2;
              if (confirm2("Window") && confirm2("HTMLElement")) return hooks;
            }
        ...
        B.P = A.a(s([4]), t.V);
        B.Z = new A.y("VEC2", 5120, false);
        B.aW = new A.y("VEC2", 5121, false);
        B.a1 = new A.y("VEC2", 5122, false);
        B.aX = new A.y("VEC2", 5123, false);
        ...
        B.aQ = new A.y("SCALAR", 5121, false);
        B.aT = new A.y("SCALAR", 5123, false);
        B.aV = new A.y("SCALAR", 5125, false);
        ...
        B.a5 = new A.y("VEC3", 5120, false);
        B.a6 = new A.y("VEC3", 5122, false);
        ...
        B.W = A.u("bK");
        B.bl = new A.O(A.x2(), false, false);
        B.dK = new A.X([B.W, B.bl], t.N);
        B.bG = new A.L("EXT_texture_webp", B.dK, A.x3(), false);
        B.aC = A.u("bw");
        B.bm = new A.O(A.xj(), false, false);
        B.dG = new A.X([B.aC, B.bm], t.N);
        B.bP = new A.L("KHR_animation_pointer", B.dG, A.xk(), false);
        B.U = A.u("du");
        B.V = A.u("ap");
        B.bn = new A.O(A.xl(), false, false);
        B.bs = new A.O(A.xn(), false, false);
        B.dI = new A.X([B.U, B.bn, B.V, B.bs], t.N);
        B.bQ = new A.L("KHR_lights_punctual", B.dI, null, false);
        B.f = A.u("ai");
        B.bt = new A.O(A.xo(), false, false);
        B.du = new A.X([B.f, B.bt], t.N);
        B.bD = new A.L("KHR_materials_anisotropy", B.du, null, false);
        B.bu = new A.O(A.xp(), false, false);
        B.dv = new A.X([B.f, B.bu], t.N);
        B.bM = new A.L("KHR_materials_clearcoat", B.dv, null, false);
        B.bv = new A.O(A.xq(), false, false);
        B.dw = new A.X([B.f, B.bv], t.N);
        B.bL = new A.L("KHR_materials_dispersion", B.dw, null, false);
        B.bw = new A.O(A.xr(), false, false);
        B.dy = new A.X([B.f, B.bw], t.N);
        B.bT = new A.L("KHR_materials_emissive_strength", B.dy, null, false);
        B.bx = new A.O(A.xs(), false, false);
        B.dz = new A.X([B.f, B.bx], t.N);
        B.bR = new A.L("KHR_materials_ior", B.dz, null, false);
        B.by = new A.O(A.xt(), false, false);
        B.dA = new A.X([B.f, B.by], t.N);
        B.bK = new A.L("KHR_materials_iridescence", B.dA, null, false);
        B.bB = new A.O(A.xu(), true, false);
        B.dB = new A.X([B.f, B.bB], t.N);
        B.bI = new A.L("KHR_materials_pbrSpecularGlossiness", B.dB, null, false);
        B.bz = new A.O(A.xv(), false, false);
        B.dC = new A.X([B.f, B.bz], t.N);
        B.bF = new A.L("KHR_materials_sheen", B.dC, null, false);
        B.bo = new A.O(A.xw(), false, false);
        B.dD = new A.X([B.f, B.bo], t.N);
        B.bO = new A.L("KHR_materials_specular", B.dD, null, false);
        B.bp = new A.O(A.xx(), false, false);
        B.dE = new A.X([B.f, B.bp], t.N);
        B.bN = new A.L("KHR_materials_transmission", B.dE, null, false);
        B.bC = new A.O(A.xy(), true, false);
        B.dF = new A.X([B.f, B.bC], t.N);
        B.bE = new A.L("KHR_materials_unlit", B.dF, null, false);
        B.aF = A.u("aE");
        B.bq = new A.O(A.ul(), false, false);
        B.bA = new A.O(A.um(), false, true);
        B.dH = new A.X([B.U, B.bq, B.aF, B.bA], t.N);
        B.bJ = new A.L("KHR_materials_variants", B.dH, null, false);
        B.br = new A.O(A.xz(), false, false);
        B.dx = new A.X([B.f, B.br], t.N);
        B.bS = new A.L("KHR_materials_volume", B.dx, null, false);
        B.cN = A.a(s([]), A.aR("D<bk*>"));
        B.dL = new A.aJ(0, {}, B.cN, A.aR("aJ<bk*,O*>"));
        B.bU = new A.L("KHR_mesh_quantization", B.dL, A.xA(), true);
        B.aL = A.u("bj");
        B.aH = A.u("cz");
        B.aI = A.u("cA");
        B.N = new A.O(A.xB(), false, false);
        B.dJ = new A.X([B.aL, B.N, B.aH, B.N, B.aI, B.N], t.N);
        B.bH = new A.L("KHR_texture_transform", B.dJ, null, false);
        ...
        B.aY = new A.y("VEC3", 5121, false);
        B.aZ = new A.y("VEC3", 5123, false);
        ...
        B.aR = new A.y("SCALAR", 5121, true);
        B.aP = new A.y("SCALAR", 5120, true);
        B.aU = new A.y("SCALAR", 5123, true);
        B.aS = new A.y("SCALAR", 5122, true);
      ...
      (function nativeSupport() {
        !function() {
          ...
          v2.getIsolateTag = function(a) {
            return s("___dart_" + a + v2.isolateTag);
          };
          var r = "___dart_isolate_tags_";
          var q = Object[r] || (Object[r] = /* @__PURE__ */ Object.create(null));
          var p = "_ZxYxX";
          for (var o = 0; ; o++) {
            var n = s(p + "_" + o + "_");
            if (!(n in q)) {
          ...
          v2.dispatchPropertyName = v2.getIsolateTag("dispatch_record");
        }();
...
// node_modules/gltf-validator/module.mjs
var v = __toESM(require_gltf_validator_dart(), 1);
var version2 = () => v.default.version();
var supportedExtensions = () => v.default.supportedExtensions();
var validateBytes = (data, options) => v.default.validateBytes(data, options);
var validateString = (json, options) => v.default.validateString(json, options);
export {
  supportedExtensions,
  validateBytes,
  validateString,
...
//# sourceMappingURL=gltf-validator.js.map
