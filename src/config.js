...
const quest3ModelRenderPresets = {
  'train': {
    'moge-medium-19.glb': { pointSize: 0.015, subsampleRate: 0.47, modelScale: 1, backgroundColor: '#8c8c8c' },
    'uni-long-15.glb': { pointSize: 0.015, subsampleRate: 1, modelScale: 0.5, backgroundColor: '#8c8c8c', faceCamera: true },
    'uni-short-24.glb': { pointSize: 0.001, subsampleRate: 0.55, modelScale: 0.5, backgroundColor: '#8c8c8c', faceCamera: true },
    'vggt-medium-15.glb': { pointSize: 0.002, subsampleRate: 1.0, modelScale: 1, backgroundColor: '#8c8c8c', flipUpsideDown: true },
  },
  'moge-long': {
    'moge-long-1.glb': { pointSize: 0.008, subsampleRate: 0.85, modelScale: 1, backgroundColor: '#8c8c8c'},
  ...
  'moge-medium': {
    'moge-medium-1.glb': { pointSize: 0.007, subsampleRate: 0.49, modelScale: 1, backgroundColor: '#8c8c8c' },
    'moge-medium-2.glb': { pointSize: 0.012, subsampleRate: 0.67, modelScale: 1, backgroundColor: '#8c8c8c' },
    'moge-medium-3.glb': { pointSize: 0.010, subsampleRate: 0.68, modelScale: 1, backgroundColor: '#8c8c8c' },
    'moge-medium-4.glb': { pointSize: 0.005, subsampleRate: 0.53, modelScale: 1, backgroundColor: '#8c8c8c' },
  },
  'moge-short': {
    'moge-short-1.glb': { pointSize: 0.001, subsampleRate: 0.79, modelScale: 0.5, backgroundColor: '#8c8c8c' },
    'moge-short-2.glb': { pointSize: 0.002, subsampleRate: 0.4, modelScale: 0.3, backgroundColor: '#8c8c8c' },
    'moge-short-3.glb': { pointSize: 0.003, subsampleRate: 0.42, modelScale: 1, backgroundColor: '#8c8c8c' },
    'moge-short-4.glb': { pointSize: 0.002, subsampleRate: 0.39, modelScale: 1, backgroundColor: '#8c8c8c' },
  },
  'uni-long': {
    ...
    'uni-long-3.glb': { pointSize: 0.006, subsampleRate: 0.57, modelScale: 0.5, backgroundColor: '#8c8c8c', faceCamera: true },
  ...
  'uni-medium': {
    ...
    'uni-medium-3.glb': { pointSize: 0.007, subsampleRate: 0.64, modelScale: 0.5, backgroundColor: '#8c8c8c', faceCamera: true },
    'uni-medium-4.glb': { pointSize: 0.003, subsampleRate: 0.75, modelScale: 0.5, backgroundColor: '#8c8c8c', faceCamera: true },
  },
  'uni-short': {
    'uni-short-1.glb': { pointSize: 0.003, subsampleRate: 0.82, modelScale: 0.5, backgroundColor: '#8c8c8c', faceCamera: true },
    'uni-short-2.glb': { pointSize: 0.005, subsampleRate: 0.55, modelScale: 0.5, backgroundColor: '#8c8c8c', faceCamera: true },
    'uni-short-3.glb': { pointSize: 0.002, subsampleRate: 1, modelScale: 1, backgroundColor: '#8c8c8c', faceCamera: true },
    'uni-short-4.glb': { pointSize: 0.001, subsampleRate: 0.64, modelScale: 0.5, backgroundColor: '#8c8c8c', faceCamera: true },
  },
  'vggt-long': {
